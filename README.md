...
- API version: 23.6.0.46
- Package version: 23.6.0.46
...
*ConfigurationPolicyApi* | [**update_iot_profile**](docs/ConfigurationPolicyApi.md#update_iot_profile) | **PUT** /iot-profiles/{id} | Update radio profile by ID
...
*LocationApi* | [**delete_site**](docs/LocationApi.md#delete_site) | **DELETE** /locations/site/{id} | Delete site by ID
...
*LocationApi* | [**update_site**](docs/LocationApi.md#update_site) | **PUT** /locations/site/{id} | Update site by ID

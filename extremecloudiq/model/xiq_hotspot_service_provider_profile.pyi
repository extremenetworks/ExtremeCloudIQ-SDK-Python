...
class XiqHotspotServiceProviderProfile(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "create_time", "update_time", "name", "friendly_names", "descriptions", "icon_files", "nai_realms", "roaming_consortiums", "cellular_networks", "osu_uri", "osu_methods", "osu_nai", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "create_time", "update_time", "name", "friendly_names", "descriptions", "icon_files", "nai_realms", "roaming_consortiums", "cellular_networks", "osu_uri", "osu_methods", "osu_nai", ], str]):

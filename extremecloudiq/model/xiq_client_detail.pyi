...
class XiqClientDetail(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["device_connected", "device_id", "os_type", "ip_address", "mac_address", "device_location_names", "device_location_id", "alias", "user", "connection_to", "connection_time", "vlan", "cwp_used", "user_profile", "ssid", "radio", "wifi_protocol", "channel", "client_hostname", "client_type", "rtts_supported", ], str]):

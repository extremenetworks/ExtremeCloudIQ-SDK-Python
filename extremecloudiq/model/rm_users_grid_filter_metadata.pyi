...
class RmUsersGridFilterMetadata(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["user_names", "groups", "sources", "emails", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["user_names", "groups", "sources", "emails", ], str]):

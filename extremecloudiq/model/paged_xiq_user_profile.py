        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['XiqUserProfile']:
                        return XiqUserProfile
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['XiqUserProfile'], typing.List['XiqUserProfile']],
                ...
                def __getitem__(self, i: int) -> 'XiqUserProfile':

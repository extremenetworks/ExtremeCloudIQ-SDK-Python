...
class XiqVhmSettingInfo(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            current_status = schemas.StrSchema
            backed_up_on = schemas.Int64Schema
            ...
            enable_auto_config_push = schemas.BoolSchema
            enable_site_isolation = schemas.BoolSchema
            enable_legacy_uztna_proxy = schemas.BoolSchema
            __annotations__ = {
                "id": id,
                ...
                "enable_auto_config_push": enable_auto_config_push,
                "enable_site_isolation": enable_site_isolation,
                "enable_legacy_uztna_proxy": enable_legacy_uztna_proxy,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["backed_up_on"]) -> MetaOapg.properties.backed_up_on: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["enable_auto_config_push"]) -> MetaOapg.properties.enable_auto_config_push: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["enable_site_isolation"]) -> MetaOapg.properties.enable_site_isolation: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["enable_legacy_uztna_proxy"]) -> MetaOapg.properties.enable_legacy_uztna_proxy: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "create_time", "update_time", "org_id", "vhm_name", "current_status", "backed_up_on", "enable_copilot", "enable_ssh", "enable_supplemental_cli", "enable_wireless_onboarding", "enable_password_for_exos_voss", "enable_auto_config_push", "enable_site_isolation", "enable_legacy_uztna_proxy", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["backed_up_on"]) -> typing.Union[MetaOapg.properties.backed_up_on, schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["enable_auto_config_push"]) -> typing.Union[MetaOapg.properties.enable_auto_config_push, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["enable_site_isolation"]) -> typing.Union[MetaOapg.properties.enable_site_isolation, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["enable_legacy_uztna_proxy"]) -> typing.Union[MetaOapg.properties.enable_legacy_uztna_proxy, schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        current_status: typing.Union[MetaOapg.properties.current_status, str, schemas.Unset] = schemas.unset,
        backed_up_on: typing.Union[MetaOapg.properties.backed_up_on, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        ...
        enable_auto_config_push: typing.Union[MetaOapg.properties.enable_auto_config_push, bool, schemas.Unset] = schemas.unset,
        enable_site_isolation: typing.Union[MetaOapg.properties.enable_site_isolation, bool, schemas.Unset] = schemas.unset,
        enable_legacy_uztna_proxy: typing.Union[MetaOapg.properties.enable_legacy_uztna_proxy, bool, schemas.Unset] = schemas.unset,

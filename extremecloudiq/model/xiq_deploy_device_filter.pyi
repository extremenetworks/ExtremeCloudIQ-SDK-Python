...
class XiqDeployDeviceFilter(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["ids", "site_ids", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["ids", "site_ids", ], str]):

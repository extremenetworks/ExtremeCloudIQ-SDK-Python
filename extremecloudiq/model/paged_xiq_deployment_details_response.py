...
class PagedXiqDeploymentDetailsResponse(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['XiqDeploymentDetailsResponse']:
                        return XiqDeploymentDetailsResponse
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['XiqDeploymentDetailsResponse'], typing.List['XiqDeploymentDetailsResponse']],
                ...
                def __getitem__(self, i: int) -> 'XiqDeploymentDetailsResponse':

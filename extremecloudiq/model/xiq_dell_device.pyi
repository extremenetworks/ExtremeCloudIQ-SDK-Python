...
class XiqDellDevice(
    ...
    service_tag: MetaOapg.properties.service_tag
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["serial_number", "service_tag", "location", "network_policy_id", "hostname", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["service_tag"]) -> MetaOapg.properties.service_tag: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["serial_number", "service_tag", "location", "network_policy_id", "hostname", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        service_tag: typing.Union[MetaOapg.properties.service_tag, str, ],
        location: 'XiqDeviceLocationAssignment',

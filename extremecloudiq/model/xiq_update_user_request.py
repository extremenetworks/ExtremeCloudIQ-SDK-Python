...
class XiqUpdateUserRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["login_name", "display_name", "idle_timeout", "user_role", "location_ids", "access_scope", "viq_access_control", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["login_name", "display_name", "idle_timeout", "user_role", "location_ids", "access_scope", "viq_access_control", ], str]):

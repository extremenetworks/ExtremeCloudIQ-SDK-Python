...
class XiqCreateAlertEmailSubscriptionRequest(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["email", "is_subscribe_all", "alert_policy_ids", "is_enabled", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["email", "is_subscribe_all", "alert_policy_ids", "is_enabled", ], str]):

...
class XiqUpdateEndUserRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "organization", "visit_purpose", "description", "email_address", "phone_number", "password", "email_password_delivery", "sms_password_delivery", "vlan_override", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "organization", "visit_purpose", "description", "email_address", "phone_number", "password", "email_password_delivery", "sms_password_delivery", "vlan_override", ], str]):

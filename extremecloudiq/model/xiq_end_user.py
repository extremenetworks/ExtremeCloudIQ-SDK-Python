...
class XiqEndUser(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "create_time", "update_time", "name", "email_address", "phone_number", "user_name", "user_group_id", "user_group_name", "approval_type", "expired_time", "org_id", "description", "password", "organization", "visit_purpose", "email_password_delivery", "sms_password_delivery", "vlan_override", ], str]):

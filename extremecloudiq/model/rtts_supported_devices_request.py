...
class RttsSupportedDevicesRequest(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["floor_ids", "building_ids", "site_ids", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["floor_ids", "building_ids", "site_ids", ], str]):

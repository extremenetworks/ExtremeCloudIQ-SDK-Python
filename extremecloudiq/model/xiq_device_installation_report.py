...
class XiqDeviceInstallationReport(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["onboarded", "location_name", "network_policy_name", "device_template_name", "ip_address", "default_gateway", "ntp_server", "dns_server", "enable_poe", "xiq_connectivity", "image_count", "image_names", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["onboarded", "location_name", "network_policy_name", "device_template_name", "ip_address", "default_gateway", "ntp_server", "dns_server", "enable_poe", "xiq_connectivity", "image_count", "image_names", ], str]):

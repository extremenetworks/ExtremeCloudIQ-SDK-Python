...
class XiqDeviceInstallationReport(
        ...
        class properties:
            ...
            class image_file_details(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['XiqImageFileDetails']:
                        return XiqImageFileDetails
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['XiqImageFileDetails'], typing.List['XiqImageFileDetails']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'image_file_details':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'XiqImageFileDetails':
                    return super().__getitem__(i)
            __annotations__ = {
                "onboarded": onboarded,
                ...
                "image_file_details": image_file_details,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["image_file_details"]) -> MetaOapg.properties.image_file_details: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["onboarded", "location_name", "network_policy_name", "device_template_name", "ip_address", "default_gateway", "ntp_server", "dns_server", "enable_poe", "xiq_connectivity", "image_count", "image_names", "installation_time", "installed_by", "image_file_details", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["image_file_details"]) -> typing.Union[MetaOapg.properties.image_file_details, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["onboarded", "location_name", "network_policy_name", "device_template_name", "ip_address", "default_gateway", "ntp_server", "dns_server", "enable_poe", "xiq_connectivity", "image_count", "image_names", "installation_time", "installed_by", "image_file_details", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        image_file_details: typing.Union[MetaOapg.properties.image_file_details, list, tuple, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,

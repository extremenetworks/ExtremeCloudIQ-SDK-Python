        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['XiqMacFirewall']:
                        return XiqMacFirewall
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['XiqMacFirewall'], typing.List['XiqMacFirewall']],
                ...
                def __getitem__(self, i: int) -> 'XiqMacFirewall':

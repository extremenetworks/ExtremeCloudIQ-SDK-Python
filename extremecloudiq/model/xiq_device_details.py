...
class XiqDeviceDetails(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["system_name", "ip_address", "model", "sys_up_time", "os_version", "location", "system_mac", "serial_number", "system_description", "software_version", "installation_time", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["system_name", "ip_address", "model", "sys_up_time", "os_version", "location", "system_mac", "serial_number", "system_description", "software_version", "installation_time", ], str]):

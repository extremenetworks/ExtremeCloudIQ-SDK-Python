...
class XiqRmDeviceMetadataResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["default_gateway", "software_version", "product_type", "device_admin_state", "country_code", "managed_by", "sim_type", "country_code_name", "network_policy", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["default_gateway", "software_version", "product_type", "device_admin_state", "country_code", "managed_by", "sim_type", "country_code_name", "network_policy", ], str]):
        return super().get_item_oapg(name)

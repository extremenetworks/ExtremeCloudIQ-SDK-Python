...
class PagedXiqConnectivityExperienceData(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['XiqConnectivityExperienceData']:
                        return XiqConnectivityExperienceData
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['XiqConnectivityExperienceData'], typing.List['XiqConnectivityExperienceData']],
                ...
                def __getitem__(self, i: int) -> 'XiqConnectivityExperienceData':

        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['XiqCredentialLog']:
                        return XiqCredentialLog
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['XiqCredentialLog'], typing.List['XiqCredentialLog']],
                ...
                def __getitem__(self, i: int) -> 'XiqCredentialLog':

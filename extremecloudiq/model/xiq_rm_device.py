...
class XiqRmDevice(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            display_managed_by = schemas.StrSchema
            ...
            class eth0_uplink_speed(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "SPEED_AUTO": "AUTO",
                        "SPEED_10M": "DIGIT_ONE_0M",
                        "SPEED_100M": "DIGIT_ONE_00M",
                        "SPEED_1000M": "DIGIT_ONE_000M",
                        "SPEED_10000M": "DIGIT_ONE_0000M",
                        "SPEED_100000M": "DIGIT_ONE_00000M",
                        "SPEED_44M": "DIGIT_FOUR_4M",
                        "SPEED_155M": "DIGIT_ONE_55M",
                        "SPEED_622M": "DIGIT_SIX_22M",
                    }
                
                @schemas.classproperty
                def AUTO(cls):
                    return cls("SPEED_AUTO")
                
                @schemas.classproperty
                def DIGIT_ONE_0M(cls):
                    return cls("SPEED_10M")
                
                @schemas.classproperty
                def DIGIT_ONE_00M(cls):
                    return cls("SPEED_100M")
                
                @schemas.classproperty
                def DIGIT_ONE_000M(cls):
                    return cls("SPEED_1000M")
                
                @schemas.classproperty
                def DIGIT_ONE_0000M(cls):
                    return cls("SPEED_10000M")
                
                @schemas.classproperty
                def DIGIT_ONE_00000M(cls):
                    return cls("SPEED_100000M")
                
                @schemas.classproperty
                def DIGIT_FOUR_4M(cls):
                    return cls("SPEED_44M")
                
                @schemas.classproperty
                def DIGIT_ONE_55M(cls):
                    return cls("SPEED_155M")
                
                @schemas.classproperty
                def DIGIT_SIX_22M(cls):
                    return cls("SPEED_622M")
            
            
            class eth1_uplink_speed(
                schemas.EnumBase,
                schemas.StrSchema
            ):
                ...
                def DIGIT_SIX_22M(cls):
                    return cls("SPEED_622M")
            controller_id = schemas.Int64Schema
            primary_controller_address = schemas.StrSchema
            secondary_controller_address = schemas.StrSchema
        
            @staticmethod
            def copilot_license_status() -> typing.Type['XiqCopilotLicenseStatus']:
                return XiqCopilotLicenseStatus
            device_family = schemas.StrSchema
            __annotations__ = {
                "id": id,
                ...
                "cloud_config_groups": cloud_config_groups,
                "eth0_uplink_speed": eth0_uplink_speed,
                "eth1_uplink_speed": eth1_uplink_speed,
                "controller_id": controller_id,
                "primary_controller_address": primary_controller_address,
                "secondary_controller_address": secondary_controller_address,
                "copilot_license_status": copilot_license_status,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["stack_id"]) -> MetaOapg.properties.stack_id: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["cloud_config_groups"]) -> MetaOapg.properties.cloud_config_groups: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["eth0_uplink_speed"]) -> MetaOapg.properties.eth0_uplink_speed: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["eth1_uplink_speed"]) -> MetaOapg.properties.eth1_uplink_speed: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["controller_id"]) -> MetaOapg.properties.controller_id: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["primary_controller_address"]) -> MetaOapg.properties.primary_controller_address: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["secondary_controller_address"]) -> MetaOapg.properties.secondary_controller_address: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["copilot_license_status"]) -> 'XiqCopilotLicenseStatus': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["device_family"]) -> MetaOapg.properties.device_family: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "create_time", "update_time", "org_id", "connected", "hostname", "healthy_clients", "unhealthy_clients", "system_up_time", "updated_on", "mac_address", "serial_number", "device_ip", "default_gateway", "software_version", "product_type", "ipv6_address", "device_admin_state", "sim_type", "country_code", "managed_by", "display_managed_by", "channel_wifi0", "power_wifi0", "radio_wifi0", "channel_wifi1", "power_wifi1", "radio_wifi1", "channel_wifi2", "power_wifi2", "radio_wifi2", "config_mismatch", "locations", "device_category", "has_management_ip_issue", "has_default_gateway_issue", "has_firmware_version_issue", "stack_size", "stack_id", "xiq_rm_device_icons", "device_license_tier", "device_license_type", "network_policy_id", "network_policy_name", "os", "device_template_name", "cloud_config_groups", "eth0_uplink_speed", "eth1_uplink_speed", "controller_id", "primary_controller_address", "secondary_controller_address", "copilot_license_status", "device_family", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["stack_id"]) -> typing.Union[MetaOapg.properties.stack_id, schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["cloud_config_groups"]) -> typing.Union[MetaOapg.properties.cloud_config_groups, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["eth0_uplink_speed"]) -> typing.Union[MetaOapg.properties.eth0_uplink_speed, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["eth1_uplink_speed"]) -> typing.Union[MetaOapg.properties.eth1_uplink_speed, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["controller_id"]) -> typing.Union[MetaOapg.properties.controller_id, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["primary_controller_address"]) -> typing.Union[MetaOapg.properties.primary_controller_address, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["secondary_controller_address"]) -> typing.Union[MetaOapg.properties.secondary_controller_address, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["copilot_license_status"]) -> typing.Union['XiqCopilotLicenseStatus', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["device_family"]) -> typing.Union[MetaOapg.properties.device_family, schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        display_managed_by: typing.Union[MetaOapg.properties.display_managed_by, str, schemas.Unset] = schemas.unset,
        ...
        stack_id: typing.Union[MetaOapg.properties.stack_id, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        ...
        cloud_config_groups: typing.Union[MetaOapg.properties.cloud_config_groups, list, tuple, schemas.Unset] = schemas.unset,
        eth0_uplink_speed: typing.Union[MetaOapg.properties.eth0_uplink_speed, str, schemas.Unset] = schemas.unset,
        eth1_uplink_speed: typing.Union[MetaOapg.properties.eth1_uplink_speed, str, schemas.Unset] = schemas.unset,
        controller_id: typing.Union[MetaOapg.properties.controller_id, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        primary_controller_address: typing.Union[MetaOapg.properties.primary_controller_address, str, schemas.Unset] = schemas.unset,
        secondary_controller_address: typing.Union[MetaOapg.properties.secondary_controller_address, str, schemas.Unset] = schemas.unset,
        copilot_license_status: typing.Union['XiqCopilotLicenseStatus', schemas.Unset] = schemas.unset,
        device_family: typing.Union[MetaOapg.properties.device_family, str, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,

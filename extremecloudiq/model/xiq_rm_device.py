...
class XiqRmDevice(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "create_time", "update_time", "org_id", "connected", "hostname", "healthy_clients", "unhealthy_clients", "system_up_time", "updated_on", "mac_address", "serial_number", "device_ip", "default_gateway", "software_version", "product_type", "ipv6_address", "device_admin_state", "sim_type", "country_code", "managed_by", "channel_wifi0", "power_wifi0", "radio_wifi0", "channel_wifi1", "power_wifi1", "radio_wifi1", "channel_wifi2", "power_wifi2", "radio_wifi2", "config_mismatch", "locations", "device_category", "has_management_ip_issue", "has_default_gateway_issue", "has_firmware_version_issue", "stack_size", "stack_id", "xiq_rm_device_icons", "device_license_tier", "device_license_type", "network_policy_id", "network_policy_name", "os", "device_template_name", "cloud_config_groups", "eth0_uplink_speed", "eth1_uplink_speed", ], str]):

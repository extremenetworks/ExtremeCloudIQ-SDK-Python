...
class XiqClientChartRoamDetails(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["device_name_from", "device_name_to", "device_mac_from", "device_mac_to", "roam_duration", "status_action", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["device_name_from", "device_name_to", "device_mac_from", "device_mac_to", "roam_duration", "status_action", ], str]):

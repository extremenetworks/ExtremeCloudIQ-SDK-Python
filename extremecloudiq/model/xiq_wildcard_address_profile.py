...
class XiqWildcardAddressProfile(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "create_time", "update_time", "name", "address_type", "org_id", "predefined", "description", "value", "enable_classification", "classified_entries", "wildcard_mask", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "create_time", "update_time", "name", "address_type", "org_id", "predefined", "description", "value", "enable_classification", "classified_entries", "wildcard_mask", ], str]):

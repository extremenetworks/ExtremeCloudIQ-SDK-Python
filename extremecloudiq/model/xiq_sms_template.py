...
class XiqSmsTemplate(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "create_time", "update_time", "name", "predefined", "password_type", "org_id", "description", "content", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "create_time", "update_time", "name", "predefined", "password_type", "org_id", "description", "content", ], str]):

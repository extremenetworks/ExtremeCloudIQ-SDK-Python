        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['XiqHotspotProfile']:
                        return XiqHotspotProfile
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['XiqHotspotProfile'], typing.List['XiqHotspotProfile']],
                ...
                def __getitem__(self, i: int) -> 'XiqHotspotProfile':

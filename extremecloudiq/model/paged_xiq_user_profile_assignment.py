...
class PagedXiqUserProfileAssignment(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['XiqUserProfileAssignment']:
                        return XiqUserProfileAssignment
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['XiqUserProfileAssignment'], typing.List['XiqUserProfileAssignment']],
                ...
                def __getitem__(self, i: int) -> 'XiqUserProfileAssignment':

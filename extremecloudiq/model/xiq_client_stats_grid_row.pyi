...
class XiqClientStatsGridRow(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["connection_status", "client_hostname", "client_ip", "site", "building", "floor", "association_issues", "authentication_issues", "ip_address_issues", "snr", "rssi", "channel_utilization_score", "frequency", "roaming_issues", "ipv4", "connected_device_mac", "ssid", "vlan", "username", "authentication", "encryption", "user_profile", "alias", "category_assignment", "ipv6", "client_device_id", "device_id", "client_type", "is_mlo", "mlo_bands", "mlo_mode", "last_session_start_time", "operating_system", "client_mac", ], str]):

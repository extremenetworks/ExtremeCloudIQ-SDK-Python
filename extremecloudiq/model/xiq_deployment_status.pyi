...
class XiqDeploymentStatus(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            is_config_rolled_back = schemas.BoolSchema
            __annotations__ = {
                ...
                "is_config_rolled_back": is_config_rolled_back,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["is_config_rolled_back"]) -> MetaOapg.properties.is_config_rolled_back: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["is_finished", "current_progress", "current_step_code", "current_step_message", "is_finished_successful", "last_deploy_time", "status_message", "is_pending_config", "is_config_rolled_back", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["is_config_rolled_back"]) -> typing.Union[MetaOapg.properties.is_config_rolled_back, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["is_finished", "current_progress", "current_step_code", "current_step_message", "is_finished_successful", "last_deploy_time", "status_message", "is_pending_config", "is_config_rolled_back", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        is_config_rolled_back: typing.Union[MetaOapg.properties.is_config_rolled_back, bool, schemas.Unset] = schemas.unset,

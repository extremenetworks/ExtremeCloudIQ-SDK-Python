...
class XiqIssueClientIpAddress(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["date_time", "issue_type", "device_name", "slowness_duration", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["date_time", "issue_type", "device_name", "slowness_duration", ], str]):

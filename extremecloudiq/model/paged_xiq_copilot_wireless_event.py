...
class PagedXiqCopilotWirelessEvent(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['XiqCopilotWirelessEvent']:
                        return XiqCopilotWirelessEvent
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['XiqCopilotWirelessEvent'], typing.List['XiqCopilotWirelessEvent']],
                ...
                def __getitem__(self, i: int) -> 'XiqCopilotWirelessEvent':

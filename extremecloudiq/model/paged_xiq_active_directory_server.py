...
class PagedXiqActiveDirectoryServer(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['XiqActiveDirectoryServer']:
                        return XiqActiveDirectoryServer
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['XiqActiveDirectoryServer'], typing.List['XiqActiveDirectoryServer']],
                ...
                def __getitem__(self, i: int) -> 'XiqActiveDirectoryServer':

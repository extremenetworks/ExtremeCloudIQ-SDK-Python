        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['XiqBuilding']:
                        return XiqBuilding
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['XiqBuilding'], typing.List['XiqBuilding']],
                ...
                def __getitem__(self, i: int) -> 'XiqBuilding':

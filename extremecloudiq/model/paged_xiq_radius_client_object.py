...
class PagedXiqRadiusClientObject(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['XiqRadiusClientObject']:
                        return XiqRadiusClientObject
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['XiqRadiusClientObject'], typing.List['XiqRadiusClientObject']],
                ...
                def __getitem__(self, i: int) -> 'XiqRadiusClientObject':

...
class XiqWiredDeviceHealthPoeUsageStatusResponseEntry(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["slot_number", "poe_usage", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["slot_number", "poe_usage", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        poe_usage: typing.Union[MetaOapg.properties.poe_usage, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'XiqWiredDeviceHealthPoeUsageStatusResponseEntry':

...
class XiqExternalAccount(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "create_time", "update_time", "name", "alias", "active", "data_center", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["alias"]) -> MetaOapg.properties.alias: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "create_time", "update_time", "name", "alias", "active", "data_center", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        alias: typing.Union[MetaOapg.properties.alias, str, ],

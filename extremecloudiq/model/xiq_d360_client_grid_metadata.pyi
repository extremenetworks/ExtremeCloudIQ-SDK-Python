...
class XiqD360ClientGridMetadata(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["alias", "auth_methods", "encryption_methods", "operating_systems", "ssids", "user_profiles", "frequency", "category_assignments", "client_type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["alias", "auth_methods", "encryption_methods", "operating_systems", "ssids", "user_profiles", "frequency", "category_assignments", "client_type", ], str]):

...
class XiqD360DeviceStats(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            channel_change = schemas.Int64Schema
            wifi_reboots = schemas.Int64Schema
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["channel_change"]) -> MetaOapg.properties.channel_change: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["wifi_reboots"]) -> MetaOapg.properties.wifi_reboots: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["device_hostname", "device_ip", "site", "building", "floor", "cpu_usage_percentage", "memory_usage_percentage", "poe_usage_indicator", "channel_change", "wifi_reboots", "eth0_unicast_score", "eth0_broadcast_score", "eth0_multicast_score", "eth1_unicast_score", "eth1_broadcast_score", "eth1_multicast_score", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["channel_change"]) -> typing.Union[MetaOapg.properties.channel_change, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["wifi_reboots"]) -> typing.Union[MetaOapg.properties.wifi_reboots, schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        channel_change: typing.Union[MetaOapg.properties.channel_change, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        wifi_reboots: typing.Union[MetaOapg.properties.wifi_reboots, decimal.Decimal, int, schemas.Unset] = schemas.unset,

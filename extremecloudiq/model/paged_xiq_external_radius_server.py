...
class PagedXiqExternalRadiusServer(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['XiqExternalRadiusServer']:
                        return XiqExternalRadiusServer
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['XiqExternalRadiusServer'], typing.List['XiqExternalRadiusServer']],
                ...
                def __getitem__(self, i: int) -> 'XiqExternalRadiusServer':

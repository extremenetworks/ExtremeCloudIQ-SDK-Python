...
class XiqCreateRadiusClientObjectRequest(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "enable_inject_operator_name_attribute", "enable_message_authenticator_attribute", "enable_permit_dynamic_authorization_message_change", "retry_interval", "accounting_interim_update_interval", "entries", "description", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "enable_inject_operator_name_attribute", "enable_message_authenticator_attribute", "enable_permit_dynamic_authorization_message_change", "retry_interval", "accounting_interim_update_interval", "entries", "description", ], str]):

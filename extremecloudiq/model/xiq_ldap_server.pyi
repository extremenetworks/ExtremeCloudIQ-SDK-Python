...
class XiqLdapServer(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            destination_port = schemas.Int32Schema
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "create_time", "update_time", "name", "description", "enable_tls", "bind_dn", "bind_dn_password", "base_dn", "l3_address_profile_id", "protocol_type", "enable_strip_realm_name", "destination_port", "verification_mode", "ca_certificate_id", "client_certificate_id", "client_key_id", "client_key_password", ], str]):

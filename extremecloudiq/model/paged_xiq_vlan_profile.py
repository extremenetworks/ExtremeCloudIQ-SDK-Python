        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['XiqVlanProfile']:
                        return XiqVlanProfile
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['XiqVlanProfile'], typing.List['XiqVlanProfile']],
                ...
                def __getitem__(self, i: int) -> 'XiqVlanProfile':

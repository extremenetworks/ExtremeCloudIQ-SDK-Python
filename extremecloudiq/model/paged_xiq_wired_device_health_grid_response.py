...
class PagedXiqWiredDeviceHealthGridResponse(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['XiqWiredDeviceHealthGridResponse']:
                        return XiqWiredDeviceHealthGridResponse
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['XiqWiredDeviceHealthGridResponse'], typing.List['XiqWiredDeviceHealthGridResponse']],
                ...
                def __getitem__(self, i: int) -> 'XiqWiredDeviceHealthGridResponse':

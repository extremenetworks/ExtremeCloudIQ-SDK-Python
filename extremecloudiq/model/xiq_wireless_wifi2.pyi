...
class XiqWirelessWifi2(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            __annotations__ = {
                ...
                "xiq_ap_afc_status": xiq_ap_afc_status,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["xiq_ap_afc_status"]) -> MetaOapg.properties.xiq_ap_afc_status: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["ssid_count", "ssids", "number_of_clients", "channel_utilization", "channel", "channel_width", "load_balancing", "band_steering", "channel_utilization_details", "xiq_ap_afc_status", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["xiq_ap_afc_status"]) -> typing.Union[MetaOapg.properties.xiq_ap_afc_status, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["ssid_count", "ssids", "number_of_clients", "channel_utilization", "channel", "channel_width", "load_balancing", "band_steering", "channel_utilization_details", "xiq_ap_afc_status", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        xiq_ap_afc_status: typing.Union[MetaOapg.properties.xiq_ap_afc_status, str, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,

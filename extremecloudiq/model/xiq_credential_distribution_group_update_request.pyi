...
class XiqCredentialDistributionGroupUpdateRequest(
        ...
        class properties:
            ...
            class user_group_ids(
                ...
                def __getitem__(self, i: int) -> MetaOapg.items:
                    return super().__getitem__(i)
            credential_distribution_group_error_message = schemas.StrSchema
            __annotations__ = {
                "name": name,
                ...
                "credential_distribution_group_error_message": credential_distribution_group_error_message,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["credential_distribution_group_error_message"]) -> MetaOapg.properties.credential_distribution_group_error_message: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "enable_email_approval", "enable_user_limitation", "employee_group_type", "employee_groups", "restrict_number", "user_group_ids", "credential_distribution_group_error_message", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["credential_distribution_group_error_message"]) -> typing.Union[MetaOapg.properties.credential_distribution_group_error_message, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "enable_email_approval", "enable_user_limitation", "employee_group_type", "employee_groups", "restrict_number", "user_group_ids", "credential_distribution_group_error_message", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        credential_distribution_group_error_message: typing.Union[MetaOapg.properties.credential_distribution_group_error_message, str, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,

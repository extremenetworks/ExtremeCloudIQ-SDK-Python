        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['XiqApiAccessToken']:
                        return XiqApiAccessToken
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['XiqApiAccessToken'], typing.List['XiqApiAccessToken']],
                ...
                def __getitem__(self, i: int) -> 'XiqApiAccessToken':

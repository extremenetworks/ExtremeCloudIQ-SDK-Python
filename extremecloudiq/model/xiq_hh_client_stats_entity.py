...
class XiqHhClientStatsEntity(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["client_mac", "client_name", "client_host_os", "avg_snr", "client_id", "health_score", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["client_mac", "client_name", "client_host_os", "avg_snr", "client_id", "health_score", ], str]):

...
class XiqMissingVlanSiteAnomalyCountDetails(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            anomalies_count = schemas.Int32Schema
            __annotations__ = {
                "site_id": site_id,
                "site_name": site_name,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["anomalies_count"]) -> MetaOapg.properties.anomalies_count: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["site_id", "site_name", "anomalies_count", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["anomalies_count"]) -> typing.Union[MetaOapg.properties.anomalies_count, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["site_id", "site_name", "anomalies_count", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        anomalies_count: typing.Union[MetaOapg.properties.anomalies_count, decimal.Decimal, int, schemas.Unset] = schemas.unset,

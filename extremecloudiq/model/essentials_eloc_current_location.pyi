...
class EssentialsElocCurrentLocation(
    schemas.DictSchema
):
    ...
    The current location of the client on the floor plan
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["timestamp", "x", "y", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["timestamp", "x", "y", ], str]):

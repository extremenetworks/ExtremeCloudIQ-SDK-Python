...
class PagedXiqClientMonitorProfile(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['XiqClientMonitorProfile']:
                        return XiqClientMonitorProfile
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['XiqClientMonitorProfile'], typing.List['XiqClientMonitorProfile']],
                ...
                def __getitem__(self, i: int) -> 'XiqClientMonitorProfile':

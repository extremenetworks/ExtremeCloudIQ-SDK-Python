...
class XiqDeviceRebootSummary(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["date_time", "description", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["date_time", "description", ], str]):

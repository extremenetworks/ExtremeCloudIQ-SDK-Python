...
class XiqWiredClientHealthIpConnectivityIssuesRequest(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["site_ids", "device_ids", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["site_ids", "device_ids", ], str]):
    ...
    ) -> 'XiqWiredClientHealthIpConnectivityIssuesRequest':
        return super().__new__(
            cls,
            *_args,
            site_ids=site_ids,

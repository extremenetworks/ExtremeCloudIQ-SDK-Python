...
class XiqHttpServer(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["url", "interval", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["url", "interval", ], str]):

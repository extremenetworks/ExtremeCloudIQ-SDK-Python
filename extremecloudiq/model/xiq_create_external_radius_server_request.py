...
class XiqCreateExternalRadiusServerRequest(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def access_type() -> typing.Type['XiqRadiusAccessType']:
                return XiqRadiusAccessType
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["access_type"]) -> 'XiqRadiusAccessType': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "authentication_port", "accounting_port", "server_type", "enable_a3", "shared_secret", "ip_addr", "enable_peer_discovery", "access_type", "trust_pilot_id", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["access_type"]) -> typing.Union['XiqRadiusAccessType', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "authentication_port", "accounting_port", "server_type", "enable_a3", "shared_secret", "ip_addr", "enable_peer_discovery", "access_type", "trust_pilot_id", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        access_type: typing.Union['XiqRadiusAccessType', schemas.Unset] = schemas.unset,

...
class XiqCreateExternalRadiusServerRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "authentication_port", "accounting_port", "server_type", "ip_addr", "enable_a3", "shared_secret", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "authentication_port", "accounting_port", "server_type", "ip_addr", "enable_a3", "shared_secret", ], str]):

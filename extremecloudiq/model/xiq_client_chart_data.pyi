...
class XiqClientChartData(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["timestamp", "rssi", "snr", "noise_floor", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["timestamp", "rssi", "snr", "noise_floor", ], str]):

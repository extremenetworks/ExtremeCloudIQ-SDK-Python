...
class XiqVhmSetting(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "create_time", "update_time", "org_id", "enable_ssh", "enable_supplemental_cli", "enable_wireless_onboarding", "enable_password_for_exos_voss", "enable_auto_config_push", "enable_site_isolation", "enable_legacy_uztna_proxy", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "create_time", "update_time", "org_id", "enable_ssh", "enable_supplemental_cli", "enable_wireless_onboarding", "enable_password_for_exos_voss", "enable_auto_config_push", "enable_site_isolation", "enable_legacy_uztna_proxy", ], str]):

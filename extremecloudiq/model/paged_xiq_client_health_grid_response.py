...
class PagedXiqClientHealthGridResponse(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['XiqClientHealthGridResponse']:
                        return XiqClientHealthGridResponse
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['XiqClientHealthGridResponse'], typing.List['XiqClientHealthGridResponse']],
                ...
                def __getitem__(self, i: int) -> 'XiqClientHealthGridResponse':

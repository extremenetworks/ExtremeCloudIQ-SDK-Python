...
class XiqClientHealthRoamingIssues(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["total_clients", "roaming_issues", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["total_clients", "roaming_issues", ], str]):

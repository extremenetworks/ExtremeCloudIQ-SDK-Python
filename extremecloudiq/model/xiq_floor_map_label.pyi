...
class XiqFloorMapLabel(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "x", "y", "text", "floor_id", "visible", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "x", "y", "text", "floor_id", "visible", ], str]):

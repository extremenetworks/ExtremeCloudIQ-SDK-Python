...
class XiqOsEntry(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["os", "value", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["os", "value", ], str]):

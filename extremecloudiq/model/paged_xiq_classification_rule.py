...
class PagedXiqClassificationRule(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['XiqClassificationRule']:
                        return XiqClassificationRule
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['XiqClassificationRule'], typing.List['XiqClassificationRule']],
                ...
                def __getitem__(self, i: int) -> 'XiqClassificationRule':

...
class PagedXiqSiteDashboardResponse(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['XiqSiteDashboardResponse']:
                        return XiqSiteDashboardResponse
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['XiqSiteDashboardResponse'], typing.List['XiqSiteDashboardResponse']],
                ...
                def __getitem__(self, i: int) -> 'XiqSiteDashboardResponse':

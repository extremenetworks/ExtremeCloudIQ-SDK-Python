...
class XiqCreateL3AddressProfileRequest(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "value", "address_type", "description", "enable_classification", "classified_entries", "ip_address_end", "netmask", "wildcard_mask", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "value", "address_type", "description", "enable_classification", "classified_entries", "ip_address_end", "netmask", "wildcard_mask", ], str]):

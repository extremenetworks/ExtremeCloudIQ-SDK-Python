...
class XiqWiredDeviceHealthTemperatureStatusResponseEntry(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["slot_number", "temperature", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["slot_number", "temperature", ], str]):

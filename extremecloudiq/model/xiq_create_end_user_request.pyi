...
class XiqCreateEndUserRequest(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["vlan_override"]) -> MetaOapg.properties.vlan_override: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["user_group_id", "user_name", "name", "organization", "visit_purpose", "description", "email_address", "phone_number", "password", "email_password_delivery", "sms_password_delivery", "vlan_override", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["vlan_override"]) -> typing.Union[MetaOapg.properties.vlan_override, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["user_group_id", "user_name", "name", "organization", "visit_purpose", "description", "email_address", "phone_number", "password", "email_password_delivery", "sms_password_delivery", "vlan_override", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        vlan_override: typing.Union[MetaOapg.properties.vlan_override, decimal.Decimal, int, schemas.Unset] = schemas.unset,

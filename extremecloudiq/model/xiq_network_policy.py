...
class XiqNetworkPolicy(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class type(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "NetworkAccessAndSwitching": "NETWORK_ACCESS_AND_SWITCHING",
                        "BranchRouting": "BRANCH_ROUTING",
                        "WirelessAccess": "WIRELESS_ACCESS",
                        "Switching": "SWITCHING",
                        "NetworkAccessAndSwitchingAndBR": "NETWORK_ACCESS_AND_SWITCHING_AND_BR",
                        "NetworkAccessAndBranchRouting": "NETWORK_ACCESS_AND_BRANCH_ROUTING",
                        "SwitchingAndBranchRouting": "SWITCHING_AND_BRANCH_ROUTING",
                    }
                
                @schemas.classproperty
                def NETWORK_ACCESS_AND_SWITCHING(cls):
                    return cls("NetworkAccessAndSwitching")
                
                @schemas.classproperty
                def BRANCH_ROUTING(cls):
                    return cls("BranchRouting")
                
                @schemas.classproperty
                def WIRELESS_ACCESS(cls):
                    return cls("WirelessAccess")
                ...
                def NETWORK_ACCESS_AND_SWITCHING_AND_BR(cls):
                    return cls("NetworkAccessAndSwitchingAndBR")
                
                @schemas.classproperty
                def NETWORK_ACCESS_AND_BRANCH_ROUTING(cls):
                    return cls("NetworkAccessAndBranchRouting")
                
                @schemas.classproperty
                def SWITCHING_AND_BRANCH_ROUTING(cls):
                    return cls("SwitchingAndBranchRouting")
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "create_time", "update_time", "name", "predefined", "type", "org_id", "description", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "create_time", "update_time", "name", "predefined", "type", "org_id", "description", ], str]):

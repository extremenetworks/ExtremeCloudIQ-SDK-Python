...
class XiqMacObject(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "create_time", "update_time", "org_id", "name", "description", "predefined", "value", "mac_type", "defender_defined", "mac_address_end", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["mac_type"]) -> typing.Union['XiqMacObjectType', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "create_time", "update_time", "org_id", "name", "description", "predefined", "value", "mac_type", "defender_defined", "mac_address_end", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        mac_type: typing.Union['XiqMacObjectType', schemas.Unset] = schemas.unset,

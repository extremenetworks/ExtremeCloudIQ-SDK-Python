        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['XiqRmDevice']:
                        return XiqRmDevice
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['XiqRmDevice'], typing.List['XiqRmDevice']],
                ...
                def __getitem__(self, i: int) -> 'XiqRmDevice':

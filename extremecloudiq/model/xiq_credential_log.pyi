...
class XiqCredentialLog(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "username", "vhm_id", "org_id", "timestamp", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "username", "vhm_id", "org_id", "timestamp", ], str]):

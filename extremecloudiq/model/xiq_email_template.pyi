...
class XiqEmailTemplate(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            enable_preview = schemas.BoolSchema
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["enable_preview"]) -> MetaOapg.properties.enable_preview: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "create_time", "update_time", "name", "predefined", "password_type", "org_id", "description", "content", "enable_preview", "logo_url", "icon_url", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["enable_preview"]) -> typing.Union[MetaOapg.properties.enable_preview, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "create_time", "update_time", "name", "predefined", "password_type", "org_id", "description", "content", "enable_preview", "logo_url", "icon_url", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        enable_preview: typing.Union[MetaOapg.properties.enable_preview, bool, schemas.Unset] = schemas.unset,

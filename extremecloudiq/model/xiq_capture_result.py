...
class XiqCaptureResult(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "org_id", "start_time", "end_time", "device_id", "hostname", "mac_address", "interface_name", "location_id", "locations", "status", "error_message", "error_code", "storage", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "org_id", "start_time", "end_time", "device_id", "hostname", "mac_address", "interface_name", "location_id", "locations", "status", "error_message", "error_code", "storage", ], str]):

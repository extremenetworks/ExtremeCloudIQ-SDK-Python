...
class XiqCreateInternalRadiusServerRequest(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "authentication_method_group", "default_authentication_method", "enable_verify_server_cert", "enable_check_cert_common_name", "enable_check_user_for_tls_auth", "enable_authentication_server", "enable_radius_accounting_settings", "external_user_directory", "ca_certificate_id", "server_certificate_id", "server_key_id", "device_ids", "description", "server_key_password", "enable_check_user_for_peap_auth", "enable_check_user_for_ttls_auth", "authentication_server_port", "active_session_limit", "active_session_age_timeout", "clients", ], str]):

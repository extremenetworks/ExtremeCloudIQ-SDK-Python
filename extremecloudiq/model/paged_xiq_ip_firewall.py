        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['XiqIpFirewall']:
                        return XiqIpFirewall
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['XiqIpFirewall'], typing.List['XiqIpFirewall']],
                ...
                def __getitem__(self, i: int) -> 'XiqIpFirewall':

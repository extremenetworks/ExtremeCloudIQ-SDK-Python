...
class PagedXiqInternalRadiusServer(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['XiqInternalRadiusServer']:
                        return XiqInternalRadiusServer
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['XiqInternalRadiusServer'], typing.List['XiqInternalRadiusServer']],
                ...
                def __getitem__(self, i: int) -> 'XiqInternalRadiusServer':

...
class XiqWirelessWlan(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["network_policy_name", "ssid", "ssid_status", "ssid_security_type", "bssid", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["network_policy_name", "ssid", "ssid_status", "ssid_security_type", "bssid", ], str]):

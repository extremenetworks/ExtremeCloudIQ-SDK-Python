...
class XiqExternalUser(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "create_time", "update_time", "login_name", "user_role", "org_id", "location_ids", "grantee_id", "access_scope", "viq_access_control", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "create_time", "update_time", "login_name", "user_role", "org_id", "location_ids", "grantee_id", "access_scope", "viq_access_control", ], str]):

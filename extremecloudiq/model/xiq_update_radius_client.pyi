...
class XiqUpdateRadiusClient(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "shared_secret", "description", "l3_address_profile_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "shared_secret", "description", "l3_address_profile_id", ], str]):

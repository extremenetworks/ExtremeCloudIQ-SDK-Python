        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['XiqLocationTreeMap']:
                        return XiqLocationTreeMap
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['XiqLocationTreeMap'], typing.List['XiqLocationTreeMap']],
                ...
                def __getitem__(self, i: int) -> 'XiqLocationTreeMap':

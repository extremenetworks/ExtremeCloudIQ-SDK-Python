...
class XiqWirelessTimeToConnectResponse(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class quality_index_graph(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['XiqWirelessTimeToConnectEntity']:
                        return XiqWirelessTimeToConnectEntity
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['XiqWirelessTimeToConnectEntity'], typing.List['XiqWirelessTimeToConnectEntity']],
                ...
                def __getitem__(self, i: int) -> 'XiqWirelessTimeToConnectEntity':

        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['XiqRadioProfile']:
                        return XiqRadioProfile
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['XiqRadioProfile'], typing.List['XiqRadioProfile']],
                ...
                def __getitem__(self, i: int) -> 'XiqRadioProfile':

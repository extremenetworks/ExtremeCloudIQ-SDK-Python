...
class XiqD360ClientGridFilterRequest(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["number_filter", "alias", "auth_methods", "encryption_methods", "operating_systems", "ssids", "user_profiles", "frequency", "category_assignments", "client_type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["number_filter", "alias", "auth_methods", "encryption_methods", "operating_systems", "ssids", "user_profiles", "frequency", "category_assignments", "client_type", ], str]):
    ...
    ) -> 'XiqD360ClientGridFilterRequest':
        return super().__new__(
            cls,
            *_args,
            number_filter=number_filter,

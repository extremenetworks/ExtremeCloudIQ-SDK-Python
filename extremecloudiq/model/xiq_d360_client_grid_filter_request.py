...
class XiqD360ClientGridFilterRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["number_filter", "alias", "auth_methods", "encryption_methods", "operating_systems", "ssids", "user_profiles", "frequency", "category_assignments", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["number_filter", "alias", "auth_methods", "encryption_methods", "operating_systems", "ssids", "user_profiles", "frequency", "category_assignments", ], str]):

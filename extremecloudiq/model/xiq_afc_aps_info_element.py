...
class XiqAfcApsInfoElement(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["total_devices", "afc_status", "geo_location", "spectrum_mismatch", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["total_devices", "afc_status", "geo_location", "spectrum_mismatch", ], str]):

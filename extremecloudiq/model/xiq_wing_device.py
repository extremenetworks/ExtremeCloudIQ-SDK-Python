...
class XiqWingDevice(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["serial_number", "mac_address", "location", "network_policy_id", "hostname", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["serial_number", "mac_address", "location", "network_policy_id", "hostname", ], str]):

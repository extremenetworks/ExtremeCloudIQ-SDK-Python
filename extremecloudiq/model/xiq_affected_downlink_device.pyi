...
class XiqAffectedDownlinkDevice(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["host_name", "product_type", "interface_name", "port_id", "last_detected_time", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["host_name", "product_type", "interface_name", "port_id", "last_detected_time", ], str]):

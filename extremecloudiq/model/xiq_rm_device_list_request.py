...
class XiqRmDeviceListRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["site_ids", "sns", "mac_addresses", "hostnames", "default_gateway_ips", "product_types", "firmware_versions", "country_codes", "managed_by", "display_managed_by", "network_policies", "eth_uplink_speed_filters", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["site_ids", "sns", "mac_addresses", "hostnames", "default_gateway_ips", "product_types", "firmware_versions", "country_codes", "managed_by", "display_managed_by", "network_policies", "eth_uplink_speed_filters", ], str]):

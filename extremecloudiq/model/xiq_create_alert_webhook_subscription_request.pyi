...
class XiqCreateAlertWebhookSubscriptionRequest(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["url", "is_subscribe_all", "alert_policy_ids", "secret", "is_enabled", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["url", "is_subscribe_all", "alert_policy_ids", "secret", "is_enabled", ], str]):

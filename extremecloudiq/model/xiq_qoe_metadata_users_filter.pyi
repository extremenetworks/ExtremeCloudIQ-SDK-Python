...
class XiqQoeMetadataUsersFilter(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["site_ids", "building_ids", "floor_ids", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["site_ids", "building_ids", "floor_ids", ], str]):

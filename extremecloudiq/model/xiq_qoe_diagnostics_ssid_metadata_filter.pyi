...
class XiqQoeDiagnosticsSsidMetadataFilter(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["site_ids", "building_ids", "floor_ids", "start_time", "end_time", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["site_ids", "building_ids", "floor_ids", "start_time", "end_time", ], str]):
    ...
    ) -> 'XiqQoeDiagnosticsSsidMetadataFilter':
        return super().__new__(
            cls,
            *_args,
            site_ids=site_ids,

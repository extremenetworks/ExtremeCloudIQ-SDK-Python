...
class XiqRoamingTrialCount(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            slow_roam_count = schemas.Int64Schema
            __annotations__ = {
                "roam_completed": roam_completed,
                "roam_failed": roam_failed,
                "slow_roam_count": slow_roam_count,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["slow_roam_count"]) -> MetaOapg.properties.slow_roam_count: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["roam_completed", "roam_failed", "slow_roam_count", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["slow_roam_count"]) -> typing.Union[MetaOapg.properties.slow_roam_count, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["roam_completed", "roam_failed", "slow_roam_count", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        slow_roam_count: typing.Union[MetaOapg.properties.slow_roam_count, decimal.Decimal, int, schemas.Unset] = schemas.unset,

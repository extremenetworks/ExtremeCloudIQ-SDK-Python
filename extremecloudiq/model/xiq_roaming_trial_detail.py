...
class XiqRoamingTrialDetail(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            radio_type_from = schemas.StrSchema
            radio_type_to = schemas.StrSchema
            ...
            class status(
                ...
                @schemas.classproperty
                def ROAMING_FAILED(cls):
                    return cls("ROAMING_FAILED")
            ...
            __annotations__ = {
                ...
                "snr_from": snr_from,
                "snr_to": snr_to,
                "radio_type_from": radio_type_from,
                "radio_type_to": radio_type_to,
                "status": status,
                "reason": reason,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["radio_type_from"]) -> MetaOapg.properties.radio_type_from: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["radio_type_to"]) -> MetaOapg.properties.radio_type_to: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["channel_from", "channel_to", "rssi_from", "rssi_to", "snr_from", "snr_to", "radio_type_from", "radio_type_to", "status", "reason", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["radio_type_from"]) -> typing.Union[MetaOapg.properties.radio_type_from, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["radio_type_to"]) -> typing.Union[MetaOapg.properties.radio_type_to, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["channel_from", "channel_to", "rssi_from", "rssi_to", "snr_from", "snr_to", "radio_type_from", "radio_type_to", "status", "reason", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        radio_type_from: typing.Union[MetaOapg.properties.radio_type_from, str, schemas.Unset] = schemas.unset,
        radio_type_to: typing.Union[MetaOapg.properties.radio_type_to, str, schemas.Unset] = schemas.unset,

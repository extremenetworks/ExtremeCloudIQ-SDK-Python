...
class XiqCreateWebhookSubscriptionRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["application", "url", "message_type", "secret", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["application", "url", "message_type", "secret", ], str]):

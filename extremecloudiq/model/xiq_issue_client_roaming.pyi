...
class XiqIssueClientRoaming(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["date_time", "issue_type", "roaming_time", "device_name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["date_time", "issue_type", "roaming_time", "device_name", ], str]):

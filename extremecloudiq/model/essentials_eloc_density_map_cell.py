...
class EssentialsElocDensityMapCell(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["x", "y", "client_count", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["x", "y", "client_count", ], str]):

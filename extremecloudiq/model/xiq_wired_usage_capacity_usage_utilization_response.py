...
class XiqWiredUsageCapacityUsageUtilizationResponse(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["total_bandwidth_utilized", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["total_bandwidth_utilized", ], str]):
    ...
    ) -> 'XiqWiredUsageCapacityUsageUtilizationResponse':

...
class PagedXiqUsageCapacityGridResponse(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['XiqUsageCapacityGridResponse']:
                        return XiqUsageCapacityGridResponse
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['XiqUsageCapacityGridResponse'], typing.List['XiqUsageCapacityGridResponse']],
                ...
                def __getitem__(self, i: int) -> 'XiqUsageCapacityGridResponse':

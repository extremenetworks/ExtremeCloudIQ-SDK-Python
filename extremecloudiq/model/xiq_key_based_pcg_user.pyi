...
class XiqKeyBasedPcgUser(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "email", "user_group_name", "id", "create_time", "update_time", "org_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "email", "user_group_name", "id", "create_time", "update_time", "org_id", ], str]):

...
class PagedXiqCustomReportSchedule(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['XiqCustomReportSchedule']:
                        return XiqCustomReportSchedule
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['XiqCustomReportSchedule'], typing.List['XiqCustomReportSchedule']],
                ...
                def __getitem__(self, i: int) -> 'XiqCustomReportSchedule':

...
class XiqTunnelConcentrator(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            block_non_essential_broadcast = schemas.BoolSchema
            arp_proxy = schemas.BoolSchema
            
            
            class internal_mgmt_vlan(
                schemas.Int32Schema
            ):
            ...
            class multicast_rules(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['XiqMulticastRule']:
                        return XiqMulticastRule
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['XiqMulticastRule'], typing.List['XiqMulticastRule']],
                ...
                def __getitem__(self, i: int) -> 'XiqMulticastRule':
            ...
            __annotations__ = {
                ...
                "router_id": router_id,
                "gateway": gateway,
                "block_non_essential_broadcast": block_non_essential_broadcast,
                "arp_proxy": arp_proxy,
                "internal_mgmt_vlan": internal_mgmt_vlan,
                "keep_alive_interval": keep_alive_interval,
                "keep_alive_retries": keep_alive_retries,
                "multicast_rules": multicast_rules,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["block_non_essential_broadcast"]) -> MetaOapg.properties.block_non_essential_broadcast: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["arp_proxy"]) -> MetaOapg.properties.arp_proxy: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["internal_mgmt_vlan"]) -> MetaOapg.properties.internal_mgmt_vlan: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["keep_alive_interval"]) -> MetaOapg.properties.keep_alive_interval: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["keep_alive_retries"]) -> MetaOapg.properties.keep_alive_retries: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["multicast_rules"]) -> MetaOapg.properties.multicast_rules: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "create_time", "update_time", "name", "description", "primary_tc", "primary_listening_interface", "primary_bridging_interface", "primary_vlan", "primary_tagged", "tunnel_address", "native_vlan", "redundant", "backup_tc", "backup_listening_interface", "backup_bridging_interface", "primary_ip", "backup_ip", "backup_vlan", "backup_tagged", "router_id", "gateway", "block_non_essential_broadcast", "arp_proxy", "internal_mgmt_vlan", "keep_alive_interval", "keep_alive_retries", "multicast_rules", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["block_non_essential_broadcast"]) -> typing.Union[MetaOapg.properties.block_non_essential_broadcast, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["arp_proxy"]) -> typing.Union[MetaOapg.properties.arp_proxy, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["internal_mgmt_vlan"]) -> typing.Union[MetaOapg.properties.internal_mgmt_vlan, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["keep_alive_interval"]) -> typing.Union[MetaOapg.properties.keep_alive_interval, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["keep_alive_retries"]) -> typing.Union[MetaOapg.properties.keep_alive_retries, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["multicast_rules"]) -> typing.Union[MetaOapg.properties.multicast_rules, schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        block_non_essential_broadcast: typing.Union[MetaOapg.properties.block_non_essential_broadcast, bool, schemas.Unset] = schemas.unset,
        arp_proxy: typing.Union[MetaOapg.properties.arp_proxy, bool, schemas.Unset] = schemas.unset,
        internal_mgmt_vlan: typing.Union[MetaOapg.properties.internal_mgmt_vlan, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        keep_alive_interval: typing.Union[MetaOapg.properties.keep_alive_interval, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        keep_alive_retries: typing.Union[MetaOapg.properties.keep_alive_retries, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        multicast_rules: typing.Union[MetaOapg.properties.multicast_rules, list, tuple, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,

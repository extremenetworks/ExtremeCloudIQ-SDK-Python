...
class PagedXiqWiredUsageCapacityGridResponse(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['XiqWiredUsageCapacityGridResponse']:
                        return XiqWiredUsageCapacityGridResponse
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['XiqWiredUsageCapacityGridResponse'], typing.List['XiqWiredUsageCapacityGridResponse']],
                ...
                def __getitem__(self, i: int) -> 'XiqWiredUsageCapacityGridResponse':

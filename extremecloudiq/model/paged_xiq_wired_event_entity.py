...
class PagedXiqWiredEventEntity(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['XiqWiredEventEntity']:
                        return XiqWiredEventEntity
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['XiqWiredEventEntity'], typing.List['XiqWiredEventEntity']],
                ...
                def __getitem__(self, i: int) -> 'XiqWiredEventEntity':

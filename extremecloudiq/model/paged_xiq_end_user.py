        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['XiqEndUser']:
                        return XiqEndUser
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['XiqEndUser'], typing.List['XiqEndUser']],
                ...
                def __getitem__(self, i: int) -> 'XiqEndUser':

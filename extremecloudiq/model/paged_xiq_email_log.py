        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['XiqEmailLog']:
                        return XiqEmailLog
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['XiqEmailLog'], typing.List['XiqEmailLog']],
                ...
                def __getitem__(self, i: int) -> 'XiqEmailLog':

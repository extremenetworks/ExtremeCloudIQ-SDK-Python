        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['XiqDeviceAlarm']:
                        return XiqDeviceAlarm
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['XiqDeviceAlarm'], typing.List['XiqDeviceAlarm']],
                ...
                def __getitem__(self, i: int) -> 'XiqDeviceAlarm':

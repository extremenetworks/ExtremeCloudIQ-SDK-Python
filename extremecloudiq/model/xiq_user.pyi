...
class XiqUser(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            access_scope = schemas.Int32Schema
            viq_access_control = schemas.Int32Schema
            __annotations__ = {
                "id": id,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["viq_access_control"]) -> MetaOapg.properties.viq_access_control: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "create_time", "update_time", "login_name", "first_name", "last_name", "display_name", "phone", "job_title", "locale", "user_role", "idle_timeout", "last_login_time", "org_id", "location_ids", "access_scope", "viq_access_control", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["viq_access_control"]) -> typing.Union[MetaOapg.properties.viq_access_control, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "create_time", "update_time", "login_name", "first_name", "last_name", "display_name", "phone", "job_title", "locale", "user_role", "idle_timeout", "last_login_time", "org_id", "location_ids", "access_scope", "viq_access_control", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        access_scope: typing.Union[MetaOapg.properties.access_scope, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        viq_access_control: typing.Union[MetaOapg.properties.viq_access_control, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,

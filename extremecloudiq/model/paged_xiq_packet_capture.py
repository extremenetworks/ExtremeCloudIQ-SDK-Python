        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['XiqPacketCapture']:
                        return XiqPacketCapture
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['XiqPacketCapture'], typing.List['XiqPacketCapture']],
                ...
                def __getitem__(self, i: int) -> 'XiqPacketCapture':

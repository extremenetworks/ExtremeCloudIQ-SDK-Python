...
class XiqUpdateExternalUserRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["user_role", "org_id", "location_ids", "access_scope", "viq_access_control", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["user_role", "org_id", "location_ids", "access_scope", "viq_access_control", ], str]):

...
class XiqAssignDevicesNetworkPolicyRequest(
    schemas.DictSchema
):
    ...
    network_policy_id: MetaOapg.properties.network_policy_id
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["devices", "network_policy_id", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["network_policy_id"]) -> MetaOapg.properties.network_policy_id: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["devices", "network_policy_id", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        devices: 'XiqDeviceFilter',
        network_policy_id: typing.Union[MetaOapg.properties.network_policy_id, decimal.Decimal, int, ],

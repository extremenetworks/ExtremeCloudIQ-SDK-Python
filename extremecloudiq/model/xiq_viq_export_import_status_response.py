...
class XiqViqExportImportStatusResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["user_name", "vhm_id", "operation", "status", "total_finish_percentage", "viq_task_progresses", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["user_name", "vhm_id", "operation", "status", "total_finish_percentage", "viq_task_progresses", ], str]):

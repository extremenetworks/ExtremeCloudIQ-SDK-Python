...
class XiqSessionEntry(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["site_name", "value", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["site_name", "value", ], str]):

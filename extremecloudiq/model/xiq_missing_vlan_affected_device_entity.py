...
class XiqMissingVlanAffectedDeviceEntity(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["ap_name", "ap_device_id", "upstream_switch_interface", "interface_name", "missing_vlans", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["ap_name", "ap_device_id", "upstream_switch_interface", "interface_name", "missing_vlans", ], str]):

...
class XiqRmDeviceLocationDetails(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["site", "site_id", "building", "building_id", "floor", "floor_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["site", "site_id", "building", "building_id", "floor", "floor_id", ], str]):

...
class XiqRpChannelSelection(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            channel_selection_max_clients = schemas.Int32Schema
            enable_switch_channel_if_exceed_threshold = schemas.BoolSchema
            rf_interference_threshold = schemas.Int32Schema
            crc_error_threshold = schemas.Int32Schema
            __annotations__ = {
                "id": id,

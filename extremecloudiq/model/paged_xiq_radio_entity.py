        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['XiqRadioEntity']:
                        return XiqRadioEntity
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['XiqRadioEntity'], typing.List['XiqRadioEntity']],
                ...
                def __getitem__(self, i: int) -> 'XiqRadioEntity':

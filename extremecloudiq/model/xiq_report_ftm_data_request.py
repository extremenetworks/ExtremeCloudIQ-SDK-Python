...
class XiqReportFtmDataRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["owner_id", "ids", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["owner_id", "ids", ], str]):

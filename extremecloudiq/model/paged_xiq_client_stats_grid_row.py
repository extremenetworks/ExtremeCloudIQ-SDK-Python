...
class PagedXiqClientStatsGridRow(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['XiqClientStatsGridRow']:
                        return XiqClientStatsGridRow
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['XiqClientStatsGridRow'], typing.List['XiqClientStatsGridRow']],
                ...
                def __getitem__(self, i: int) -> 'XiqClientStatsGridRow':

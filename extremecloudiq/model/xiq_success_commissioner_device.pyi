...
class XiqSuccessCommissionerDevice(
    schemas.DictSchema
):
    ...
    A device where the commissioner operation completed successfully.
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["device_id", "serial_number", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["device_id", "serial_number", ], str]):

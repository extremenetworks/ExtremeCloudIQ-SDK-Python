...
class XiqClientUsage(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["client_id", "usage", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["client_id", "usage", ], str]):

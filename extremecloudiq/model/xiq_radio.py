...
class XiqRadio(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "channel_width", "mode", "channel_number", "mac_address", "power", "clients", "wlans", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "channel_width", "mode", "channel_number", "mac_address", "power", "clients", "wlans", ], str]):

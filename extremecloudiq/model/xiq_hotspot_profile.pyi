...
class XiqHotspotProfile(
        ...
        class properties:
            ...
            class service_providers(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['XiqHotspotServiceProviderProfile']:
                        return XiqHotspotServiceProviderProfile
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['XiqHotspotServiceProviderProfile'], typing.List['XiqHotspotServiceProviderProfile']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'service_providers':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'XiqHotspotServiceProviderProfile':
                    return super().__getitem__(i)
            __annotations__ = {
                "id": id,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["service_providers"]) -> MetaOapg.properties.service_providers: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "create_time", "update_time", "name", "domain_name", "hessid", "operator_names", "venue", "access_network_type", "dgaf", "ipv4_availability", "ipv6_availability", "wan_metrics", "connection_capabilities", "qos_map", "gas_comeback_delay", "anqp_domain_id", "online_signup", "nai_realms", "roaming_consortiums", "cellular_networks", "service_providers", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["service_providers"]) -> typing.Union[MetaOapg.properties.service_providers, schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        service_providers: typing.Union[MetaOapg.properties.service_providers, list, tuple, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,

...
class XiqCopilotPagedXiqAnomalyDeviceWithLocation(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['XiqAnomalyDeviceWithLocation']:
                        return XiqAnomalyDeviceWithLocation
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['XiqAnomalyDeviceWithLocation'], typing.List['XiqAnomalyDeviceWithLocation']],
                ...
                def __getitem__(self, i: int) -> 'XiqAnomalyDeviceWithLocation':
                    return super().__getitem__(i)
            summary = schemas.StrSchema
        
            @staticmethod
            def affected_count() -> typing.Type['XiqAnomalyAffectedCount']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["affected_count"]) -> 'XiqAnomalyAffectedCount': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["page", "count", "total_pages", "total_count", "data", "summary", "affected_count", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["affected_count"]) -> typing.Union['XiqAnomalyAffectedCount', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["page", "count", "total_pages", "total_count", "data", "summary", "affected_count", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        affected_count: typing.Union['XiqAnomalyAffectedCount', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,

...
class PagedXiqWiredClientHealthGridResponse(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['XiqWiredClientHealthGridResponse']:
                        return XiqWiredClientHealthGridResponse
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['XiqWiredClientHealthGridResponse'], typing.List['XiqWiredClientHealthGridResponse']],
                ...
                def __getitem__(self, i: int) -> 'XiqWiredClientHealthGridResponse':

...
class XiqUpdateRadioProfileRequest(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            afc_power_mode = schemas.StrSchema
            __annotations__ = {
                "name": name,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["afc_power_mode"]) -> MetaOapg.properties.afc_power_mode: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "description", "transmission_power", "max_transmit_power", "transmission_power_floor", "transmission_power_max_drop", "max_clients", "enable_client_transmission_power", "client_transmission_power", "radio_mode", "enable_ofdma", "afc_power_mode", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["afc_power_mode"]) -> typing.Union[MetaOapg.properties.afc_power_mode, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "description", "transmission_power", "max_transmit_power", "transmission_power_floor", "transmission_power_max_drop", "max_clients", "enable_client_transmission_power", "client_transmission_power", "radio_mode", "enable_ofdma", "afc_power_mode", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        afc_power_mode: typing.Union[MetaOapg.properties.afc_power_mode, str, schemas.Unset] = schemas.unset,

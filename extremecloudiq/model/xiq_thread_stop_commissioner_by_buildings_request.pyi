...
class XiqThreadStopCommissionerByBuildingsRequest(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["building_ids", "owner_id", "ext_pan_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["building_ids", "owner_id", "ext_pan_id", ], str]):

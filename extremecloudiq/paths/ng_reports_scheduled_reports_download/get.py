...
FileFormatSchema = XiqReportFileFormat
...
request_query_report_run_id = api_client.QueryParameter(
    name="reportRunId",
...
class BaseApi(api_client.Api):
    @typing.overload
    def _download_scheduled_report_file_oapg(
        self,
...
class DownloadScheduledReportFile(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def download_scheduled_report_file(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def download_scheduled_report_file(
        ...
        return self._download_scheduled_report_file_oapg(

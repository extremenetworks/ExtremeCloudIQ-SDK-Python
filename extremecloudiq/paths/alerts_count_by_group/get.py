...
# Path params
GroupSchema = XiqAlertGroupQuery
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'group': typing.Union[GroupSchema, ],
    }
)
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['XiqAlertGroupCount']:
            return XiqAlertGroupCount

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['XiqAlertGroupCount'], typing.List['XiqAlertGroupCount']],
    ...
    def __getitem__(self, i: int) -> 'XiqAlertGroupCount':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _count_alerts_by_group_oapg(
        self,
...
class CountAlertsByGroup(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def count_alerts_by_group(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def count_alerts_by_group(
        ...
        return self._count_alerts_by_group_oapg(

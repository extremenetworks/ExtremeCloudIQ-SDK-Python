...
# body param
SchemaForRequestBodyApplicationJson = XiqUpdateApiAccessTokenRequest


request_body_xiq_update_api_access_token_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = XiqApiAccessToken
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_api_access_token_oapg(
        self,
    ...
    def _update_api_access_token_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_update_api_access_token_request.serialize(body, content_type)
...
class UpdateApiAccessToken(BaseApi):
    ...
    def update_api_access_token(
        ...
        return self._update_api_access_token_oapg(
            body=body,

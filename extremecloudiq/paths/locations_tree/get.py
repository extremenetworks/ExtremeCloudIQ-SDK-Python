...
ExpandChildrenSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'expandChildren': typing.Union[ExpandChildrenSchema, bool, ],
    },
    total=False
)
...
request_query_expand_children = api_client.QueryParameter(
    name="expandChildren",
    style=api_client.ParameterStyle.FORM,
    schema=ExpandChildrenSchema,
    explode=True,
)
_auth = [
    'Bearer',
...
class GetLocationTree(BaseApi):
    ...
    def get_location_tree(
        ...
        return self._get_location_tree_oapg(

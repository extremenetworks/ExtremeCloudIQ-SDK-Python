...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['XiqKeyBasedPcg']:
            return XiqKeyBasedPcg

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['XiqKeyBasedPcg'], typing.List['XiqKeyBasedPcg']],
    ...
    def __getitem__(self, i: int) -> 'XiqKeyBasedPcg':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_key_based_private_client_groups_oapg(
        self,
...
class ListKeyBasedPrivateClientGroups(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_key_based_private_client_groups(
        self,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
    ...
    def list_key_based_private_client_groups(
        ...
        return self._list_key_based_private_client_groups_oapg(

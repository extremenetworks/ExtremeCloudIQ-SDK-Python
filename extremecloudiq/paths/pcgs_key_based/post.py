...
# body param
SchemaForRequestBodyApplicationJson = XiqInitKeyBasedPcgNetworkPolicyRequest


request_body_xiq_init_key_based_pcg_network_policy_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = XiqKeyBasedPcg
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_key_based_pcg_network_policy_oapg(
        self,
    ...
    def _create_key_based_pcg_network_policy_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_init_key_based_pcg_network_policy_request.serialize(body, content_type)
...
class CreateKeyBasedPcgNetworkPolicy(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def create_key_based_pcg_network_policy(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def create_key_based_pcg_network_policy(
        ...
        return self._create_key_based_pcg_network_policy_oapg(
            body=body,

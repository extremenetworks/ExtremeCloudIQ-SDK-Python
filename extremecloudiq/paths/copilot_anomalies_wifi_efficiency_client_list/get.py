...
SchemaFor200ResponseBodyApplicationJson = XiqWifiEfficiencyClientListResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_wifi_efficiency_client_list_oapg(
        self,
...
class GetWifiEfficiencyClientList(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_wifi_efficiency_client_list(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_wifi_efficiency_client_list(
        ...
        return self._get_wifi_efficiency_client_list_oapg(

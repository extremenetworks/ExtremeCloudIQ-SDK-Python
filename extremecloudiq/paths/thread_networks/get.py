...
class PageSchema(
    ...
    class MetaOapg:
        format = 'int32'
        inclusive_minimum = 1
FolderIdSchema = schemas.Int64Schema
...
class FieldsSchema(
    ...
    class MetaOapg:
        ...
        class items(
            ...
            @schemas.classproperty
            def CHANNEL_MASK(cls):
                return cls("CHANNEL_MASK")
            
            @schemas.classproperty
            def EXT_PAN_ID(cls):
                return cls("EXT_PAN_ID")
            
            @schemas.classproperty
            def MESH_LOCAL_PREFIX(cls):
                return cls("MESH_LOCAL_PREFIX")
            
            @schemas.classproperty
            def NETWORK_KEY(cls):
                return cls("NETWORK_KEY")
            
            @schemas.classproperty
            def NETWORK_NAME(cls):
                return cls("NETWORK_NAME")
            ...
            @schemas.classproperty
            def OBTAIN_NETWORK_KEY_ENABLED(cls):
                return cls("OBTAIN_NETWORK_KEY_ENABLED")
            
            @schemas.classproperty
            def NATIVE_COMMISSIONING_ENABLED(cls):
                return cls("NATIVE_COMMISSIONING_ENABLED")
            
            @schemas.classproperty
            def ROUTERS_ENABLED(cls):
                return cls("ROUTERS_ENABLED")
            
            @schemas.classproperty
            def EXTERNAL_COMMISSIONING_ENABLED(cls):
                return cls("EXTERNAL_COMMISSIONING_ENABLED")
            
            @schemas.classproperty
            def BEACONS_ENABLED(cls):
                return cls("BEACONS_ENABLED")
            
            @schemas.classproperty
            def COMMERCIAL_COMMISSIONING_ENABLED(cls):
                return cls("COMMERCIAL_COMMISSIONING_ENABLED")
            
            @schemas.classproperty
            def AUTONOMOUS_ENROLLMENT_ENABLED(cls):
                return cls("AUTONOMOUS_ENROLLMENT_ENABLED")
            
            @schemas.classproperty
            def NETWORK_KEY_PROVISIONING_ENABLED(cls):
                return cls("NETWORK_KEY_PROVISIONING_ENABLED")
            
            @schemas.classproperty
            def NON_CCM_ROUTERS_ENABLED(cls):
                return cls("NON_CCM_ROUTERS_ENABLED")
            
            @schemas.classproperty
            def ACTIVE_TIMESTAMP(cls):
                return cls("ACTIVE_TIMESTAMP")
...
SchemaFor200ResponseBodyApplicationJson = XiqThreadNetworks
...
class GetThreadNetworks(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_thread_networks(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_thread_networks(
        ...
        return self._get_thread_networks_oapg(

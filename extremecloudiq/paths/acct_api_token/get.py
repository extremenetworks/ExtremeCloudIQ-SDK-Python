...
SortFieldSchema = XiqApiAccessTokenSortField
...
SchemaFor200ResponseBodyApplicationJson = PagedXiqApiAccessToken
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_api_access_tokens_oapg(
        self,
...
class ListApiAccessTokens(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_api_access_tokens(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def list_api_access_tokens(
        ...
        return self._list_api_access_tokens_oapg(

...
# body param
SchemaForRequestBodyApplicationJson = XiqAlertPolicyFilter


request_body_xiq_alert_policy_filter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = XiqAlertPolicy
...
class BaseApi(api_client.Api):
    ...
    def _create_alert_policy_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_alert_policy_filter.serialize(body, content_type)
...
class CreateAlertPolicy(BaseApi):
    ...
    def create_alert_policy(
        ...
        return self._create_alert_policy_oapg(
            body=body,

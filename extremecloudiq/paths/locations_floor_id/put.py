...
# body param
SchemaForRequestBodyApplicationJson = XiqUpdateFloorRequest


request_body_xiq_update_floor_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = XiqFloor
...
class BaseApi(api_client.Api):
    ...
    def _update_floor_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_update_floor_request.serialize(body, content_type)
...
class UpdateFloor(BaseApi):
    ...
    def update_floor(
        ...
        return self._update_floor_oapg(
            body=body,

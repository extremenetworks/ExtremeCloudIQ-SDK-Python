...
SchemaFor200ResponseBodyApplicationJson = XiqCopilotMissingVlanPagedXiqMissingVlanExcludedVlanList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_missing_vlan_excluded_vlan_list_oapg(
        self,
...
class GetMissingVlanExcludedVlanList(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_missing_vlan_excluded_vlan_list(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_missing_vlan_excluded_vlan_list(
        ...
        return self._get_missing_vlan_excluded_vlan_list_oapg(

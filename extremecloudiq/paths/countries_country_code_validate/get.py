...
# Path params
CountryCodeSchema = schemas.Int32Schema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'countryCode': typing.Union[CountryCodeSchema, decimal.Decimal, int, ],
    }
)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _validate_country_code_oapg(
        self,
...
class ValidateCountryCode(BaseApi):
    ...
    def validate_country_code(
        ...
        return self._validate_country_code_oapg(

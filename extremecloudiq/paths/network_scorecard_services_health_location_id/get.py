...
SchemaFor200ResponseBodyApplicationJson = ServicesHealth
...
class GetServicesHealth(BaseApi):
    ...
    def get_services_health(
        ...
        return self._get_services_health_oapg(

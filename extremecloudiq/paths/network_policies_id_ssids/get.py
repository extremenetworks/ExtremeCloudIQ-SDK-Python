...
SchemaFor200ResponseBodyApplicationJson = PagedXiqSsid
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_ssids_by_network_policy_oapg(
        self,
...
class ListSsidsByNetworkPolicy(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_ssids_by_network_policy(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def list_ssids_by_network_policy(
        ...
        return self._list_ssids_by_network_policy_oapg(

...
AnomalyIdSchema = schemas.StrSchema
DeviceIdSchema = schemas.Int64Schema
LastDetectedTimeSchema = schemas.Int64Schema
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        'anomalyType': typing.Union[AnomalyTypeSchema, ],
        'anomalyId': typing.Union[AnomalyIdSchema, str, ],
        'deviceId': typing.Union[DeviceIdSchema, decimal.Decimal, int, ],
        'lastDetectedTime': typing.Union[LastDetectedTimeSchema, decimal.Decimal, int, ],
    }
)
...
request_query_anomaly_id = api_client.QueryParameter(
    name="anomalyId",
    style=api_client.ParameterStyle.FORM,
    schema=AnomalyIdSchema,
    required=True,
    explode=True,
)
...
request_query_last_detected_time = api_client.QueryParameter(
    name="lastDetectedTime",
    style=api_client.ParameterStyle.FORM,
    schema=LastDetectedTimeSchema,
    required=True,
    explode=True,
)
_auth = [
...
SchemaFor200ResponseBodyApplicationJson = XiqCopilotLldpCdpInfo
...
class BaseApi(api_client.Api):
    ...
    def _get_lldp_cdp_info_oapg(
        ...
        for parameter in (
            ...
            request_query_anomaly_id,
            request_query_device_id,
            request_query_last_detected_time,
        ):
...
class GetLldpCdpInfo(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_lldp_cdp_info(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_lldp_cdp_info(
        ...
        return self._get_lldp_cdp_info_oapg(

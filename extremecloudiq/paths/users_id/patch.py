...
# body param
SchemaForRequestBodyApplicationJson = XiqUpdateUserRequest


request_body_xiq_update_user_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = XiqUser
...
class BaseApi(api_client.Api):
    ...
    def _update_user_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_update_user_request.serialize(body, content_type)

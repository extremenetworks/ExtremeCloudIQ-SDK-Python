...
# body param
SchemaForRequestBodyApplicationJson = XiqUpdateLocationRequest


request_body_xiq_update_location_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_location_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_update_location_request.serialize(body, content_type)
...
class UpdateLocation(BaseApi):
    ...
    def update_location(
        ...
        return self._update_location_oapg(
            body=body,

...
SchemaFor200ResponseBodyApplicationJson = XiqPoeFlappingStatsResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_poe_flapping_stats_oapg(
        self,
...
class GetPoeFlappingStats(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_poe_flapping_stats(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_poe_flapping_stats(
        ...
        return self._get_poe_flapping_stats_oapg(

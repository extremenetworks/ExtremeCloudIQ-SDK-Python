...
SchemaFor200ResponseBodyApplicationJson = XiqRadiusClientObject
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_radius_client_object_oapg(
        self,
...
class GetRadiusClientObject(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_radius_client_object(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_radius_client_object(
        ...
        return self._get_radius_client_object_oapg(

...
# Query params
BackupFilesSchema = schemas.StrSchema
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        'backupFiles': typing.Union[BackupFilesSchema, str, ],
    }
)
...
request_query_backup_files = api_client.QueryParameter(
    name="backupFiles",
    style=api_client.ParameterStyle.FORM,
    schema=BackupFilesSchema,
    required=True,
    explode=True,
)
_auth = [
...
class DeleteBackup(BaseApi):
    ...
    def delete_backup(
        ...
        return self._delete_backup_oapg(

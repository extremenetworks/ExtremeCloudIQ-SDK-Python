...
SchemaFor200ResponseBodyApplicationJson = PagedXiqMacFirewall
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_mac_firewall_policies_oapg(
        self,
...
class ListMacFirewallPolicies(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_mac_firewall_policies(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def list_mac_firewall_policies(
        ...
        return self._list_mac_firewall_policies_oapg(

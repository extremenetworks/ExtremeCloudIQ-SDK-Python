...
SchemaFor200ResponseBodyApplicationJson = XiqUsageAndCapacityDashboard
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_usage_and_capacity_diagnostics_oapg(
        self,
...
class GetUsageAndCapacityDiagnostics(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_usage_and_capacity_diagnostics(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_usage_and_capacity_diagnostics(
        ...
        return self._get_usage_and_capacity_diagnostics_oapg(
            body=body,

...
# body param
SchemaForRequestBodyApplicationJson = RmUserGridRequest


request_body_rm_user_grid_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = PagedRmUsersGridResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_users_grid_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_rm_user_grid_request.serialize(body, content_type)
...
class ListUsersGrid(BaseApi):
    ...
    def list_users_grid(
        ...
        return self._list_users_grid_oapg(
            body=body,

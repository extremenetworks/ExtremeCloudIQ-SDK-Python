...
# body param
SchemaForRequestBodyApplicationJson = XiqUpdateNetworkPolicyRequest


request_body_xiq_update_network_policy_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = XiqNetworkPolicy
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_network_policy_oapg(
        self,
    ...
    def _update_network_policy_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_update_network_policy_request.serialize(body, content_type)
...
class UpdateNetworkPolicy(BaseApi):
    ...
    def update_network_policy(
        ...
        return self._update_network_policy_oapg(
            body=body,

...
SchemaFor200ResponseBodyApplicationJson = XiqClientHealthDashboard
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_client_health_diagnostics_oapg(
        self,
...
class GetClientHealthDiagnostics(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_client_health_diagnostics(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_client_health_diagnostics(
        ...
        return self._get_client_health_diagnostics_oapg(
            body=body,

...
SchemaFor200ResponseBodyApplicationJson = XiqCountApWithExcessiveRetriesResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_count_excessive_retries_oapg(
        self,
...
class GetCountExcessiveRetries(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_count_excessive_retries(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_count_excessive_retries(
        ...
        return self._get_count_excessive_retries_oapg(
            body=body,

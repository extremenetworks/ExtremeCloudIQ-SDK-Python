    ...
    class MetaOapg:
        ...
        class items(
            ...
            def UNIQUE_CLIENTS(cls):
                return cls("UNIQUE_CLIENTS")
            
            @schemas.classproperty
            def POOR_HEALTH_CLIENTS(cls):
                return cls("POOR_HEALTH_CLIENTS")
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['XiqClientGraphData']:
            return XiqClientGraphData

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['XiqClientGraphData'], typing.List['XiqClientGraphData']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ...
    def __getitem__(self, i: int) -> 'XiqClientGraphData':
        return super().__getitem__(i)
...
class GetClientGraph(BaseApi):
    ...
    def get_client_graph(
        ...
        return self._get_client_graph_oapg(

...
# body param
SchemaForRequestBodyApplicationJson = XiqCreateLdapServerRequest


request_body_xiq_create_ldap_server_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = XiqLdapServer
...
class BaseApi(api_client.Api):
    ...
    def _create_ldap_server_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_create_ldap_server_request.serialize(body, content_type)
...
class CreateLdapServer(BaseApi):
    ...
    def create_ldap_server(
        ...
        return self._create_ldap_server_oapg(
            body=body,

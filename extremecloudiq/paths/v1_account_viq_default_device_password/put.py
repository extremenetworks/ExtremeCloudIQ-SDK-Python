...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_default_device_password_with_validation_oapg(
        self,
...
class UpdateDefaultDevicePasswordWithValidation(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_default_device_password_with_validation(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,str, ],
        content_type: typing_extensions.Literal["application/json"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def update_default_device_password_with_validation(
        ...
        return self._update_default_device_password_with_validation_oapg(
            body=body,

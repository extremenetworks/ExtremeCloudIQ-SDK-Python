...
SchemaFor200ResponseBodyApplicationJson = XiqDeploymentByIdStatusResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_deployment_by_id_status_oapg(
        self,
...
class GetDeploymentByIdStatus(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_deployment_by_id_status(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_deployment_by_id_status(
        ...
        return self._get_deployment_by_id_status_oapg(

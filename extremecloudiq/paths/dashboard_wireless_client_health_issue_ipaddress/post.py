...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['XiqIssueClientIpAddress']:
            return XiqIssueClientIpAddress

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['XiqIssueClientIpAddress'], typing.List['XiqIssueClientIpAddress']],
    ...
    def __getitem__(self, i: int) -> 'XiqIssueClientIpAddress':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_client_ip_address_issues_oapg(
        self,
...
class GetClientIpAddressIssues(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_client_ip_address_issues(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def get_client_ip_address_issues(
        ...
        return self._get_client_ip_address_issues_oapg(
            body=body,

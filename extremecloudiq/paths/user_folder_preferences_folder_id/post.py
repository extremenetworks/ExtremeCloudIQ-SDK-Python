...
class BaseApi(api_client.Api):
    @typing.overload
    def _save_user_folder_preferences_oapg(
        self,
...
class SaveUserFolderPreferences(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def save_user_folder_preferences(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def save_user_folder_preferences(
        ...
        return self._save_user_folder_preferences_oapg(
            body=body,

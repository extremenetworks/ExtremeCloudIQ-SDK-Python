...
RequestRequiredQueryParams = typing_extensions.TypedDict(
    ...
    {
        'imageName': typing.Union[ImageNameSchema, str, ],
    }
)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _download_device_gallery_image_oapg(
        self,
...
class DownloadDeviceGalleryImage(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def download_device_gallery_image(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def download_device_gallery_image(
        ...
        return self._download_device_gallery_image_oapg(

...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['XiqThirdPartyApplication']:
            return XiqThirdPartyApplication

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['XiqThirdPartyApplication'], typing.List['XiqThirdPartyApplication']],
    ...
    def __getitem__(self, i: int) -> 'XiqThirdPartyApplication':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_api_access_tokens_oapg(
        self,
...
class GetApiAccessTokens(BaseApi):
    ...
    def get_api_access_tokens(
        ...
        return self._get_api_access_tokens_oapg(

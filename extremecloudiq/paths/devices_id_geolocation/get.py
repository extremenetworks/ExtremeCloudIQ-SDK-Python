...
SchemaFor200ResponseBodyApplicationJson = XiqDeviceGeolocation
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_device_geolocation_oapg(
        self,
...
class GetDeviceGeolocation(BaseApi):
    ...
    def get_device_geolocation(
        ...
        return self._get_device_geolocation_oapg(

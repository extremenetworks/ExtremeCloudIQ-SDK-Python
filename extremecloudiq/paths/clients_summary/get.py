...
SchemaFor200ResponseBodyApplicationJson = XiqClientSummary
...
class GetClientSummary(BaseApi):
    ...
    def get_client_summary(
        ...
        return self._get_client_summary_oapg(

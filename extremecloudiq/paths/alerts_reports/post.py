...
SchemaFor200ResponseBodyApplicationJson = XiqAlertReport
...
class CreateAlertReport(BaseApi):
    ...
    def create_alert_report(
        ...
        return self._create_alert_report_oapg(

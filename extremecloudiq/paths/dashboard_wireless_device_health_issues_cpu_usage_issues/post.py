...
SchemaFor200ResponseBodyApplicationJson = XiqDeviceCpuUsageIssueCount
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_device_cpu_usage_issue_count_oapg(
        self,
...
class GetDeviceCpuUsageIssueCount(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_device_cpu_usage_issue_count(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_device_cpu_usage_issue_count(
        ...
        return self._get_device_cpu_usage_issue_count_oapg(
            body=body,

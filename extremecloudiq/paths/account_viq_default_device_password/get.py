...
SchemaFor200ResponseBodyApplicationJson = XiqDefaultDevicePassword
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_default_device_password_oapg(
        self,
...
class GetDefaultDevicePassword(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_default_device_password(
        self,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
    ...
    def get_default_device_password(
        ...
        return self._get_default_device_password_oapg(

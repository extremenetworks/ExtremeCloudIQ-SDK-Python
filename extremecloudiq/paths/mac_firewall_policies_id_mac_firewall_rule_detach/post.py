...
# body param
SchemaForRequestBodyApplicationJson = schemas.Int64Schema
...
class BaseApi(api_client.Api):
    @typing.overload
    def _detach_service_to_mac_firewall_policy_oapg(
        self,
...
class DetachServiceToMacFirewallPolicy(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def detach_service_to_mac_firewall_policy(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,decimal.Decimal, int, ],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def detach_service_to_mac_firewall_policy(
        ...
        return self._detach_service_to_mac_firewall_policy_oapg(
            body=body,

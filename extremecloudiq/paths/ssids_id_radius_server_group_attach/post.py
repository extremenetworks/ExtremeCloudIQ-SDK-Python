...
class BaseApi(api_client.Api):
    @typing.overload
    def _attach_radius_server_group_to_ssid_oapg(
        self,
...
class AttachRadiusServerGroupToSsid(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def attach_radius_server_group_to_ssid(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,decimal.Decimal, int, ],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def attach_radius_server_group_to_ssid(
        ...
        return self._attach_radius_server_group_to_ssid_oapg(
            body=body,

...
SchemaFor201ResponseBodyApplicationJson = XiqIpFirewall
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_ip_firewall_policy_oapg(
        self,
...
class CreateIpFirewallPolicy(BaseApi):
    ...
    def create_ip_firewall_policy(
        ...
        return self._create_ip_firewall_policy_oapg(
            body=body,

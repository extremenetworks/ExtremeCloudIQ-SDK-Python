...
# body param
SchemaForRequestBodyApplicationJson = XiqUpdateBuildingRequest


request_body_xiq_update_building_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = XiqBuilding
...
class BaseApi(api_client.Api):
    ...
    def _update_building_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_update_building_request.serialize(body, content_type)
...
class UpdateBuilding(BaseApi):
    ...
    def update_building(
        ...
        return self._update_building_oapg(
            body=body,

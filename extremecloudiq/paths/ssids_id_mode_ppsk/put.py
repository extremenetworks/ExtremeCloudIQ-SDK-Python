...
# body param
SchemaForRequestBodyApplicationJson = XiqSetSsidModePpskRequest


request_body_xiq_set_ssid_mode_ppsk_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _set_ssid_mode_ppsk_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_set_ssid_mode_ppsk_request.serialize(body, content_type)
...
class SetSsidModePpsk(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def set_ssid_mode_ppsk(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def set_ssid_mode_ppsk(
        ...
        return self._set_ssid_mode_ppsk_oapg(
            body=body,

...
SchemaFor200ResponseBodyApplicationJson = PagedXiqRpMacOuiProfile
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_rp_mac_oui_profiles_oapg(
        self,
...
class ListRpMacOuiProfiles(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_rp_mac_oui_profiles(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def list_rp_mac_oui_profiles(
        ...
        return self._list_rp_mac_oui_profiles_oapg(

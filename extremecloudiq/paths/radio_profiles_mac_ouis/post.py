...
# body param
SchemaForRequestBodyApplicationJson = XiqCreateRpMacOuiProfileRequest


request_body_xiq_create_rp_mac_oui_profile_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = XiqRpMacOuiProfile
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_mac_oui_profile_oapg(
        self,
    ...
    def _create_mac_oui_profile_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_create_rp_mac_oui_profile_request.serialize(body, content_type)
...
class CreateMacOuiProfile(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def create_mac_oui_profile(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def create_mac_oui_profile(
        ...
        return self._create_mac_oui_profile_oapg(
            body=body,

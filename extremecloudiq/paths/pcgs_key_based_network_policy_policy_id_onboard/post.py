...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'policyId': typing.Union[PolicyIdSchema, decimal.Decimal, int, ],
    }
)
...
# body param
SchemaForRequestBodyApplicationJson = XiqOnboardKeyBasedPcgRequest


request_body_xiq_onboard_key_based_pcg_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = XiqOnboardKeyBasedPcgResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _onboard_key_based_private_client_group_oapg(
        self,
    ...
    def _onboard_key_based_private_client_group_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_onboard_key_based_pcg_request.serialize(body, content_type)
...
class OnboardKeyBasedPrivateClientGroup(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def onboard_key_based_private_client_group(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def onboard_key_based_private_client_group(
        ...
        return self._onboard_key_based_private_client_group_oapg(
            body=body,

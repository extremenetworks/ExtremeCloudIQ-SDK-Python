...
class LimitSchema(
    ...
    class MetaOapg:
        ...
        inclusive_minimum = 1
SortFieldSchema = XiqCloudConfigGroupSortField
...
SchemaFor200ResponseBodyApplicationJson = PagedXiqCloudConfigGroup
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_cloud_config_groups_oapg(
        self,
...
class ListCloudConfigGroups(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_cloud_config_groups(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def list_cloud_config_groups(
        ...
        return self._list_cloud_config_groups_oapg(

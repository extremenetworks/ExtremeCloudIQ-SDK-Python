...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['XiqUserGroupName']:
            return XiqUserGroupName

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['XiqUserGroupName'], typing.List['XiqUserGroupName']],
    ...
    def __getitem__(self, i: int) -> 'XiqUserGroupName':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_unique_user_group_names_oapg(
        self,
...
class ListUniqueUserGroupNames(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_unique_user_group_names(
        self,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
    ...
    def list_unique_user_group_names(
        ...
        return self._list_unique_user_group_names_oapg(

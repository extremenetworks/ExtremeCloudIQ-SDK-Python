...
SchemaFor200ResponseBodyApplicationJson = XiqSiteAfcSchedule
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_site_afc_schedule_oapg(
        self,
...
class GetSiteAfcSchedule(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_site_afc_schedule(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_site_afc_schedule(
        ...
        return self._get_site_afc_schedule_oapg(

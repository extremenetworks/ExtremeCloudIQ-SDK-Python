...
# Path params
ReportRunIdSchema = schemas.Int64Schema
...
request_path_report_run_id = api_client.PathParameter(
    name="reportRunId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ReportRunIdSchema,
    required=True,
)
SchemaFor200ResponseBodyApplicationJson = XiqRecipientsForReportRun
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_recipients_for_report_run_oapg(
        self,
...
class GetRecipientsForReportRun(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_recipients_for_report_run(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_recipients_for_report_run(
        ...
        return self._get_recipients_for_report_run_oapg(

...
SchemaFor200ResponseBodyApplicationJson = XiqClientHealthRoamingIssues
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_client_health_roaming_issues_oapg(
        self,
...
class GetClientHealthRoamingIssues(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_client_health_roaming_issues(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_client_health_roaming_issues(
        ...
        return self._get_client_health_roaming_issues_oapg(
            body=body,

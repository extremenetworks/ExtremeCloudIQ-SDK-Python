...
# body param
SchemaForRequestBodyApplicationJson = XiqCreateBuildingRequest


request_body_xiq_create_building_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_building_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_create_building_request.serialize(body, content_type)
...
class CreateBuilding(BaseApi):
    ...
    def create_building(
        ...
        return self._create_building_oapg(
            body=body,

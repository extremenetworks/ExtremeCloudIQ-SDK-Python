...
IpProtocolSchema = XiqNetworkIpProtocol
AlgTypeSchema = XiqNetworkAlgType
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'ipProtocol': typing.Union[IpProtocolSchema, ],
        'algType': typing.Union[AlgTypeSchema, ],
    },
    total=False
)
...
request_query_ip_protocol = api_client.QueryParameter(
    name="ipProtocol",
    style=api_client.ParameterStyle.FORM,
    schema=IpProtocolSchema,
    explode=True,
)
request_query_alg_type = api_client.QueryParameter(
    name="algType",
    style=api_client.ParameterStyle.FORM,
    schema=AlgTypeSchema,
    explode=True,
)
_auth = [
    'Bearer',
...
SchemaFor200ResponseBodyApplicationJson = PagedXiqNetworkService
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_network_services_oapg(
        self,
    ...
    def _list_network_services_oapg(
        ...
        for parameter in (
            ...
            request_query_limit,
            request_query_name,
            request_query_ip_protocol,
            request_query_alg_type,
        ):
...
class ListNetworkServices(BaseApi):
    ...
    def list_network_services(
        ...
        return self._list_network_services_oapg(

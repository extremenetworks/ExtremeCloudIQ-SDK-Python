...
# body param
SchemaForRequestBodyApplicationJson = XiqNetworkServiceRequest


request_body_xiq_network_service_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = XiqNetworkService
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_network_services_oapg(
        self,
    ...
    def _create_network_services_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_network_service_request.serialize(body, content_type)
...
class CreateNetworkServices(BaseApi):
    ...
    def create_network_services(
        ...
        return self._create_network_services_oapg(
            body=body,

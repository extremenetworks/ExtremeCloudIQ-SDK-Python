...
SchemaFor200ResponseBodyApplicationJson = XiqUserProfileAssignment
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_user_profile_assignment_oapg(
        self,
...
class GetUserProfileAssignment(BaseApi):
    ...
    def get_user_profile_assignment(
        ...
        return self._get_user_profile_assignment_oapg(

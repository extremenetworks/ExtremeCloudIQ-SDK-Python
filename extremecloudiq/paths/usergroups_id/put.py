...
# body param
SchemaForRequestBodyApplicationJson = XiqUpdateUserGroupRequest


request_body_xiq_update_user_group_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = XiqUserGroup
...
class BaseApi(api_client.Api):
    ...
    def _update_user_group_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_update_user_group_request.serialize(body, content_type)

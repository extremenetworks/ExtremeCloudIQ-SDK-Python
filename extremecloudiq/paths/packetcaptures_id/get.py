...
SchemaFor200ResponseBodyApplicationJson = XiqPacketCapture
...
class GetPacketCapture(BaseApi):
    ...
    def get_packet_capture(
        ...
        return self._get_packet_capture_oapg(

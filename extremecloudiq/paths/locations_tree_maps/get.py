...
SchemaFor200ResponseBodyApplicationJson = PagedXiqLocationTreeMap
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_location_maps_list_oapg(
        self,
...
class GetLocationMapsList(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_location_maps_list(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_location_maps_list(
        ...
        return self._get_location_maps_list_oapg(

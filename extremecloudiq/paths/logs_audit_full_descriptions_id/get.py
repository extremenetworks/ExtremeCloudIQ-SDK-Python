...
SchemaFor200ResponseBodyApplicationJson = XiqAuditLogFullDescriptions
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_audit_log_full_descriptions_oapg(
        self,
...
class GetAuditLogFullDescriptions(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_audit_log_full_descriptions(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_audit_log_full_descriptions(
        ...
        return self._get_audit_log_full_descriptions_oapg(

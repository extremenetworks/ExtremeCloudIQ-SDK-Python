...
SchemaFor200ResponseBodyApplicationJson = XiqMacFirewall
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_mac_firewall_policy_oapg(
        self,
...
class UpdateMacFirewallPolicy(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_mac_firewall_policy(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def update_mac_firewall_policy(
        ...
        return self._update_mac_firewall_policy_oapg(
            body=body,

...
SchemaFor200ResponseBodyApplicationJson = XiqClientHealthFrequencyDistribution
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_client_frequency_distribution_oapg(
        self,
...
class GetClientFrequencyDistribution(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_client_frequency_distribution(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_client_frequency_distribution(
        ...
        return self._get_client_frequency_distribution_oapg(
            body=body,

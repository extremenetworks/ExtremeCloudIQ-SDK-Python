...
SchemaFor200ResponseBodyApplicationJson = XiqDeviceSummary
...
class GetDeviceSummary(BaseApi):
    ...
    def get_device_summary(
        ...
        return self._get_device_summary_oapg(
            body=body,

...
# body param
SchemaForRequestBodyApplicationJson = RmUserFilterRequest


request_body_rm_user_filter_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = RmUsersGridFilterMetadata
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_user_grid_filter_metadata_oapg(
        self,
    ...
    def _list_user_grid_filter_metadata_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_rm_user_filter_request.serialize(body, content_type)
...
class ListUserGridFilterMetadata(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_user_grid_filter_metadata(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def list_user_grid_filter_metadata(
        ...
        return self._list_user_grid_filter_metadata_oapg(
            body=body,

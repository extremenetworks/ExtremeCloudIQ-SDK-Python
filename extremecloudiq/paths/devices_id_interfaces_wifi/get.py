...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['XiqDeviceWifiInterface']:
            return XiqDeviceWifiInterface

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['XiqDeviceWifiInterface'], typing.List['XiqDeviceWifiInterface']],
    ...
    def __getitem__(self, i: int) -> 'XiqDeviceWifiInterface':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_device_wifi_interface_oapg(
        self,
...
class GetDeviceWifiInterface(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_device_wifi_interface(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_device_wifi_interface(
        ...
        return self._get_device_wifi_interface_oapg(

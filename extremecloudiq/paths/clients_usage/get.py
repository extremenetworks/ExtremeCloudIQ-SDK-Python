...
RequestRequiredQueryParams = typing_extensions.TypedDict(
    ...
    {
        'clientIds': typing.Union[ClientIdsSchema, list, tuple, ],
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['XiqClientUsage']:
            return XiqClientUsage

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['XiqClientUsage'], typing.List['XiqClientUsage']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ...
    def __getitem__(self, i: int) -> 'XiqClientUsage':
        return super().__getitem__(i)
...
class GetClientUsage(BaseApi):
    ...
    def get_client_usage(
        ...
        return self._get_client_usage_oapg(

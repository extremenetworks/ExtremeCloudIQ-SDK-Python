...
# body param
SchemaForRequestBodyApplicationJson = XiqCreateSiteRequest


request_body_xiq_create_site_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = XiqSite
...
class BaseApi(api_client.Api):
    ...
    def _create_site_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_create_site_request.serialize(body, content_type)

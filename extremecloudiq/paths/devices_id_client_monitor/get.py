...
SchemaFor200ResponseBodyApplicationJson = XiqDeviceClientMonitor
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_device_client_monitor_oapg(
        self,
...
class GetDeviceClientMonitor(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_device_client_monitor(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_device_client_monitor(
        ...
        return self._get_device_client_monitor_oapg(

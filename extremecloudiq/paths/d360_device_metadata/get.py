...
SchemaFor200ResponseBodyApplicationJson = XiqDeviceMetaData
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_device_meta_data_oapg(
        self,
...
class GetDeviceMetaData(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_device_meta_data(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_device_meta_data(
        ...
        return self._get_device_meta_data_oapg(

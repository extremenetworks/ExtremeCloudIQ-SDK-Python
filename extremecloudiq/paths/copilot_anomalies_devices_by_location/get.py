...
SchemaFor200ResponseBodyApplicationJson = XiqAnomalyDevicesByLocationResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_devices_by_location_oapg(
        self,
...
class GetDevicesByLocation(BaseApi):
    ...
    def get_devices_by_location(
        ...
        return self._get_devices_by_location_oapg(

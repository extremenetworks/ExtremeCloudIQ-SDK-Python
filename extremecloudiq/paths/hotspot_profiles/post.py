...
# body param
SchemaForRequestBodyApplicationJson = XiqHotspotProfileRequest


request_body_xiq_hotspot_profile_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = XiqHotspotProfile
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_hotspot_profile_oapg(
        self,
    ...
    def _create_hotspot_profile_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_hotspot_profile_request.serialize(body, content_type)
...
class CreateHotspotProfile(BaseApi):
    ...
    def create_hotspot_profile(
        ...
        return self._create_hotspot_profile_oapg(
            body=body,

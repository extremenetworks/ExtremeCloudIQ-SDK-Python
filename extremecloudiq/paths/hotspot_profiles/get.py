...
SchemaFor200ResponseBodyApplicationJson = PagedXiqHotspotProfile
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_hotspot_profiles_oapg(
        self,
...
class ListHotspotProfiles(BaseApi):
    ...
    def list_hotspot_profiles(
        ...
        return self._list_hotspot_profiles_oapg(

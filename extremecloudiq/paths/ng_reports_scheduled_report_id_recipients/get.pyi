...
SchemaFor200ResponseBodyApplicationJson = XiqRecipientsForReportSchedule
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_recipients_for_report_oapg(
        self,
...
class GetRecipientsForReport(BaseApi):
    ...
    def get_recipients_for_report(
        ...
        return self._get_recipients_for_report_oapg(

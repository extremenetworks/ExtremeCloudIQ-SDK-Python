...
# Query params
TaskKeySchema = schemas.StrSchema
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        'taskKey': typing.Union[TaskKeySchema, str, ],
    }
)
...
request_query_task_key = api_client.QueryParameter(
    name="taskKey",
    style=api_client.ParameterStyle.FORM,
    schema=TaskKeySchema,
    required=True,
    explode=True,
)
# Path params
...
SchemaFor200ResponseBodyApplicationJson = XiqDeviceMonitorRefreshStatusResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _monitor_refresh_device_status_oapg(
        self,
...
class MonitorRefreshDeviceStatus(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def monitor_refresh_device_status(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def monitor_refresh_device_status(
        ...
        return self._monitor_refresh_device_status_oapg(

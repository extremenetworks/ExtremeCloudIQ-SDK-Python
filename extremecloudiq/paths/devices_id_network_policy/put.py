...
# Query params
NetworkPolicyIdSchema = schemas.Int64Schema
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        'networkPolicyId': typing.Union[NetworkPolicyIdSchema, decimal.Decimal, int, ],
    }
)
...
request_query_network_policy_id = api_client.QueryParameter(
    name="networkPolicyId",
    style=api_client.ParameterStyle.FORM,
    schema=NetworkPolicyIdSchema,
    required=True,
    explode=True,
)
# Path params
...
class BaseApi(api_client.Api):
    @typing.overload
    def _assign_device_network_policy_oapg(
        self,
    ...
    def _assign_device_network_policy_oapg(
        ...
        for parameter in (
            request_query_network_policy_id,
        ):
...
class AssignDeviceNetworkPolicy(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def assign_device_network_policy(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def assign_device_network_policy(
        ...
        return self._assign_device_network_policy_oapg(

...
# body param
SchemaForRequestBodyApplicationJson = XiqGrantExternalUserRequest


request_body_xiq_grant_external_user_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = XiqExternalUser
...
class BaseApi(api_client.Api):
    ...
    def _grant_external_user_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_grant_external_user_request.serialize(body, content_type)
...
class GrantExternalUser(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def grant_external_user(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def grant_external_user(
        ...
        return self._grant_external_user_oapg(
            body=body,

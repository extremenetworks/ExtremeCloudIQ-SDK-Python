...
SchemaFor200ResponseBodyApplicationJson = PagedXiqExternalUser
...
class ListExternalUsers(BaseApi):
    ...
    def list_external_users(
        ...
        return self._list_external_users_oapg(

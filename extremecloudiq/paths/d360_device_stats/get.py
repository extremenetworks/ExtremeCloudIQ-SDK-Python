...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['XiqD360DeviceStats']:
            return XiqD360DeviceStats

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['XiqD360DeviceStats'], typing.List['XiqD360DeviceStats']],
    ...
    def __getitem__(self, i: int) -> 'XiqD360DeviceStats':
...
class GetDeviceStats1(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_device_stats1(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_device_stats1(
        ...
        return self._get_device_stats1_oapg(

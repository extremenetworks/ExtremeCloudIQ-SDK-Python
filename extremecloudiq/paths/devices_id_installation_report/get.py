...
SchemaFor200ResponseBodyApplicationJson = XiqDeviceInstallationReport
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_xiq_device_installation_report_oapg(
        self,
...
class GetXiqDeviceInstallationReport(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_xiq_device_installation_report(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_xiq_device_installation_report(
        ...
        return self._get_xiq_device_installation_report_oapg(

...
# body param
SchemaForRequestBodyApplicationJson = XiqUpdateClientMonitorProfileRequest


request_body_xiq_update_client_monitor_profile_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = XiqClientMonitorProfile
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_client_monitor_profile_oapg(
        self,
    ...
    def _update_client_monitor_profile_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_update_client_monitor_profile_request.serialize(body, content_type)
...
class UpdateClientMonitorProfile(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_client_monitor_profile(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def update_client_monitor_profile(
        ...
        return self._update_client_monitor_profile_oapg(
            body=body,

...
# body param
SchemaForRequestBodyApplicationJson = XiqCreateUserGroupRequest


request_body_xiq_create_user_group_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_user_group_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_create_user_group_request.serialize(body, content_type)

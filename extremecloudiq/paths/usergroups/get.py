...
class LimitSchema(
    ...
    class MetaOapg:
        ...
        inclusive_minimum = 1
PasswordDbLocationSchema = XiqPasswordDbLocation
PasswordTypeSchema = XiqPasswordType
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'password_db_location': typing.Union[PasswordDbLocationSchema, ],
        'password_type': typing.Union[PasswordTypeSchema, ],
    },
    total=False
)
...
request_query_password_db_location = api_client.QueryParameter(
    name="password_db_location",
    style=api_client.ParameterStyle.FORM,
    schema=PasswordDbLocationSchema,
    explode=True,
)
request_query_password_type = api_client.QueryParameter(
    name="password_type",
    style=api_client.ParameterStyle.FORM,
...
SchemaFor200ResponseBodyApplicationJson = PagedXiqUserGroup
...
class BaseApi(api_client.Api):
    ...
    def _list_user_groups_oapg(
        ...
        for parameter in (
            request_query_page,
            request_query_limit,
            request_query_password_db_location,
            request_query_password_type,
        ):
...
class ListUserGroups(BaseApi):
    ...
    def list_user_groups(
        ...
        return self._list_user_groups_oapg(

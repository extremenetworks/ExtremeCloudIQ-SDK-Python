...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'passwordType': typing.Union[PasswordTypeSchema, ],
    },
    total=False
)
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['XiqSmsTemplate']:
            return XiqSmsTemplate

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['XiqSmsTemplate'], typing.List['XiqSmsTemplate']],
    ...
    def __getitem__(self, i: int) -> 'XiqSmsTemplate':
...
class ListSmsTemplates(BaseApi):
    ...
    def list_sms_templates(
        ...
        return self._list_sms_templates_oapg(

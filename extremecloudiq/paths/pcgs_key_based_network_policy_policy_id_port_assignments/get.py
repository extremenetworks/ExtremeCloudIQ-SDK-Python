...
SchemaFor200ResponseBodyApplicationJson = XiqGetPortAssignmentDetailsResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_port_assignments_oapg(
        self,
...
class GetPortAssignments(BaseApi):
    ...
    def get_port_assignments(
        ...
        return self._get_port_assignments_oapg(

...
# body param
SchemaForRequestBodyApplicationJson = XiqPcgAssignPortsRequest


request_body_xiq_pcg_assign_ports_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = XiqPcgAssignPortsResponse
...
class BaseApi(api_client.Api):
    ...
    def _assign_ports_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_pcg_assign_ports_request.serialize(body, content_type)
...
class AssignPorts(BaseApi):
    ...
    def assign_ports(
        ...
        return self._assign_ports_oapg(
            body=body,

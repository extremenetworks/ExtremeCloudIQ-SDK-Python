...
# body param
SchemaForRequestBodyApplicationJson = XiqUpdateRpNeighborhoodAnalysisRequest


request_body_xiq_update_rp_neighborhood_analysis_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = XiqRpNeighborhoodAnalysis
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_neighborhood_analysis_oapg(
        self,
    ...
    def _update_neighborhood_analysis_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_update_rp_neighborhood_analysis_request.serialize(body, content_type)
...
class UpdateNeighborhoodAnalysis(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_neighborhood_analysis(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def update_neighborhood_analysis(
        ...
        return self._update_neighborhood_analysis_oapg(
            body=body,

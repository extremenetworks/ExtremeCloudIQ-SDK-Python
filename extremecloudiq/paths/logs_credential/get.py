...
SchemaFor200ResponseBodyApplicationJson = PagedXiqCredentialLog
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_credential_logs_oapg(
        self,
...
class ListCredentialLogs(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_credential_logs(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def list_credential_logs(
        ...
        return self._list_credential_logs_oapg(

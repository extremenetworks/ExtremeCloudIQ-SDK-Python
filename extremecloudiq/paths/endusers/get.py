...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'user_group_ids': typing.Union[UserGroupIdsSchema, list, tuple, ],
...
SchemaFor200ResponseBodyApplicationJson = PagedXiqEndUser
...
class ListEndUsers(BaseApi):
    ...
    def list_end_users(
        ...
        return self._list_end_users_oapg(

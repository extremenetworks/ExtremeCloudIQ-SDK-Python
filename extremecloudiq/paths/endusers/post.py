...
# body param
SchemaForRequestBodyApplicationJson = XiqCreateEndUserRequest


request_body_xiq_create_end_user_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = XiqEndUser
...
class BaseApi(api_client.Api):
    ...
    def _create_end_user_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_create_end_user_request.serialize(body, content_type)
...
class CreateEndUser(BaseApi):
    ...
    def create_end_user(
        ...
        return self._create_end_user_oapg(
            body=body,

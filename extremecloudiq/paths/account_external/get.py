...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['XiqExternalAccount']:
            return XiqExternalAccount

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['XiqExternalAccount'], typing.List['XiqExternalAccount']],
    ...
    def __getitem__(self, i: int) -> 'XiqExternalAccount':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_external_accounts_oapg(
        self,
...
class ListExternalAccounts(BaseApi):
    ...
    def list_external_accounts(
        ...
        return self._list_external_accounts_oapg(

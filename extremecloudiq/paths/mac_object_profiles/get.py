...
SchemaFor200ResponseBodyApplicationJson = PagedXiqMacObject
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_mac_object_profiles_oapg(
        self,
...
class ListMacObjectProfiles(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_mac_object_profiles(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def list_mac_object_profiles(
        ...
        return self._list_mac_object_profiles_oapg(

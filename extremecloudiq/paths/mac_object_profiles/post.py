...
# body param
SchemaForRequestBodyApplicationJson = XiqCreateMacObjectRequest


request_body_xiq_create_mac_object_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = XiqMacObject
...
class BaseApi(api_client.Api):
    ...
    def _create_mac_object_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_create_mac_object_request.serialize(body, content_type)
...
class CreateMacObject(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def create_mac_object(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def create_mac_object(
        ...
        return self._create_mac_object_oapg(
            body=body,

...
# Query params
ViqOperationTypeSchema = XiqViqOperationType
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        'viqOperationType': typing.Union[ViqOperationTypeSchema, ],
    }
)
...
request_query_viq_operation_type = api_client.QueryParameter(
    name="viqOperationType",
    style=api_client.ParameterStyle.FORM,
    schema=ViqOperationTypeSchema,
    required=True,
    explode=True,
)
_auth = [
...
SchemaFor200ResponseBodyApplicationJson = XiqViqExportImportStatusResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _export_import_status_oapg(
        self,
    ...
    def _export_import_status_oapg(
        ...
        for parameter in (
            request_query_viq_operation_type,
        ):
...
class ExportImportStatus(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def export_import_status(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def export_import_status(
        ...
        return self._export_import_status_oapg(

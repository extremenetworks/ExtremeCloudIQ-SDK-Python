...
SchemaFor200ResponseBodyApplicationJson = XiqDfsRecurenceChannelStatsResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_dfs_recurrence_channel_stats_oapg(
        self,
...
class GetDfsRecurrenceChannelStats(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_dfs_recurrence_channel_stats(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_dfs_recurrence_channel_stats(
        ...
        return self._get_dfs_recurrence_channel_stats_oapg(

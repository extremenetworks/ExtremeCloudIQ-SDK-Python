...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['XiqCountry']:
            return XiqCountry

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['XiqCountry'], typing.List['XiqCountry']],
    ...
    def __getitem__(self, i: int) -> 'XiqCountry':
...
class GetCountryList(BaseApi):
    ...
    def get_country_list(
        ...
        return self._get_country_list_oapg(

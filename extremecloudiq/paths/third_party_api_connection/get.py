...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['XiqThirdPartyApiConnection']:
            return XiqThirdPartyApiConnection

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['XiqThirdPartyApiConnection'], typing.List['XiqThirdPartyApiConnection']],
    ...
    def __getitem__(self, i: int) -> 'XiqThirdPartyApiConnection':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_third_party_api_connections_oapg(
        self,
...
class ListThirdPartyApiConnections(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_third_party_api_connections(
        self,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
    ...
    def list_third_party_api_connections(
        ...
        return self._list_third_party_api_connections_oapg(

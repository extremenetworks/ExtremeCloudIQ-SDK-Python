...
SchemaFor200ResponseBodyApplicationJson = XiqApiTokenInfo
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_current_api_token_info_oapg(
        self,
...
class GetCurrentApiTokenInfo(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_current_api_token_info(
        self,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
    ...
    def get_current_api_token_info(
        ...
        return self._get_current_api_token_info_oapg(

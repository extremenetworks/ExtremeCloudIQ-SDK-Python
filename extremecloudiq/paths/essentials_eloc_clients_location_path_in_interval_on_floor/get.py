...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['EssentialsElocClientPathPoint']:
            return EssentialsElocClientPathPoint

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['EssentialsElocClientPathPoint'], typing.List['EssentialsElocClientPathPoint']],
    ...
    def __getitem__(self, i: int) -> 'EssentialsElocClientPathPoint':
...
class GetClientPath(BaseApi):
    ...
    def get_client_path(
        ...
        return self._get_client_path_oapg(

...
CallingStationIdSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'callingStationId': typing.Union[CallingStationIdSchema, str, ],
...
request_query_calling_station_id = api_client.QueryParameter(
    name="callingStationId",
    style=api_client.ParameterStyle.FORM,
    schema=CallingStationIdSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = PagedXiqAccountingLog
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_accounting_logs_oapg(
        self,
    ...
    def _list_accounting_logs_oapg(
        ...
        for parameter in (
            ...
            request_query_calling_station_id,
...
class ListAccountingLogs(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_accounting_logs(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def list_accounting_logs(
        ...
        return self._list_accounting_logs_oapg(

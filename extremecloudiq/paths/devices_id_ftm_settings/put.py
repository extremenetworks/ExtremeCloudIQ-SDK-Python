...
# body param
SchemaForRequestBodyApplicationJson = XiqFtmSettingsRequest


request_body_xiq_ftm_settings_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = XiqFtmSettings
...
class BaseApi(api_client.Api):
    @typing.overload
    def _configure_ftm_settings_oapg(
        self,
    ...
    def _configure_ftm_settings_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_ftm_settings_request.serialize(body, content_type)
...
class ConfigureFtmSettings(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def configure_ftm_settings(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def configure_ftm_settings(
        ...
        return self._configure_ftm_settings_oapg(
            body=body,

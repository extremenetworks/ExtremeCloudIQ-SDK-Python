...
SchemaFor200ResponseBodyApplicationJson = XiqDeleteBulkAlertSubscriptionWebhookResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_bulk_alert_subscription_webhook_oapg(
        self,
...
class DeleteBulkAlertSubscriptionWebhook(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def delete_bulk_alert_subscription_webhook(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def delete_bulk_alert_subscription_webhook(
        ...
        return self._delete_bulk_alert_subscription_webhook_oapg(
            body=body,

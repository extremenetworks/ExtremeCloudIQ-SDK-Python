...
request_query_stats_field = api_client.QueryParameter(
    name="statsField",
    style=api_client.ParameterStyle.FORM,
    schema=StatsFieldSchema,
    required=True,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = XiqHardwareHealthCpuMemStatsResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_hardware_health_cpu_mem_stats_oapg(
        self,
...
class GetHardwareHealthCpuMemStats(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_hardware_health_cpu_mem_stats(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_hardware_health_cpu_mem_stats(
        ...
        return self._get_hardware_health_cpu_mem_stats_oapg(

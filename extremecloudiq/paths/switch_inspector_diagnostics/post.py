...
SchemaFor200ResponseBodyApplicationJson = XiqSwitchInspectorPanelDiagnosticsResponse
...
class GetDiagnostics(BaseApi):
    ...
    def get_diagnostics(
        ...
        return self._get_diagnostics_oapg(

...
SchemaFor200ResponseBodyApplicationJson = PagedXiqTunnelConcentrator
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_tunnel_concentrators_oapg(
        self,
...
class ListTunnelConcentrators(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_tunnel_concentrators(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def list_tunnel_concentrators(
        ...
        return self._list_tunnel_concentrators_oapg(

...
SchemaFor201ResponseBodyApplicationJson = XiqTunnelConcentrator
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_tunnel_concentrator_oapg(
        self,
...
class CreateTunnelConcentrator(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def create_tunnel_concentrator(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def create_tunnel_concentrator(
        ...
        return self._create_tunnel_concentrator_oapg(
            body=body,

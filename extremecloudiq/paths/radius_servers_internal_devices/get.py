...
SchemaFor200ResponseBodyApplicationJson = PagedXiqInternalRadiusDevice
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_internal_radius_devices_oapg(
        self,
...
class ListInternalRadiusDevices(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_internal_radius_devices(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def list_internal_radius_devices(
        ...
        return self._list_internal_radius_devices_oapg(

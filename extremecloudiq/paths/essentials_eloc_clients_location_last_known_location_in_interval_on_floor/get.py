...
IntervalSchema = XiqClientLocationSearchInterval
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        ...
        'interval': typing.Union[IntervalSchema, ],
    }
)
...
SchemaFor200ResponseBodyApplicationJson = EssentialsElocLastKnownLocation
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_client_last_known_location_in_interval_oapg(
        self,
...
class GetClientLastKnownLocationInInterval(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_client_last_known_location_in_interval(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_client_last_known_location_in_interval(
        ...
        return self._get_client_last_known_location_in_interval_oapg(

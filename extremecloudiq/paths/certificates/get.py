...
SchemaFor200ResponseBodyApplicationJson = PagedXiqCertificate
...
class ListCertificates(BaseApi):
    ...
    def list_certificates(
        ...
        return self._list_certificates_oapg(

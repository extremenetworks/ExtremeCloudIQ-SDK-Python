...
SchemaFor200ResponseBodyApplicationJson = PagedXiqCwp
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_captive_web_portals_oapg(
        self,
...
class ListCaptiveWebPortals(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_captive_web_portals(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def list_captive_web_portals(
        ...
        return self._list_captive_web_portals_oapg(

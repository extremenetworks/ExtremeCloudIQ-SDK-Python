...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def additional_properties() -> typing.Type['XiqDeviceClientMonitor']:
            return XiqDeviceClientMonitor
    
    def __getitem__(self, name: typing.Union[str, ]) -> 'XiqDeviceClientMonitor':
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    def get_item_oapg(self, name: typing.Union[str, ]) -> 'XiqDeviceClientMonitor':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _query_devices_client_monitor_oapg(
        self,
...
class QueryDevicesClientMonitor(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def query_devices_client_monitor(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def query_devices_client_monitor(
        ...
        return self._query_devices_client_monitor_oapg(
            body=body,

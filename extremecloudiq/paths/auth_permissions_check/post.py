...
# body param
SchemaForRequestBodyApplicationJson = XiqCheckPermissionRequest


request_body_xiq_check_permission_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _check_permissions_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_check_permission_request.serialize(body, content_type)
...
class CheckPermissions(BaseApi):
    ...
    def check_permissions(
        ...
        return self._check_permissions_oapg(
            body=body,

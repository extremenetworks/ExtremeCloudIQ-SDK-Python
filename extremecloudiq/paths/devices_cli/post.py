...
# body param
SchemaForRequestBodyApplicationJson = XiqSendCliRequest


request_body_xiq_send_cli_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = XiqSendCliResponse
...
class BaseApi(api_client.Api):
    ...
    def _send_cli_to_devices_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_send_cli_request.serialize(body, content_type)
...
class SendCliToDevices(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def send_cli_to_devices(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def send_cli_to_devices(
        ...
        return self._send_cli_to_devices_oapg(
            body=body,

...
SchemaFor200ResponseBodyApplicationJson = XiqCountApWithPacketLossExcessiveResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_packet_loss_excessive_response_oapg(
        self,
...
class GetPacketLossExcessiveResponse(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_packet_loss_excessive_response(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_packet_loss_excessive_response(
        ...
        return self._get_packet_loss_excessive_response_oapg(
            body=body,

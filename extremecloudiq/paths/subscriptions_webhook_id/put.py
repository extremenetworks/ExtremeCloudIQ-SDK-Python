...
# body param
SchemaForRequestBodyApplicationJson = XiqUpdateWebhookSubscriptionRequest


request_body_xiq_update_webhook_subscription_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = XiqWebhookSubscription
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_webhook_subscription_oapg(
        self,
    ...
    def _update_webhook_subscription_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_update_webhook_subscription_request.serialize(body, content_type)
...
class UpdateWebhookSubscription(BaseApi):
    ...
    def update_webhook_subscription(
        ...
        return self._update_webhook_subscription_oapg(
            body=body,

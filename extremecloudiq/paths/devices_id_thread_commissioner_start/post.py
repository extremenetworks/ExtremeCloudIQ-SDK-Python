...
# body param
SchemaForRequestBodyApplicationJson = XiqThreadStartCommissionerRequest


request_body_xiq_thread_start_commissioner_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _start_thread_commissioner_oapg(
        self,
    ...
    def _start_thread_commissioner_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_thread_start_commissioner_request.serialize(body, content_type)
...
class StartThreadCommissioner(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def start_thread_commissioner(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def start_thread_commissioner(
        ...
        return self._start_thread_commissioner_oapg(
            body=body,

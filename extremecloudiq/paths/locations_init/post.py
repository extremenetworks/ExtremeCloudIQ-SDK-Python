...
# body param
SchemaForRequestBodyApplicationJson = XiqInitializeLocationRequest


request_body_xiq_initialize_location_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = XiqLocation
...
class BaseApi(api_client.Api):
    ...
    def _initialize_location_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_initialize_location_request.serialize(body, content_type)
...
class InitializeLocation(BaseApi):
    ...
    def initialize_location(
        ...
        return self._initialize_location_oapg(
            body=body,

...
SchemaFor200ResponseBodyApplicationJson = XiqNgCannedReport
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_network_summary_reports_oapg(
        self,
...
class GetNetworkSummaryReports(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_network_summary_reports(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_network_summary_reports(
        ...
        return self._get_network_summary_reports_oapg(

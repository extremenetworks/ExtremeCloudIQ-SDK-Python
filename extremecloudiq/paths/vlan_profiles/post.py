...
# body param
SchemaForRequestBodyApplicationJson = XiqCreateVlanProfileRequest


request_body_xiq_create_vlan_profile_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = XiqVlanProfile
...
class BaseApi(api_client.Api):
    ...
    def _create_vlan_profile_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_create_vlan_profile_request.serialize(body, content_type)
...
class CreateVlanProfile(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def create_vlan_profile(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def create_vlan_profile(
        ...
        return self._create_vlan_profile_oapg(
            body=body,

...
SchemaFor200ResponseBodyApplicationJson = RmUserTypeDistribution
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_user_type_distribution_oapg(
        self,
...
class GetUserTypeDistribution(BaseApi):
    ...
    def get_user_type_distribution(
        ...
        return self._get_user_type_distribution_oapg(
            body=body,

...
SchemaFor200ResponseBodyApplicationJson = XiqAnomaliesNotificationsResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_anomalies_notifications_oapg(
        self,
...
class GetAnomaliesNotifications(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_anomalies_notifications(
        self,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
    ...
    def get_anomalies_notifications(
        ...
        return self._get_anomalies_notifications_oapg(

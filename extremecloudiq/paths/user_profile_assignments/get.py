...
SchemaFor200ResponseBodyApplicationJson = PagedXiqUserProfileAssignment
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_user_profile_assignments_oapg(
        self,
...
class ListUserProfileAssignments(BaseApi):
    ...
    def list_user_profile_assignments(
        ...
        return self._list_user_profile_assignments_oapg(

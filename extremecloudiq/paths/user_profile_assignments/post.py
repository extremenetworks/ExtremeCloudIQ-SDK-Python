...
# body param
SchemaForRequestBodyApplicationJson = XiqCreateUserProfileAssignmentRequest


request_body_xiq_create_user_profile_assignment_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = XiqUserProfileAssignment
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_user_profile_assignment_oapg(
        self,
    ...
    def _create_user_profile_assignment_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_create_user_profile_assignment_request.serialize(body, content_type)
...
class CreateUserProfileAssignment(BaseApi):
    ...
    def create_user_profile_assignment(
        ...
        return self._create_user_profile_assignment_oapg(
            body=body,

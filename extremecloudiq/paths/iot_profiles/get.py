...
class LimitSchema(
    ...
    class MetaOapg:
        ...
        inclusive_minimum = 1
AppIdSchema = XiqIotApplicationId
AppSupportedSchema = XiqIotApplicationSupported
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'appId': typing.Union[AppIdSchema, ],
        'appSupported': typing.Union[AppSupportedSchema, ],
    },
    total=False
)
...
request_query_app_supported = api_client.QueryParameter(
    name="appSupported",
    style=api_client.ParameterStyle.FORM,
    schema=AppSupportedSchema,
    explode=True,
)
_auth = [
    'Bearer',
...
SchemaFor200ResponseBodyApplicationJson = PagedXiqIotProfile
...
class ListIotProfiles(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_iot_profiles(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def list_iot_profiles(
        ...
        return self._list_iot_profiles_oapg(

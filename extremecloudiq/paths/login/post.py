...
# body param
SchemaForRequestBodyApplicationJson = XiqLoginRequest


request_body_xiq_login_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _login_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_login_request.serialize(body, content_type)

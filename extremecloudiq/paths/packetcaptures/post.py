...
# body param
SchemaForRequestBodyApplicationJson = XiqPacketCapture


request_body_xiq_packet_capture = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_packet_capture_oapg(
        self,
    ...
    def _create_packet_capture_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_packet_capture.serialize(body, content_type)
...
class CreatePacketCapture(BaseApi):
    ...
    def create_packet_capture(
        ...
        return self._create_packet_capture_oapg(
            body=body,

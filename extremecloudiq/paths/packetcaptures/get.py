...
class LimitSchema(
    ...
    class MetaOapg:
        ...
        inclusive_minimum = 1
SortFieldSchema = XiqPacketCaptureSortField
...
class FieldsSchema(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['XiqPacketCaptureField']:
            return XiqPacketCaptureField

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['XiqPacketCaptureField'], typing.List['XiqPacketCaptureField']],
    ...
    def __getitem__(self, i: int) -> 'XiqPacketCaptureField':
...
SchemaFor200ResponseBodyApplicationJson = PagedXiqPacketCapture
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_packet_captures_oapg(
        self,
...
class ListPacketCaptures(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_packet_captures(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def list_packet_captures(
        ...
        return self._list_packet_captures_oapg(

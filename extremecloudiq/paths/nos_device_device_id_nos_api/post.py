...
# body param
SchemaForRequestBodyApplicationJson = XiqGetDeviceInfobyNosRequest


request_body_xiq_get_device_infoby_nos_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = XiqGetDeviceInfoByNos
...
class BaseApi(api_client.Api):
    ...
    def _get_device_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_get_device_infoby_nos_request.serialize(body, content_type)

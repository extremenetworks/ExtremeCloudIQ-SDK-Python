...
# Query params
ViewTypeSchema = XiqWirelessViewsListType
...
SchemaFor200ResponseBodyApplicationJson = XiqWirelessViewsTypeResponse
...
class GetWirelessViews(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_wireless_views(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_wireless_views(
        ...
        return self._get_wireless_views_oapg(

...
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        ...
        'vlanIds': typing.Union[VlanIdsSchema, list, tuple, ],
        'siteIds': typing.Union[SiteIdsSchema, list, tuple, ],
    }
)
...
request_query_vlan_ids = api_client.QueryParameter(
    name="vlanIds",
    style=api_client.ParameterStyle.FORM,
    schema=VlanIdsSchema,
    required=True,
    explode=True,
)
request_query_site_ids = api_client.QueryParameter(
    name="siteIds",
    style=api_client.ParameterStyle.FORM,
    schema=SiteIdsSchema,
    required=True,
    explode=True,
)
_auth = [
...
SchemaFor200ResponseBodyApplicationJson = XiqMissingVlanAnomaliesCountResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_missing_vlan_anomalies_count_oapg(
        self,
    ...
    def _get_missing_vlan_anomalies_count_oapg(
        ...
        for parameter in (
            ...
            request_query_vlan_ids,
            request_query_site_ids,
        ):
...
class GetMissingVlanAnomaliesCount(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_missing_vlan_anomalies_count(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_missing_vlan_anomalies_count(
        ...
        return self._get_missing_vlan_anomalies_count_oapg(

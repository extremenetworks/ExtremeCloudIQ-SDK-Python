...
RequestRequiredQueryParams = typing_extensions.TypedDict(
    ...
    {
        'hostname': typing.Union[HostnameSchema, str, ],
    }
)
...
request_query_hostname = api_client.QueryParameter(
    name="hostname",
...
class ChangeHostname(BaseApi):
    ...
    def change_hostname(
        ...
        return self._change_hostname_oapg(

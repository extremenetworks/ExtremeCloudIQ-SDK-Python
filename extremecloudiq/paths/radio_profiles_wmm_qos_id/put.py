...
# body param
SchemaForRequestBodyApplicationJson = XiqUpdateRpWmmQosSettingsRequest


request_body_xiq_update_rp_wmm_qos_settings_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = XiqRpWmmQosSettings
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_rp_wmm_qos_settings_oapg(
        self,
    ...
    def _update_rp_wmm_qos_settings_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_update_rp_wmm_qos_settings_request.serialize(body, content_type)
...
class UpdateRpWmmQosSettings(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_rp_wmm_qos_settings(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def update_rp_wmm_qos_settings(
        ...
        return self._update_rp_wmm_qos_settings_oapg(
            body=body,

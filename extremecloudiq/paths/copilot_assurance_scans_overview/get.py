...
SchemaFor200ResponseBodyApplicationJson = XiqAssuranceScansOverviewResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_assurance_scans_overview_data_oapg(
        self,
...
class GetAssuranceScansOverviewData(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_assurance_scans_overview_data(
        self,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
    ...
    def get_assurance_scans_overview_data(
        ...
        return self._get_assurance_scans_overview_data_oapg(

...
# Path params
SnSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'sn': typing.Union[SnSchema, str, ],
    }
)
...
request_path_sn = api_client.PathParameter(
    name="sn",
...
SchemaFor200ResponseBodyApplicationJson = XiqAfcApDetail
...
class GetApsAfcInfo(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_aps_afc_info(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_aps_afc_info(
        ...
        return self._get_aps_afc_info_oapg(

...
class MessageMetadataIdsSchema(
    schemas.ListSchema
):
    ...
    def __getitem__(self, i: int) -> MetaOapg.items:
        return super().__getitem__(i)
AcknowledgedSchema = schemas.BoolSchema
SiteIdSchema = schemas.Int64Schema
FloorIdSchema = schemas.Int64Schema
BuildingIdSchema = schemas.Int64Schema
KeywordSchema = schemas.StrSchema
SortFieldSchema = XiqAlertSortField
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'severityIds': typing.Union[SeverityIdsSchema, list, tuple, ],
        'categoryIds': typing.Union[CategoryIdsSchema, list, tuple, ],
        'messageMetadataIds': typing.Union[MessageMetadataIdsSchema, list, tuple, ],
        'acknowledged': typing.Union[AcknowledgedSchema, bool, ],
        'siteId': typing.Union[SiteIdSchema, decimal.Decimal, int, ],
        'floorId': typing.Union[FloorIdSchema, decimal.Decimal, int, ],
        'buildingId': typing.Union[BuildingIdSchema, decimal.Decimal, int, ],
...
request_query_severity_ids = api_client.QueryParameter(
    name="severityIds",
    style=api_client.ParameterStyle.FORM,
    schema=SeverityIdsSchema,
    explode=True,
)
request_query_category_ids = api_client.QueryParameter(
    name="categoryIds",
    style=api_client.ParameterStyle.FORM,
    schema=CategoryIdsSchema,
    explode=True,
)
request_query_message_metadata_ids = api_client.QueryParameter(
    name="messageMetadataIds",
    style=api_client.ParameterStyle.FORM,
    schema=MessageMetadataIdsSchema,
    explode=True,
)
request_query_acknowledged = api_client.QueryParameter(
    name="acknowledged",
    style=api_client.ParameterStyle.FORM,
...
request_query_floor_id = api_client.QueryParameter(
    name="floorId",
    style=api_client.ParameterStyle.FORM,
    schema=FloorIdSchema,
    explode=True,
)
request_query_building_id = api_client.QueryParameter(
    name="buildingId",
    style=api_client.ParameterStyle.FORM,
...
SchemaFor200ResponseBodyApplicationJson = PagedXiqAlert
...
class BaseApi(api_client.Api):
    ...
    def _list_alerts_oapg(
        ...
        for parameter in (
            ...
            request_query_severity_ids,
            request_query_category_ids,
            request_query_message_metadata_ids,
            request_query_acknowledged,
            request_query_site_id,
            request_query_floor_id,
            request_query_building_id,

...
IncludeDisabledRadioSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'includeDisabledRadio': typing.Union[IncludeDisabledRadioSchema, bool, ],
    },
    total=False
)
...
request_query_include_disabled_radio = api_client.QueryParameter(
    name="includeDisabledRadio",
    style=api_client.ParameterStyle.FORM,
    schema=IncludeDisabledRadioSchema,
    explode=True,
)
_auth = [
    'Bearer',
...
SchemaFor200ResponseBodyApplicationJson = PagedXiqRadioEntity
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_devices_radio_information_oapg(
        self,
    ...
    def _list_devices_radio_information_oapg(
        ...
        for parameter in (
            ...
            request_query_include_disabled_radio,
        ):
...
class ListDevicesRadioInformation(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_devices_radio_information(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def list_devices_radio_information(
        ...
        return self._list_devices_radio_information_oapg(

...
SchemaFor200ResponseBodyApplicationJson = XiqWiredDeviceHealthTemperatureStatusResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_wired_device_health_temp_status_oapg(
        self,
...
class GetWiredDeviceHealthTempStatus(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_wired_device_health_temp_status(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_wired_device_health_temp_status(
        ...
        return self._get_wired_device_health_temp_status_oapg(

...
# body param
SchemaForRequestBodyApplicationJson = XiqCreateNetworkPolicyRequest


request_body_xiq_create_network_policy_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = XiqNetworkPolicy
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_network_policy_oapg(
        self,
    ...
    def _create_network_policy_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_create_network_policy_request.serialize(body, content_type)
...
class CreateNetworkPolicy(BaseApi):
    ...
    def create_network_policy(
        ...
        return self._create_network_policy_oapg(
            body=body,

...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def additional_properties() -> typing.Type['XiqDeviceLevelSsidStatus']:
            return XiqDeviceLevelSsidStatus
    
    def __getitem__(self, name: typing.Union[str, ]) -> 'XiqDeviceLevelSsidStatus':
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    def get_item_oapg(self, name: typing.Union[str, ]) -> 'XiqDeviceLevelSsidStatus':
    ...
    def __new__(
        ...
        **kwargs: 'XiqDeviceLevelSsidStatus',
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_device_level_ssid_status_oapg(
        self,
...
class GetDeviceLevelSsidStatus(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_device_level_ssid_status(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_device_level_ssid_status(
        ...
        return self._get_device_level_ssid_status_oapg(

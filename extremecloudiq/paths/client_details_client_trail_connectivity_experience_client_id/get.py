...
IncludeWiredSchema = schemas.BoolSchema
OnlyWiredSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'includeWired': typing.Union[IncludeWiredSchema, bool, ],
        'onlyWired': typing.Union[OnlyWiredSchema, bool, ],
    },
    total=False
)
...
request_query_precision = api_client.QueryParameter(
    name="precision",
    style=api_client.ParameterStyle.FORM,
...
request_query_include_wired = api_client.QueryParameter(
    name="includeWired",
    style=api_client.ParameterStyle.FORM,
    schema=IncludeWiredSchema,
    explode=True,
)
request_query_only_wired = api_client.QueryParameter(
    name="onlyWired",
    style=api_client.ParameterStyle.FORM,
    schema=OnlyWiredSchema,
    explode=True,
)
# Path params
...
SchemaFor200ResponseBodyApplicationJson = XiqConnectivityExperienceList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_connectivity_experience_grid_oapg(
        self,
    ...
    def _get_connectivity_experience_grid_oapg(
        ...
        for parameter in (
            ...
            request_query_include_wired,
            request_query_only_wired,
        ):
...
class GetConnectivityExperienceGrid(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_connectivity_experience_grid(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_connectivity_experience_grid(
        ...
        return self._get_connectivity_experience_grid_oapg(

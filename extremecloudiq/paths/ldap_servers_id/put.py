...
# body param
SchemaForRequestBodyApplicationJson = XiqUpdateLdapServerRequest


request_body_xiq_update_ldap_server_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = XiqLdapServer
...
class BaseApi(api_client.Api):
    ...
    def _update_ldap_server_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_update_ldap_server_request.serialize(body, content_type)
...
class UpdateLdapServer(BaseApi):
    ...
    def update_ldap_server(
        ...
        return self._update_ldap_server_oapg(
            body=body,

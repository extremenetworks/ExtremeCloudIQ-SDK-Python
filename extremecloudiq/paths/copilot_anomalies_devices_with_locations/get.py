...
SchemaFor200ResponseBodyApplicationJson = XiqCopilotPagedXiqAnomalyDeviceWithLocation
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_copilot_devices_with_locations_oapg(
        self,
...
class GetCopilotDevicesWithLocations(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_copilot_devices_with_locations(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_copilot_devices_with_locations(
        ...
        return self._get_copilot_devices_with_locations_oapg(

...
# body param
SchemaForRequestBodyApplicationJson = XiqUpdateVhmSettingRequest


request_body_xiq_update_vhm_setting_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = XiqVhmSetting
...
class BaseApi(api_client.Api):
    ...
    def _update_vhm_setting_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_update_vhm_setting_request.serialize(body, content_type)
...
class UpdateVhmSetting(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_vhm_setting(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def update_vhm_setting(
        ...
        return self._update_vhm_setting_oapg(
            body=body,

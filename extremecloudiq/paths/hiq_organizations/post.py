...
# body param
SchemaForRequestBodyApplicationJson = XiqCreateOrganizationRequest


request_body_xiq_create_organization_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = XiqOrganization
...
class BaseApi(api_client.Api):
    ...
    def _create_organization_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_create_organization_request.serialize(body, content_type)

...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['XiqOrganization']:
            return XiqOrganization

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['XiqOrganization'], typing.List['XiqOrganization']],
    ...
    def __getitem__(self, i: int) -> 'XiqOrganization':
...
class ListOrganizations(BaseApi):
    ...
    def list_organizations(
        ...
        return self._list_organizations_oapg(

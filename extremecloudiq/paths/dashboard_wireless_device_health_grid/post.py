...
SortFieldSchema = XiqWirelessDeviceHealthSortField
...
# body param
SchemaForRequestBodyApplicationJson = XiqWirelessDeviceHealthGridFilter


request_body_xiq_wireless_device_health_grid_filter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = PagedXiqDeviceHealthGridResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_device_health_grid_oapg(
        self,
    ...
    def _get_device_health_grid_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_wireless_device_health_grid_filter.serialize(body, content_type)
...
class GetDeviceHealthGrid(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_device_health_grid(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def get_device_health_grid(
        ...
        return self._get_device_health_grid_oapg(
            body=body,

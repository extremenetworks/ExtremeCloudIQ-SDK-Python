...
# body param
SchemaForRequestBodyApplicationJson = XiqGenerateApiTokenRequest


request_body_xiq_generate_api_token_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = XiqGenerateApiTokenResponse
...
class BaseApi(api_client.Api):
    ...
    def _generate_api_token_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_generate_api_token_request.serialize(body, content_type)
...
class GenerateApiToken(BaseApi):
    ...
    def generate_api_token(
        ...
        return self._generate_api_token_oapg(
            body=body,

...
class MakesSchema(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['XiqDigitalTwinMake']:
            return XiqDigitalTwinMake

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['XiqDigitalTwinMake'], typing.List['XiqDigitalTwinMake']],
    ...
    def __getitem__(self, i: int) -> 'XiqDigitalTwinMake':
...
class ModelsSchema(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['XiqDigitalTwinModel']:
            return XiqDigitalTwinModel

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['XiqDigitalTwinModel'], typing.List['XiqDigitalTwinModel']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'ModelsSchema':
        return super().__new__(
            cls,
    ...
    def __getitem__(self, i: int) -> 'XiqDigitalTwinModel':
        return super().__getitem__(i)
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'makes': typing.Union[MakesSchema, list, tuple, ],
        'models': typing.Union[ModelsSchema, list, tuple, ],
    },
    total=False
)
...
request_query_makes = api_client.QueryParameter(
    name="makes",
    style=api_client.ParameterStyle.FORM,
    schema=MakesSchema,
    explode=True,
)
request_query_models = api_client.QueryParameter(
    name="models",
    style=api_client.ParameterStyle.FORM,
    schema=ModelsSchema,
    explode=True,
...
SchemaFor200ResponseBodyApplicationJson = PagedXiqDigitalTwinProducts
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_digital_twin_products_oapg(
        self,
...
class ListDigitalTwinProducts(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_digital_twin_products(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def list_digital_twin_products(
        ...
        return self._list_digital_twin_products_oapg(

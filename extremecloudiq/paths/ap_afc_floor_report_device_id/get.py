...
SchemaFor200ResponseBodyApplicationJson = XiqGetAfcGeolocationFloorReportResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_afc_geolocaiton_floor_report_oapg(
        self,
...
class GetAfcGeolocaitonFloorReport(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_afc_geolocaiton_floor_report(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_afc_geolocaiton_floor_report(
        ...
        return self._get_afc_geolocaiton_floor_report_oapg(

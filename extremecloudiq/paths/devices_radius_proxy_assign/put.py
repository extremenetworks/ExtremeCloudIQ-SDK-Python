...
RadiusProxyIdSchema = schemas.Int64Schema
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        'ids': typing.Union[IdsSchema, list, tuple, ],
        'radiusProxyId': typing.Union[RadiusProxyIdSchema, decimal.Decimal, int, ],
    }
)
...
request_query_radius_proxy_id = api_client.QueryParameter(
    name="radiusProxyId",
    style=api_client.ParameterStyle.FORM,
    schema=RadiusProxyIdSchema,
    required=True,
    explode=True,
)
_auth = [
...
class BaseApi(api_client.Api):
    @typing.overload
    def _assign_devices_radius_proxy_oapg(
        self,
...
class AssignDevicesRadiusProxy(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def assign_devices_radius_proxy(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def assign_devices_radius_proxy(
        ...
        return self._assign_devices_radius_proxy_oapg(

...
SchemaFor200ResponseBodyApplicationJson = XiqDeleteBulkAlertSubscriptionEmailResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_bulk_alert_subscription_email_oapg(
        self,
...
class DeleteBulkAlertSubscriptionEmail(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def delete_bulk_alert_subscription_email(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def delete_bulk_alert_subscription_email(
        ...
        return self._delete_bulk_alert_subscription_email_oapg(
            body=body,

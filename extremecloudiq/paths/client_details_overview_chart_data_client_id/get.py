...
SchemaFor200ResponseBodyApplicationJson = XiqClientChartDataList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_client_chart_data_oapg(
        self,
...
class GetClientChartData(BaseApi):
    ...
    def get_client_chart_data(
        ...
        return self._get_client_chart_data_oapg(

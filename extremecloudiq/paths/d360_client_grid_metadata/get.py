...
SchemaFor200ResponseBodyApplicationJson = XiqD360ClientGridMetadata
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_client_grid_metadata_oapg(
        self,
...
class GetClientGridMetadata(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_client_grid_metadata(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_client_grid_metadata(
        ...
        return self._get_client_grid_metadata_oapg(

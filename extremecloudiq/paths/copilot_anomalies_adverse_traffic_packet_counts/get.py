...
SchemaFor200ResponseBodyApplicationJson = XiqAtpPacketCountsResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_atp_packet_counts_oapg(
        self,
...
class GetAtpPacketCounts(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_atp_packet_counts(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_atp_packet_counts(
        ...
        return self._get_atp_packet_counts_oapg(

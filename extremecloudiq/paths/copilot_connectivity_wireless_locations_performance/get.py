...
SchemaFor200ResponseBodyApplicationJson = XiqWirelessConnectivityPerformanceResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_wireless_performance_by_location_oapg(
        self,
...
class GetWirelessPerformanceByLocation(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_wireless_performance_by_location(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_wireless_performance_by_location(
        ...
        return self._get_wireless_performance_by_location_oapg(

...
# body param
SchemaForRequestBodyApplicationJson = XiqDevicesResetToDefaultRequest


request_body_xiq_devices_reset_to_default_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _reset_devices_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_devices_reset_to_default_request.serialize(body, content_type)
...
class ResetDevices(BaseApi):
    ...
    def reset_devices(
        ...
        return self._reset_devices_oapg(
            body=body,

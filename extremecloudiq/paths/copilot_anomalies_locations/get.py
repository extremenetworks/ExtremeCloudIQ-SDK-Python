...
SchemaFor200ResponseBodyApplicationJson = XiqCopilotPagedXiqAnomalyLocationEntity
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_anomaly_locations_oapg(
        self,
...
class ListAnomalyLocations(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_anomaly_locations(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def list_anomaly_locations(
        ...
        return self._list_anomaly_locations_oapg(

...
# body param
SchemaForRequestBodyApplicationJson = XiqCreateRadiusProxyRequest


request_body_xiq_create_radius_proxy_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = XiqRadiusProxy
...
class BaseApi(api_client.Api):
    ...
    def _create_radius_proxy_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_create_radius_proxy_request.serialize(body, content_type)
...
class CreateRadiusProxy(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def create_radius_proxy(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def create_radius_proxy(
        ...
        return self._create_radius_proxy_oapg(
            body=body,

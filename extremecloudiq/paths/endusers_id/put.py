...
# body param
SchemaForRequestBodyApplicationJson = XiqUpdateEndUserRequest


request_body_xiq_update_end_user_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_end_user_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_update_end_user_request.serialize(body, content_type)
...
class UpdateEndUser(BaseApi):
    ...
    def update_end_user(
        ...
        return self._update_end_user_oapg(
            body=body,

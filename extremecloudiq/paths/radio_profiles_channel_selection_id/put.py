...
# body param
SchemaForRequestBodyApplicationJson = XiqUpdateRpChannelSelectionRequest


request_body_xiq_update_rp_channel_selection_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = XiqRpChannelSelection
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_rp_channel_selection_oapg(
        self,
    ...
    def _update_rp_channel_selection_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_update_rp_channel_selection_request.serialize(body, content_type)
...
class UpdateRpChannelSelection(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_rp_channel_selection(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def update_rp_channel_selection(
        ...
        return self._update_rp_channel_selection_oapg(
            body=body,

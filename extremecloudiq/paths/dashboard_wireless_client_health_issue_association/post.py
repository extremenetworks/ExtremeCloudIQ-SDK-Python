...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['XiqIssueClientAssociation']:
            return XiqIssueClientAssociation

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['XiqIssueClientAssociation'], typing.List['XiqIssueClientAssociation']],
    ...
    def __getitem__(self, i: int) -> 'XiqIssueClientAssociation':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_client_association_issues_oapg(
        self,
...
class GetClientAssociationIssues(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_client_association_issues(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def get_client_association_issues(
        ...
        return self._get_client_association_issues_oapg(
            body=body,

...
request_path_product_type = api_client.PathParameter(
    name="productType",
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['XiqRadioOperatingModes']:
            return XiqRadioOperatingModes

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['XiqRadioOperatingModes'], typing.List['XiqRadioOperatingModes']],
    ...
    def __getitem__(self, i: int) -> 'XiqRadioOperatingModes':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_radio_operating_modes_oapg(
        self,
...
class GetRadioOperatingModes(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_radio_operating_modes(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_radio_operating_modes(
        ...
        return self._get_radio_operating_modes_oapg(

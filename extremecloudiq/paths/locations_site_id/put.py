...
# body param
SchemaForRequestBodyApplicationJson = XiqUpdateSiteRequest


request_body_xiq_update_site_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_site_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_update_site_request.serialize(body, content_type)

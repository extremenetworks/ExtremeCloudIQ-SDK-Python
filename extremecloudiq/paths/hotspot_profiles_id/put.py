...
SchemaFor200ResponseBodyApplicationJson = XiqHotspotProfile
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_hotspot_profile_oapg(
        self,
...
class UpdateHotspotProfile(BaseApi):
    ...
    def update_hotspot_profile(
        ...
        return self._update_hotspot_profile_oapg(
            body=body,

...
SelectedTimeSchema = schemas.Int64Schema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'selectedTime': typing.Union[SelectedTimeSchema, decimal.Decimal, int, ],
    },
    total=False
)
...
request_query_selected_time = api_client.QueryParameter(
    name="selectedTime",
    style=api_client.ParameterStyle.FORM,
    schema=SelectedTimeSchema,
    explode=True,
)
# body param
SchemaForRequestBodyApplicationJson = XiqD360Filter


request_body_xiq_d360_filter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = PagedXiqSurroundingAps
...
class BaseApi(api_client.Api):
    ...
    def _get_surrounding_aps_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_d360_filter.serialize(body, content_type)
...
class GetSurroundingAps(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_surrounding_aps(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def get_surrounding_aps(
        ...
        return self._get_surrounding_aps_oapg(
            body=body,

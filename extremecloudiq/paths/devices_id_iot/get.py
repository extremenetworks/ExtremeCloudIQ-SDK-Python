...
SchemaFor200ResponseBodyApplicationJson = XiqDeviceIotInterfaceSettingsEntry
...
class GetDeviceIot(BaseApi):
    ...
    def get_device_iot(
        ...
        return self._get_device_iot_oapg(

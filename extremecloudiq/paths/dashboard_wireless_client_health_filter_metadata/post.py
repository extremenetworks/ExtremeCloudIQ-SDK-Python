...
SchemaFor200ResponseBodyApplicationJson = XiqWirelessClientHealthGridFilterMetadata
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_client_health_grid_filter_metadata_oapg(
        self,
...
class GetClientHealthGridFilterMetadata(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_client_health_grid_filter_metadata(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_client_health_grid_filter_metadata(
        ...
        return self._get_client_health_grid_filter_metadata_oapg(
            body=body,

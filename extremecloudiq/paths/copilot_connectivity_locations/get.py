...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'clientType': typing.Union[ClientTypeSchema, ],
        'forensicBucket': typing.Union[ForensicBucketSchema, ],
        'qualityIndex': typing.Union[QualityIndexSchema, ],
    },
    total=False
)
...
request_query_client_type = api_client.QueryParameter(
    name="clientType",
    style=api_client.ParameterStyle.FORM,
...
request_query_quality_index = api_client.QueryParameter(
    name="qualityIndex",
    style=api_client.ParameterStyle.FORM,
    schema=QualityIndexSchema,
    explode=True,
)
_auth = [
    'Bearer',
...
SchemaFor200ResponseBodyApplicationJson = PagedXiqConnectivityExperienceData
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_connectivity_details_by_locations_oapg(
        self,
    ...
    def _get_connectivity_details_by_locations_oapg(
        ...
        for parameter in (
            ...
            request_query_client_type,
            request_query_forensic_bucket,
            request_query_quality_index,
        ):
...
class GetConnectivityDetailsByLocations(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_connectivity_details_by_locations(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_connectivity_details_by_locations(
        ...
        return self._get_connectivity_details_by_locations_oapg(

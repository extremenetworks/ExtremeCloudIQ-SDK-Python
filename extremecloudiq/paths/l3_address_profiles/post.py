...
# body param
SchemaForRequestBodyApplicationJson = XiqCreateL3AddressProfileRequest


request_body_xiq_create_l3_address_profile_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = XiqL3AddressProfileResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_l3_address_profile_oapg(
        self,
    ...
    def _create_l3_address_profile_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_create_l3_address_profile_request.serialize(body, content_type)
...
class CreateL3AddressProfile(BaseApi):
    ...
    def create_l3_address_profile(
        ...
        return self._create_l3_address_profile_oapg(
            body=body,

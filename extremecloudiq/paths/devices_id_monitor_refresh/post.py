...
request_query_function = api_client.QueryParameter(
    name="function",
...
SchemaFor200ResponseBodyApplicationJson = XiqDeviceMonitorRefreshResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _monitor_refresh_device_oapg(
        self,
...
class MonitorRefreshDevice(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def monitor_refresh_device(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def monitor_refresh_device(
        ...
        return self._monitor_refresh_device_oapg(

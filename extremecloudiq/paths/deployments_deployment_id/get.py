...
SchemaFor200ResponseBodyApplicationJson = XiqDeploymentDetailsResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_deployment_details_by_id_oapg(
        self,
...
class GetDeploymentDetailsById(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_deployment_details_by_id(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_deployment_details_by_id(
        ...
        return self._get_deployment_details_by_id_oapg(

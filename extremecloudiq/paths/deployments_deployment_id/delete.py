...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_firmware_upgrade_schedule_oapg(
        self,
...
class DeleteFirmwareUpgradeSchedule(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def delete_firmware_upgrade_schedule(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def delete_firmware_upgrade_schedule(
        ...
        return self._delete_firmware_upgrade_schedule_oapg(

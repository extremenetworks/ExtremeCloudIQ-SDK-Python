...
class LimitSchema(
    ...
    class MetaOapg:
        ...
        inclusive_minimum = 1
SortFieldSchema = XiqLockedClientSortField
...
SchemaFor200ResponseBodyApplicationJson = PagedXiqLockedClient
...
class LockedClients(BaseApi):
    ...
    def locked_clients(
        ...
        return self._locked_clients_oapg(

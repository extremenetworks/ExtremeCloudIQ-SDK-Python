...
# Query params
BackupFileSchema = schemas.StrSchema
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        'backupFile': typing.Union[BackupFileSchema, str, ],
    }
)
...
request_query_backup_file = api_client.QueryParameter(
    name="backupFile",
...
class RestoreBackup(BaseApi):
    ...
    def restore_backup(
        ...
        return self._restore_backup_oapg(

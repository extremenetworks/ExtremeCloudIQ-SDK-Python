...
# body param
SchemaForRequestBodyApplicationJson = XiqCreateLocationRequest


request_body_xiq_create_location_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_location_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_create_location_request.serialize(body, content_type)
...
class CreateLocation(BaseApi):
    ...
    def create_location(
        ...
        return self._create_location_oapg(
            body=body,

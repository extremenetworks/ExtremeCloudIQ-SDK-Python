...
# body param
SchemaForRequestBodyApplicationJson = XiqUpdateRpMacOuiProfileRequest


request_body_xiq_update_rp_mac_oui_profile_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = XiqRpMacOuiProfile
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_rp_mac_oui_profile_oapg(
        self,
    ...
    def _update_rp_mac_oui_profile_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_update_rp_mac_oui_profile_request.serialize(body, content_type)
...
class UpdateRpMacOuiProfile(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_rp_mac_oui_profile(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def update_rp_mac_oui_profile(
        ...
        return self._update_rp_mac_oui_profile_oapg(
            body=body,

...
# body param
SchemaForRequestBodyApplicationJson = XiqCreateFloorRequest


request_body_xiq_create_floor_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_floor_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_create_floor_request.serialize(body, content_type)
...
class CreateFloor(BaseApi):
    ...
    def create_floor(
        ...
        return self._create_floor_oapg(
            body=body,

...
# Path params
StackIdSchema = schemas.Int64Schema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'stackId': typing.Union[StackIdSchema, decimal.Decimal, int, ],
    }
)
...
request_path_stack_id = api_client.PathParameter(
    name="stackId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=StackIdSchema,
    required=True,
)
_auth = [
    'Bearer',
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['XiqRmStackMemberInfo']:
            return XiqRmStackMemberInfo

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['XiqRmStackMemberInfo'], typing.List['XiqRmStackMemberInfo']],
    ...
    def __getitem__(self, i: int) -> 'XiqRmStackMemberInfo':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_stack_member_info_oapg(
        self,
...
class GetStackMemberInfo(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_stack_member_info(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_stack_member_info(
        ...
        return self._get_stack_member_info_oapg(

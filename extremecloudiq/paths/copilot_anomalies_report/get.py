...
AnomalyTypeSchema = XiqAnomalyType
BuildingIdSchema = schemas.Int64Schema
SeveritySchema = XiqAnomalySeverity
ExcludeMutedSchema = schemas.BoolSchema
SortFieldSchema = XiqAnomalySortField
SortOrderSchema = XiqSortOrder
SearchKeySchema = schemas.StrSchema
FileTypeSchema = schemas.StrSchema
OffsetTimeSchema = schemas.Int32Schema
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        ...
        'offsetTime': typing.Union[OffsetTimeSchema, decimal.Decimal, int, ],
    }
)
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        'anomalyType': typing.Union[AnomalyTypeSchema, ],
        'buildingId': typing.Union[BuildingIdSchema, decimal.Decimal, int, ],
        'severity': typing.Union[SeveritySchema, ],
        'excludeMuted': typing.Union[ExcludeMutedSchema, bool, ],
...
request_query_anomaly_type = api_client.QueryParameter(
    name="anomalyType",
    style=api_client.ParameterStyle.FORM,
    schema=AnomalyTypeSchema,
    explode=True,
)
...
request_query_exclude_muted = api_client.QueryParameter(
    name="excludeMuted",
    style=api_client.ParameterStyle.FORM,
    schema=ExcludeMutedSchema,
    explode=True,
)
...
request_query_offset_time = api_client.QueryParameter(
    name="offsetTime",
    style=api_client.ParameterStyle.FORM,
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_anomalies_report_oapg(
        self,
...
class GetAnomaliesReport(BaseApi):
    ...
    def get_anomalies_report(
        ...
        return self._get_anomalies_report_oapg(

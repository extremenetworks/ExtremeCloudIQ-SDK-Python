...
SortFieldSchema = XiqWiredUsageAndCapacitySortField
...
# body param
SchemaForRequestBodyApplicationJson = XiqWiredUsageCapacityGridRequest


request_body_xiq_wired_usage_capacity_grid_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = PagedXiqWiredUsageCapacityGridResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_wired_usage_capacity_grid_oapg(
        self,
    ...
    def _get_wired_usage_capacity_grid_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_wired_usage_capacity_grid_request.serialize(body, content_type)
...
class GetWiredUsageCapacityGrid(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_wired_usage_capacity_grid(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def get_wired_usage_capacity_grid(
        ...
        return self._get_wired_usage_capacity_grid_oapg(
            body=body,

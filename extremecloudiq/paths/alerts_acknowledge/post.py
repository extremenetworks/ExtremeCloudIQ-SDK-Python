...
# body param
SchemaForRequestBodyApplicationJson = XiqAcknowledgeAlertsRequest


request_body_xiq_acknowledge_alerts_request = api_client.RequestBody(
    content={
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['XiqAlert']:
            return XiqAlert

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['XiqAlert'], typing.List['XiqAlert']],
    ...
    def __getitem__(self, i: int) -> 'XiqAlert':
...
class BaseApi(api_client.Api):
    ...
    def _acknowledge_alerts_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_acknowledge_alerts_request.serialize(body, content_type)
...
class AcknowledgeAlerts(BaseApi):
    ...
    def acknowledge_alerts(
        ...
        return self._acknowledge_alerts_oapg(
            body=body,

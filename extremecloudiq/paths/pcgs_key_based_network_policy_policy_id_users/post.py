...
# body param
SchemaForRequestBodyApplicationJson = XiqCreateKeyBasedPcgUsersRequest


request_body_xiq_create_key_based_pcg_users_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = XiqCreateKeyBasedPcgUsersResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _add_key_based_pcg_users_oapg(
        self,
    ...
    def _add_key_based_pcg_users_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_create_key_based_pcg_users_request.serialize(body, content_type)
...
class AddKeyBasedPcgUsers(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def add_key_based_pcg_users(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def add_key_based_pcg_users(
        ...
        return self._add_key_based_pcg_users_oapg(
            body=body,

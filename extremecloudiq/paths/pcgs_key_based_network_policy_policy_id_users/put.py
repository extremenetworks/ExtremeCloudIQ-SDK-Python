...
# body param
SchemaForRequestBodyApplicationJson = XiqUpdateKeyBasedPcgUsersRequest


request_body_xiq_update_key_based_pcg_users_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_key_based_pcg_users_oapg(
        self,
    ...
    def _update_key_based_pcg_users_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_update_key_based_pcg_users_request.serialize(body, content_type)
...
class UpdateKeyBasedPcgUsers(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_key_based_pcg_users(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def update_key_based_pcg_users(
        ...
        return self._update_key_based_pcg_users_oapg(
            body=body,

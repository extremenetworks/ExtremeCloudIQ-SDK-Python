...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_ssids_from_network_policy_oapg(
        self,
...
class DeleteSsidsFromNetworkPolicy(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def delete_ssids_from_network_policy(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,list, tuple, ],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def delete_ssids_from_network_policy(
        ...
        return self._delete_ssids_from_network_policy_oapg(
            body=body,

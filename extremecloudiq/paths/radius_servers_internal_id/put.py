...
# body param
SchemaForRequestBodyApplicationJson = XiqUpdateInternalRadiusServerRequest


request_body_xiq_update_internal_radius_server_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = XiqInternalRadiusServer
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_internal_radius_server_oapg(
        self,
    ...
    def _update_internal_radius_server_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_update_internal_radius_server_request.serialize(body, content_type)
...
class UpdateInternalRadiusServer(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_internal_radius_server(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def update_internal_radius_server(
        ...
        return self._update_internal_radius_server_oapg(
            body=body,

...
SchemaFor200ResponseBodyApplicationJson = XiqRmAfcGridFilterMetadata
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_afc_grid_filter_metadata_oapg(
        self,
...
class GetAfcGridFilterMetadata(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_afc_grid_filter_metadata(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def get_afc_grid_filter_metadata(
        ...
        return self._get_afc_grid_filter_metadata_oapg(
            body=body,

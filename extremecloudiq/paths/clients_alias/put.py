...
class SchemaForRequestBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['XiqClientMacAddressAlias']:
            return XiqClientMacAddressAlias

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['XiqClientMacAddressAlias'], typing.List['XiqClientMacAddressAlias']],
    ...
    def __getitem__(self, i: int) -> 'XiqClientMacAddressAlias':
        return super().__getitem__(i)


request_body_xiq_client_mac_address_alias = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _set_clients_aliases_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_client_mac_address_alias.serialize(body, content_type)
...
class SetClientsAliases(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def set_clients_aliases(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,list, tuple, ],
        content_type: typing_extensions.Literal["application/json"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,

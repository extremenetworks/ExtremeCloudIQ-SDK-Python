...
# body param
SchemaForRequestBodyApplicationJson = RttsSessionDevices


request_body_rtts_session_devices = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = XiqRttsSessionResponse
...
class BaseApi(api_client.Api):
    ...
    def _create_rtts_session_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_rtts_session_devices.serialize(body, content_type)
...
class CreateRttsSession(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def create_rtts_session(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def create_rtts_session(
        ...
        return self._create_rtts_session_oapg(
            body=body,

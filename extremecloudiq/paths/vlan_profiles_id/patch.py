...
# body param
SchemaForRequestBodyApplicationJson = XiqUpdateVlanProfileRequest


request_body_xiq_update_vlan_profile_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = XiqVlanProfile
...
class BaseApi(api_client.Api):
    ...
    def _update_vlan_profile_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_update_vlan_profile_request.serialize(body, content_type)
...
class UpdateVlanProfile(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_vlan_profile(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def update_vlan_profile(
        ...
        return self._update_vlan_profile_oapg(
            body=body,

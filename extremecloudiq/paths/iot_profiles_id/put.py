...
# body param
SchemaForRequestBodyApplicationJson = XiqIotProfileRequest


request_body_xiq_iot_profile_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = XiqIotProfile
...
class BaseApi(api_client.Api):
    ...
    def _update_iot_profile_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_iot_profile_request.serialize(body, content_type)
...
class UpdateIotProfile(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_iot_profile(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def update_iot_profile(
        ...
        return self._update_iot_profile_oapg(
            body=body,

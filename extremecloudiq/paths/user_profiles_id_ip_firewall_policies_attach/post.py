...
class BaseApi(api_client.Api):
    @typing.overload
    def _attach_ip_firewall_policy_to_user_profile_oapg(
        self,
...
class AttachIpFirewallPolicyToUserProfile(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def attach_ip_firewall_policy_to_user_profile(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def attach_ip_firewall_policy_to_user_profile(
        ...
        return self._attach_ip_firewall_policy_to_user_profile_oapg(
            body=body,

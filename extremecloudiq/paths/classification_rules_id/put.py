...
# body param
SchemaForRequestBodyApplicationJson = XiqUpdateClassificationRuleRequest


request_body_xiq_update_classification_rule_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = XiqClassificationRule
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_classification_rule_oapg(
        self,
    ...
    def _update_classification_rule_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_update_classification_rule_request.serialize(body, content_type)
...
class UpdateClassificationRule(BaseApi):
    ...
    def update_classification_rule(
        ...
        return self._update_classification_rule_oapg(
            body=body,

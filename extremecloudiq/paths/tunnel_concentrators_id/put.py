...
# body param
SchemaForRequestBodyApplicationJson = XiqTunnelConcentratorRequest


request_body_xiq_tunnel_concentrator_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = XiqTunnelConcentrator
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_tunnel_concentrator_oapg(
        self,
    ...
    def _update_tunnel_concentrator_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_tunnel_concentrator_request.serialize(body, content_type)
...
class UpdateTunnelConcentrator(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_tunnel_concentrator(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def update_tunnel_concentrator(
        ...
        return self._update_tunnel_concentrator_oapg(
            body=body,

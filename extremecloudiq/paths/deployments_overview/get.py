...
SchemaFor200ResponseBodyApplicationJson = XiqDeploymentOverview
...
class GetDeployOverview(BaseApi):
    ...
    def get_deploy_overview(
        ...
        return self._get_deploy_overview_oapg(

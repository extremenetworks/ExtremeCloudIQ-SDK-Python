...
# Query params
ViewTypeSchema = XiqConnectivityExperienceViewType
...
SortFieldSchema = XiqCopilotEventsWirelessSortField
SortOrderSchema = XiqSortOrder
ViewIdSchema = schemas.StrSchema
ScoreTypeSchema = XiqCopilotWirelessEventsScoreType
...
SchemaFor200ResponseBodyApplicationJson = PagedXiqCopilotWirelessEvent
...
class GetWirelessEvents(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_wireless_events(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_wireless_events(
        ...
        return self._get_wireless_events_oapg(

...
SchemaFor200ResponseBodyApplicationJson = PagedXiqCustomReportSchedule
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_scheduled_custom_reports_oapg(
        self,
...
class ListScheduledCustomReports(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_scheduled_custom_reports(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def list_scheduled_custom_reports(
        ...
        return self._list_scheduled_custom_reports_oapg(

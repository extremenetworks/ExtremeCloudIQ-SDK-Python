...
ChannelSchema = XiqRmChannelFilterType
...
class SourceSchema(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['XiqRmSourceFilterType']:
            return XiqRmSourceFilterType

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['XiqRmSourceFilterType'], typing.List['XiqRmSourceFilterType']],
    ...
    def __getitem__(self, i: int) -> 'XiqRmSourceFilterType':
...
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        ...
        'channel': typing.Union[ChannelSchema, ],
    }
)
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        'source': typing.Union[SourceSchema, list, tuple, ],
    },
    total=False
)
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['XiqWirelessInterfaceGraph']:
            return XiqWirelessInterfaceGraph

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['XiqWirelessInterfaceGraph'], typing.List['XiqWirelessInterfaceGraph']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ...
    def __getitem__(self, i: int) -> 'XiqWirelessInterfaceGraph':
        return super().__getitem__(i)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_wireless_interface_graph_oapg(
        self,
...
class GetWirelessInterfaceGraph(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_wireless_interface_graph(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_wireless_interface_graph(
        ...
        return self._get_wireless_interface_graph_oapg(

...
# Query params
CloudFileUrlSchema = schemas.StrSchema
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        'cloudFileUrl': typing.Union[CloudFileUrlSchema, str, ],
    }
)
...
request_query_cloud_file_url = api_client.QueryParameter(
    name="cloudFileUrl",
    style=api_client.ParameterStyle.FORM,
    schema=CloudFileUrlSchema,
    required=True,
    explode=True,
)
_auth = [
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_packet_capture_file_oapg(
        self,
...
class GetPacketCaptureFile(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_packet_capture_file(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_packet_capture_file(
        ...
        return self._get_packet_capture_file_oapg(

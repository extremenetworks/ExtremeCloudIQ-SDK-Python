...
SchemaFor200ResponseBodyApplicationJson = PagedXiqAppUsageSummary
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_application_usage_summary_oapg(
        self,
...
class ListApplicationUsageSummary(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_application_usage_summary(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def list_application_usage_summary(
        ...
        return self._list_application_usage_summary_oapg(
            body=body,

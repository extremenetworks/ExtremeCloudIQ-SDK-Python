...
SchemaFor200ResponseBodyApplicationJson = XiqDeviceLocation
...
class GetDeviceLocation(BaseApi):
    ...
    def get_device_location(
        ...
        return self._get_device_location_oapg(

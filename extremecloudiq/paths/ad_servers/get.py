...
SchemaFor200ResponseBodyApplicationJson = PagedXiqActiveDirectoryServer
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_active_directory_servers_oapg(
        self,
...
class ListActiveDirectoryServers(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_active_directory_servers(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def list_active_directory_servers(
        ...
        return self._list_active_directory_servers_oapg(

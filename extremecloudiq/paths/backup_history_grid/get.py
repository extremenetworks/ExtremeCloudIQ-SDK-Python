...
SchemaFor200ResponseBodyApplicationJson = PagedXiqBackupHistory
...
class ListBackupHistory(BaseApi):
    ...
    def list_backup_history(
        ...
        return self._list_backup_history_oapg(

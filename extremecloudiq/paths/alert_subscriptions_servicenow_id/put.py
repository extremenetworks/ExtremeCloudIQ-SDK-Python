...
# body param
SchemaForRequestBodyApplicationJson = XiqUpdateAlertServiceNowSubscriptionRequest


request_body_xiq_update_alert_service_now_subscription_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = XiqAlertServiceNowSubscription
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_service_now_subscription_oapg(
        self,
    ...
    def _update_service_now_subscription_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_xiq_update_alert_service_now_subscription_request.serialize(body, content_type)
...
class UpdateServiceNowSubscription(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_service_now_subscription(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def update_service_now_subscription(
        ...
        return self._update_service_now_subscription_oapg(
            body=body,

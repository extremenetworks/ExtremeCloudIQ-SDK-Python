...
SchemaFor200ResponseBodyApplicationJson = PagedXiqRadiusClientObject
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_radius_client_objects_oapg(
        self,
...
class ListRadiusClientObjects(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_radius_client_objects(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def list_radius_client_objects(
        ...
        return self._list_radius_client_objects_oapg(

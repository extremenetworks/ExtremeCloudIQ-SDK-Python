...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['XiqEmailTemplate']:
            return XiqEmailTemplate

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['XiqEmailTemplate'], typing.List['XiqEmailTemplate']],
    ...
    def __getitem__(self, i: int) -> 'XiqEmailTemplate':

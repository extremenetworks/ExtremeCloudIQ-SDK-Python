...
# body param
SchemaForRequestBodyApplicationJson = XiqCaptureStopRequest


request_body_xiq_capture_stop_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _stop_packet_capture_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_capture_stop_request.serialize(body, content_type)
...
class StopPacketCapture(BaseApi):
    ...
    def stop_packet_capture(
        ...
        return self._stop_packet_capture_oapg(
            body=body,

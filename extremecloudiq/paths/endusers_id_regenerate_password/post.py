...
SchemaFor200ResponseBodyApplicationJson = XiqRegenerateEndUserPasswordResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _regenerate_end_user_password_oapg(
        self,
...
class RegenerateEndUserPassword(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def regenerate_end_user_password(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def regenerate_end_user_password(
        ...
        return self._regenerate_end_user_password_oapg(

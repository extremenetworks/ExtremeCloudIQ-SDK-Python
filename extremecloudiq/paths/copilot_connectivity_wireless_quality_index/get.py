...
SchemaFor200ResponseBodyApplicationJson = XiqWirelessQualityIndexResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_wireless_quality_index_oapg(
        self,
...
class GetWirelessQualityIndex(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_wireless_quality_index(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_wireless_quality_index(
        ...
        return self._get_wireless_quality_index_oapg(

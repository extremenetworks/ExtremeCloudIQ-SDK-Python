...
SchemaFor200ResponseBodyApplicationJson = PagedXiqDeploymentDetailsResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_list_of_deployments_oapg(
        self,
...
class GetListOfDeployments(BaseApi):
    ...
    def get_list_of_deployments(
        ...
        return self._get_list_of_deployments_oapg(

...
# body param
SchemaForRequestBodyApplicationJson = XiqDeploymentRequest


request_body_xiq_deployment_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = XiqDeploymentResponse
...
class BaseApi(api_client.Api):
    ...
    def _deploy_config_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_deployment_request.serialize(body, content_type)

...
# body param
SchemaForRequestBodyApplicationJson = XiqUpdateRadiusProxyRequest


request_body_xiq_update_radius_proxy_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = XiqRadiusProxy
...
class BaseApi(api_client.Api):
    ...
    def _update_radius_proxy_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_update_radius_proxy_request.serialize(body, content_type)
...
class UpdateRadiusProxy(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_radius_proxy(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def update_radius_proxy(
        ...
        return self._update_radius_proxy_oapg(
            body=body,

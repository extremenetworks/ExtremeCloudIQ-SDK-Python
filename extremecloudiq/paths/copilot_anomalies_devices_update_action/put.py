...
# body param
SchemaForRequestBodyApplicationJson = XiqAnomaliesDeviceUpdateActionRequest


request_body_xiq_anomalies_device_update_action_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = XiqCopilotAnomaliesActionResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_anomaly_device_action_oapg(
        self,
    ...
    def _update_anomaly_device_action_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_anomalies_device_update_action_request.serialize(body, content_type)
...
class UpdateAnomalyDeviceAction(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_anomaly_device_action(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def update_anomaly_device_action(
        ...
        return self._update_anomaly_device_action_oapg(
            body=body,

...
SchemaFor200ResponseBodyApplicationJson = PagedXiqUserProfile
...
class ListUserProfiles(BaseApi):
    ...
    def list_user_profiles(
        ...
        return self._list_user_profiles_oapg(

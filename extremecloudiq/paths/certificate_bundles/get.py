...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'certType': typing.Union[CertTypeSchema, str, ],
    },
    total=False
)
...
SchemaFor200ResponseBodyApplicationJson = PagedXiqCertificateBundle
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_certificate_bundles_oapg(
        self,
...
class ListCertificateBundles(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_certificate_bundles(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def list_certificate_bundles(
        ...
        return self._list_certificate_bundles_oapg(

...
SchemaFor200ResponseBodyApplicationJson = XiqConnectivityDetailsByClientTypeResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_connectivity_details_by_client_type_oapg(
        self,
...
class GetConnectivityDetailsByClientType(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_connectivity_details_by_client_type(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_connectivity_details_by_client_type(
        ...
        return self._get_connectivity_details_by_client_type_oapg(

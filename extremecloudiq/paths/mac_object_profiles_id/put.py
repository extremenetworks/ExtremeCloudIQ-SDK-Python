...
# body param
SchemaForRequestBodyApplicationJson = XiqUpdateMacObjectRequest


request_body_xiq_update_mac_object_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = XiqMacObject
...
class BaseApi(api_client.Api):
    ...
    def _update_mac_object_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_update_mac_object_request.serialize(body, content_type)
...
class UpdateMacObject(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_mac_object(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def update_mac_object(
        ...
        return self._update_mac_object_oapg(
            body=body,

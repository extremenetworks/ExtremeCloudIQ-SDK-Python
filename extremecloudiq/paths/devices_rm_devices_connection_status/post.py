...
request_body_xiq_rm_site_ids_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = XiqRmDeviceConnectionStatus
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_device_connection_status_oapg(
        self,
    ...
    def _get_device_connection_status_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_xiq_rm_site_ids_request.serialize(body, content_type)
...
class GetDeviceConnectionStatus(BaseApi):
    ...
    def get_device_connection_status(
        ...
        return self._get_device_connection_status_oapg(
            body=body,

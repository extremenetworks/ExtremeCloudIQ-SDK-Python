...
# body param
SchemaForRequestBodyApplicationJson = XiqHiqContext


request_body_xiq_hiq_context = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _set_hiq_context_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_hiq_context.serialize(body, content_type)
...
class SetHiqContext(BaseApi):
    ...
    def set_hiq_context(
        ...
        return self._set_hiq_context_oapg(
            body=body,

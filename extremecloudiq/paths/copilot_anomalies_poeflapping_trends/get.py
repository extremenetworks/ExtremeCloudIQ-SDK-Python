...
SchemaFor200ResponseBodyApplicationJson = XiqPoeTrendGraphsResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_poe_flapping_trends_oapg(
        self,
...
class GetPoeFlappingTrends(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_poe_flapping_trends(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_poe_flapping_trends(
        ...
        return self._get_poe_flapping_trends_oapg(

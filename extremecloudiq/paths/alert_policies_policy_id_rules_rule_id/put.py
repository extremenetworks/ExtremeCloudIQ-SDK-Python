...
RuleIdSchema = schemas.Int64Schema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'policyId': typing.Union[PolicyIdSchema, decimal.Decimal, int, ],
        'ruleId': typing.Union[RuleIdSchema, decimal.Decimal, int, ],
    }
)
...
# body param
SchemaForRequestBodyApplicationJson = XiqUpdateAlertRuleRequest


request_body_xiq_update_alert_rule_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = XiqAlertRule
...
class BaseApi(api_client.Api):
    ...
    def _update_alert_rule_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_update_alert_rule_request.serialize(body, content_type)
...
class UpdateAlertRule(BaseApi):
    ...
    def update_alert_rule(
        ...
        return self._update_alert_rule_oapg(
            body=body,

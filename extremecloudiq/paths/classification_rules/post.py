...
# body param
SchemaForRequestBodyApplicationJson = XiqCreateClassificationRuleRequest


request_body_xiq_create_classification_rule_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = XiqClassificationRule
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_classification_rule_oapg(
        self,
    ...
    def _create_classification_rule_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_create_classification_rule_request.serialize(body, content_type)
...
class CreateClassificationRule(BaseApi):
    ...
    def create_classification_rule(
        ...
        return self._create_classification_rule_oapg(
            body=body,

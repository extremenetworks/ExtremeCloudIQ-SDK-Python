...
SchemaFor200ResponseBodyApplicationJson = PagedXiqClassificationRule
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_classification_rules_oapg(
        self,
...
class ListClassificationRules(BaseApi):
    ...
    def list_classification_rules(
        ...
        return self._list_classification_rules_oapg(

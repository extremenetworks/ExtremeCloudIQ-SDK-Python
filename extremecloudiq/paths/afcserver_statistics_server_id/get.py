...
SchemaFor200ResponseBodyApplicationJson = XiqAfcServersStatistics
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_afc_server_statistics_oapg(
        self,
...
class GetAfcServerStatistics(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_afc_server_statistics(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_afc_server_statistics(
        ...
        return self._get_afc_server_statistics_oapg(

...
# body param
SchemaForRequestBodyApplicationJson = XiqCreateUserRequest


request_body_xiq_create_user_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = XiqUser
...
class BaseApi(api_client.Api):
    ...
    def _create_user_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_create_user_request.serialize(body, content_type)

...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_hotspot_service_provider_profile_oapg(
        self,
...
class DeleteHotspotServiceProviderProfile(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def delete_hotspot_service_provider_profile(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def delete_hotspot_service_provider_profile(
        ...
        return self._delete_hotspot_service_provider_profile_oapg(

...
SchemaFor200ResponseBodyApplicationJson = XiqHotspotServiceProviderProfile
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_hotspot_service_provider_profile_oapg(
        self,
...
class UpdateHotspotServiceProviderProfile(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_hotspot_service_provider_profile(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def update_hotspot_service_provider_profile(
        ...
        return self._update_hotspot_service_provider_profile_oapg(
            body=body,

...
# body param
SchemaForRequestBodyApplicationJson = XiqIpFirewallPolicyRequest


request_body_xiq_ip_firewall_policy_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = XiqIpFirewall
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_ip_policy_request_oapg(
        self,
    ...
    def _update_ip_policy_request_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_ip_firewall_policy_request.serialize(body, content_type)
...
class UpdateIpPolicyRequest(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_ip_policy_request(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def update_ip_policy_request(
        ...
        return self._update_ip_policy_request_oapg(
            body=body,

...
SchemaFor200ResponseBodyApplicationJson = XiqDfsRecurenceCountStatsResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_dfs_recurrence_count_stats_oapg(
        self,
...
class GetDfsRecurrenceCountStats(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_dfs_recurrence_count_stats(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_dfs_recurrence_count_stats(
        ...
        return self._get_dfs_recurrence_count_stats_oapg(

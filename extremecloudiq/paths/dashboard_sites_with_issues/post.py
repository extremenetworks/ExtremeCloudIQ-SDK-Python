...
class SortFieldSchema(
    ...
    @schemas.classproperty
    def USAGE_CAPACITY(cls):
        return cls("USAGE_CAPACITY")
...
SchemaFor200ResponseBodyApplicationJson = PagedXiqSiteDashboardResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_sites_with_issues_diagnostics_oapg(
        self,
...
class GetSitesWithIssuesDiagnostics(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_sites_with_issues_diagnostics(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def get_sites_with_issues_diagnostics(
        ...
        return self._get_sites_with_issues_diagnostics_oapg(
            body=body,

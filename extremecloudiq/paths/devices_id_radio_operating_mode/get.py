...
SchemaFor200ResponseBodyApplicationJson = XiqDeviceRadioOperatingMode
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_device_radio_operating_mode_oapg(
        self,
...
class GetDeviceRadioOperatingMode(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_device_radio_operating_mode(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_device_radio_operating_mode(
        ...
        return self._get_device_radio_operating_mode_oapg(

...
SchemaFor200ResponseBodyApplicationJson = PagedXiqInternalRadiusServer
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_internal_radius_servers_oapg(
        self,
...
class ListInternalRadiusServers(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_internal_radius_servers(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def list_internal_radius_servers(
        ...
        return self._list_internal_radius_servers_oapg(

...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_bulk_internal_radius_server_oapg(
        self,
...
class DeleteBulkInternalRadiusServer(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def delete_bulk_internal_radius_server(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def delete_bulk_internal_radius_server(
        ...
        return self._delete_bulk_internal_radius_server_oapg(

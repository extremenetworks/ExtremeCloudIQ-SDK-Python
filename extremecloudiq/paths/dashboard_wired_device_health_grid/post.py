...
SortFieldSchema = XiqWiredDeviceHealthSortField
...
# body param
SchemaForRequestBodyApplicationJson = XiqWiredDeviceHealthGridRequest


request_body_xiq_wired_device_health_grid_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = PagedXiqWiredDeviceHealthGridResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_wired_device_health_grid_oapg(
        self,
    ...
    def _get_wired_device_health_grid_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_wired_device_health_grid_request.serialize(body, content_type)
...
class GetWiredDeviceHealthGrid(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_wired_device_health_grid(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def get_wired_device_health_grid(
        ...
        return self._get_wired_device_health_grid_oapg(
            body=body,

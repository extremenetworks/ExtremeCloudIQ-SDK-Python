...
# body param
SchemaForRequestBodyApplicationJson = XiqThreadStopCommissionerRequest


request_body_xiq_thread_stop_commissioner_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _stop_thread_commissioner_oapg(
        self,
    ...
    def _stop_thread_commissioner_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xiq_thread_stop_commissioner_request.serialize(body, content_type)
...
class StopThreadCommissioner(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def stop_thread_commissioner(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def stop_thread_commissioner(
        ...
        return self._stop_thread_commissioner_oapg(
            body=body,

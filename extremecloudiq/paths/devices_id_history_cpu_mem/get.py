...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['XiqDeviceCpuMemoryUsage']:
            return XiqDeviceCpuMemoryUsage

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['XiqDeviceCpuMemoryUsage'], typing.List['XiqDeviceCpuMemoryUsage']],
    ...
    def __getitem__(self, i: int) -> 'XiqDeviceCpuMemoryUsage':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_device_cpu_memory_history_oapg(
        self,
...
class GetDeviceCpuMemoryHistory(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_device_cpu_memory_history(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_device_cpu_memory_history(
        ...
        return self._get_device_cpu_memory_history_oapg(

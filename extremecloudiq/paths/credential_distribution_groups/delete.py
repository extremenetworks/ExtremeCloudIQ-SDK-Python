...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_credential_distribution_group_oapg(
        self,
...
class DeleteCredentialDistributionGroup(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def delete_credential_distribution_group(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def delete_credential_distribution_group(
        ...
        return self._delete_credential_distribution_group_oapg(

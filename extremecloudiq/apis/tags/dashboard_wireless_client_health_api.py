...
from extremecloudiq.paths.dashboard_wireless_client_health_reports_id.get import DownloadClientHealthReport
from extremecloudiq.paths.dashboard_wireless_client_health_export.post import ExportToCsv3

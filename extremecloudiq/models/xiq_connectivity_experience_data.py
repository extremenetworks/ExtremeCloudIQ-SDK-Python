...
class XiqConnectivityExperienceData(object):
    ...
    def __init__(self, id=None, info=None, name=None, quality_index=None, client_type=None, trend_indicator=None, quality_index_graph=None, local_vars_configuration=None):  # noqa: E501

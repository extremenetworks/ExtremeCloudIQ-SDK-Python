...
class XiqIotProfileThreadGateway(object):
    ...
    def __init__(self, short_pan_id=None, ext_pan_id=None, master_key=None, network_name=None, channel=None, comm_credentials=None, comm_timeout=None, enable_nat64=None, enable_dns_search_domain=None, white_list=None, default_user_profile_id=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._enable_dns_search_domain = None
        ...
        if enable_dns_search_domain is not None:
            self.enable_dns_search_domain = enable_dns_search_domain
    ...
    @property
    def enable_dns_search_domain(self):
        """Gets the enable_dns_search_domain of this XiqIotProfileThreadGateway.  # noqa: E501

        Enable adding DNS search domain to unqualified host lookups forwarded by upstream DNS (in the thread border router).  # noqa: E501

        :return: The enable_dns_search_domain of this XiqIotProfileThreadGateway.  # noqa: E501
        :rtype: bool
        """
        return self._enable_dns_search_domain

    @enable_dns_search_domain.setter
    def enable_dns_search_domain(self, enable_dns_search_domain):
        """Sets the enable_dns_search_domain of this XiqIotProfileThreadGateway.

        Enable adding DNS search domain to unqualified host lookups forwarded by upstream DNS (in the thread border router).  # noqa: E501

        :param enable_dns_search_domain: The enable_dns_search_domain of this XiqIotProfileThreadGateway.  # noqa: E501
        :type: bool
        """

        self._enable_dns_search_domain = enable_dns_search_domain

...
class XiqChangeDevicesIbeaconRequest(object):
    ...
    openapi_types = {
        ...
        'enable_cloud_reporting': 'bool',
        'enable_batch_reporting': 'bool'
    }
    ...
    def __init__(self, device_ids=None, enabled=None, major=None, minor=None, power=None, enable_monitoring=None, enable_cloud_reporting=None, enable_batch_reporting=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._enable_cloud_reporting = None
        self._enable_batch_reporting = None
        ...
        if enable_cloud_reporting is not None:
            self.enable_cloud_reporting = enable_cloud_reporting
        if enable_batch_reporting is not None:
    ...
    @property
    def enable_cloud_reporting(self):
        """Gets the enable_cloud_reporting of this XiqChangeDevicesIbeaconRequest.  # noqa: E501

        Whether the device iBeacon Cloud Reporting is enabled. Default to true for newly enabled device.  # noqa: E501

        :return: The enable_cloud_reporting of this XiqChangeDevicesIbeaconRequest.  # noqa: E501
        :rtype: bool
        """
        return self._enable_cloud_reporting

    @enable_cloud_reporting.setter
    def enable_cloud_reporting(self, enable_cloud_reporting):
        """Sets the enable_cloud_reporting of this XiqChangeDevicesIbeaconRequest.

        Whether the device iBeacon Cloud Reporting is enabled. Default to true for newly enabled device.  # noqa: E501

        :param enable_cloud_reporting: The enable_cloud_reporting of this XiqChangeDevicesIbeaconRequest.  # noqa: E501
        :type: bool
        """

        self._enable_cloud_reporting = enable_cloud_reporting

    @property
    def enable_batch_reporting(self):
        """Gets the enable_batch_reporting of this XiqChangeDevicesIbeaconRequest.  # noqa: E501

        Whether the device iBeacon Batch Reporting is enabled. Default to false for newly enabled device.  # noqa: E501

        :return: The enable_batch_reporting of this XiqChangeDevicesIbeaconRequest.  # noqa: E501
        :rtype: bool
        """
        return self._enable_batch_reporting

    @enable_batch_reporting.setter
    def enable_batch_reporting(self, enable_batch_reporting):
        """Sets the enable_batch_reporting of this XiqChangeDevicesIbeaconRequest.

        Whether the device iBeacon Batch Reporting is enabled. Default to false for newly enabled device.  # noqa: E501

        :param enable_batch_reporting: The enable_batch_reporting of this XiqChangeDevicesIbeaconRequest.  # noqa: E501
        :type: bool
        """

        self._enable_batch_reporting = enable_batch_reporting

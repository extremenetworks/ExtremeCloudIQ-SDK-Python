...
class XiqDeviceConfigureIpv4Interface(object):
    ...
    attribute_map = {
        ...
        'ip_address_to_int': 'ip_address_to_int',
    ...
    def __init__(self, subnetwork=None, vlan_attribute=None, ip_address=None, ip_address_to_int=None, routing_instance=None, enable_forwarding=None, enable_vlan_loopback=None, use_ip_addr_as_ospf_router_id=None, override_dhcp_relay=None, enable_dhcp=None, primary_dhcp_server=None, secondary_dhcp_server=None, predefined=None, ipv4_interface_id=None, local_vars_configuration=None):  # noqa: E501
        ...
        if ip_address_to_int is not None:
            self.ip_address_to_int = ip_address_to_int
    ...
    @property
    def ip_address_to_int(self):
        """Gets the ip_address_to_int of this XiqDeviceConfigureIpv4Interface.  # noqa: E501

        The IPv4 address set on the interface to numeric format  # noqa: E501

        :return: The ip_address_to_int of this XiqDeviceConfigureIpv4Interface.  # noqa: E501
        :rtype: int
        """
        return self._ip_address_to_int

    @ip_address_to_int.setter
    def ip_address_to_int(self, ip_address_to_int):
        """Sets the ip_address_to_int of this XiqDeviceConfigureIpv4Interface.

        The IPv4 address set on the interface to numeric format  # noqa: E501

        :param ip_address_to_int: The ip_address_to_int of this XiqDeviceConfigureIpv4Interface.  # noqa: E501
        :type: int
        """

        self._ip_address_to_int = ip_address_to_int

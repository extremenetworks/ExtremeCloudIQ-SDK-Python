...
class XiqAnomaliesCountVoEntity(object):
    ...
    def __init__(self, timestamp=None, total_anomalies_count=None, wifi_efficiency_count=None, wifi_capacity_count=None, poe_count=None, pe_count=None, dfs_count=None, mb_cast_count=None, hardware_health_count=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._hardware_health_count = None
        ...
        if hardware_health_count is not None:
            self.hardware_health_count = hardware_health_count
    ...
    @property
    def hardware_health_count(self):
        """Gets the hardware_health_count of this XiqAnomaliesCountVoEntity.  # noqa: E501

        The hardware health count  # noqa: E501

        :return: The hardware_health_count of this XiqAnomaliesCountVoEntity.  # noqa: E501
        :rtype: int
        """
        return self._hardware_health_count

    @hardware_health_count.setter
    def hardware_health_count(self, hardware_health_count):
        """Sets the hardware_health_count of this XiqAnomaliesCountVoEntity.

        The hardware health count  # noqa: E501

        :param hardware_health_count: The hardware_health_count of this XiqAnomaliesCountVoEntity.  # noqa: E501
        :type: int
        """

        self._hardware_health_count = hardware_health_count

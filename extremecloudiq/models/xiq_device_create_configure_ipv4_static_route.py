...
class XiqDeviceCreateConfigureIpv4StaticRoute(object):
    ...
    def __init__(self, name=None, dest_subnetwork=None, next_hop_ip=None, next_hop_ip_ping_protection=None, metric=None, routing_instance=None, predefined=None, local_vars_configuration=None):  # noqa: E501

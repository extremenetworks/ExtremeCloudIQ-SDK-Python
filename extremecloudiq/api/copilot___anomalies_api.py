...
class CopilotAnomaliesApi(object):
    ...
    def get_lldp_cdp_info(self, anomaly_id, device_id, last_detected_time, **kwargs):  # noqa: E501
        """get_lldp_cdp_info  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_lldp_cdp_info(anomaly_id, device_id, last_detected_time, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_lldp_cdp_info_with_http_info(anomaly_id, device_id, last_detected_time, **kwargs)  # noqa: E501

    def get_lldp_cdp_info_with_http_info(self, anomaly_id, device_id, last_detected_time, **kwargs):  # noqa: E501
        """get_lldp_cdp_info  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_lldp_cdp_info_with_http_info(anomaly_id, device_id, last_detected_time, async_req=True)
        >>> result = thread.get()

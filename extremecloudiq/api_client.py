...
from extremecloudiq.exceptions import ApiTypeError, ApiValueError
from extremecloudiq.schemas import (
    NoneClass,
    BoolClass,
    Schema,
    FileIO,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'OpenAPI-Generator/25.10.0-103/python'

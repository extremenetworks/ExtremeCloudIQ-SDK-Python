# extremecloudiq.model.xiq_wired_device_health_temp_request.XiqWiredDeviceHealthTempRequest

Request body for the Wired Device Health Temperature Issues widget

## Model Type Info
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | Request body for the Wired Device Health Temperature Issues widget | 

# extremecloudiq.model.xiq_wired_device_health_summary_request.XiqWiredDeviceHealthSummaryRequest

Request body for the Wired Device Health Summary widget

## Model Type Info
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | Request body for the Wired Device Health Summary widget | 

# extremecloudiq.model.xiq_wired_device_health_fan_request.XiqWiredDeviceHealthFanRequest

Request body for the Wired Device Health Fan Issues widget

## Model Type Info
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | Request body for the Wired Device Health Fan Issues widget | 

# extremecloudiq.model.xiq_wired_device_health_cpu_request.XiqWiredDeviceHealthCpuRequest

Request body for the Wired Device Health CPU Usage Issues widget

## Model Type Info
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | Request body for the Wired Device Health CPU Usage Issues widget | 

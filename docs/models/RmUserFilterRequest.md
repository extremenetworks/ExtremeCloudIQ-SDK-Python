# extremecloudiq.model.rm_user_filter_request.RmUserFilterRequest

Request body for User Filter

## Model Type Info
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | Request body for User Filter | 

# extremecloudiq.model.xiq_wireless_client_health_grid_filter_metadata.XiqWirelessClientHealthGridFilterMetadata
...
**[client_type](#client_type)** | list, tuple,  | tuple,  | unique identifier of the filter metadata | [optional] 
...
unique identifier of the filter metadata

## Model Type Info
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
list, tuple,  | tuple,  | unique identifier of the filter metadata | 

### Tuple Items
Class Name | Input Type | Accessed Type | Description | Notes
------------- | ------------- | ------------- | ------------- | -------------
items | str,  | str,  | unique identifier of the filter metadata | 

# extremecloudiq.model.xiq_rm_afc_device_list_request.XiqRmAfcDeviceListRequest
...
**[power_mode](#power_mode)** | list, tuple,  | tuple,  | List of device of power mode | [optional] 
**[product_types](#product_types)** | list, tuple,  | tuple,  | List of device product types to filter | [optional] 
**[wifi_radio](#wifi_radio)** | list, tuple,  | tuple,  | List of device firmware versions to filter | [optional] 
**[geo_location](#geo_location)** | list, tuple,  | tuple,  | List of country codes to filter | [optional] 
**[afc_status](#afc_status)** | list, tuple,  | tuple,  | List of entities managing the device to filter | [optional] 
...
List of device of power mode

## Model Type Info
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
list, tuple,  | tuple,  | List of device of power mode | 

### Tuple Items
Class Name | Input Type | Accessed Type | Description | Notes
------------- | ------------- | ------------- | ------------- | -------------
items | str,  | str,  | List of device of power mode | 
...
Class Name | Input Type | Accessed Type | Description | Notes
------------- | ------------- | ------------- | ------------- | -------------
items | str,  | str,  | List of country codes to filter | 

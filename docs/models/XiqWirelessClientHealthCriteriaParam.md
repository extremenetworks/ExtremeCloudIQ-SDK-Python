# extremecloudiq.model.xiq_wireless_client_health_criteria_param.XiqWirelessClientHealthCriteriaParam
...
**time_range** | decimal.Decimal, int,  | decimal.Decimal,  | time range in days | [optional] value must be a 32 bit integer

# extremecloudiq.model.xiq_create_wireless_client_health_criteria.XiqCreateWirelessClientHealthCriteria
...
**time_range** | decimal.Decimal, int,  | decimal.Decimal,  | The time range in days | [optional] value must be a 32 bit integer

# extremecloudiq.model.xiq_thread_start_commissioner_by_buildings_request.XiqThreadStartCommissionerByBuildingsRequest
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | The request to start the thread commissioner on devices under buildings. | 
...
**ext_pan_id** | str,  | str,  | The extPanID for IoT profile to filter out devices to start the Commissioner. | [optional] 

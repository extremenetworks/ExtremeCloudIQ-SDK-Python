# extremecloudiq.model.xiq_onboard_device_response.XiqOnboardDeviceResponse

The response for onboard devices

## Model Type Info
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | The response for onboard devices | 

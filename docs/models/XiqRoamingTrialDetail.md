...
**status** | str,  | str,  | The operation progress | [optional] must be one of ["ASSOC_FAILED", "DHCP_FAILED", "GW_FAILED", "AUTH_FAILED", "DNS_FAILED", "ROAMING_STARTED", "ROAMING_COMPLETED", "ROAMING_FAILED", "DISCONNECT", ] 

# extremecloudiq.model.xiq_update_alert_webhook_subscription_request.XiqUpdateAlertWebhookSubscriptionRequest
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | The alert webhook subscription update | 

### Dictionary Keys
Key | Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | ------------- | -------------
**[alert_policy_ids](#alert_policy_ids)** | list, tuple,  | tuple,  | The selected alert policy list. | 
**url** | str,  | str,  | The webhook endpoint URL. | [optional] 

# extremecloudiq.model.xiq_hardware_health_reboot_stats_entity.XiqHardwareHealthRebootStatsEntity
...
**reboot_code** | decimal.Decimal, int, float,  | decimal.Decimal,  | Reboot Code | [optional] 

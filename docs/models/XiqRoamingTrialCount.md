# extremecloudiq.model.xiq_roaming_trial_count.XiqRoamingTrialCount
...
**slow_roam_count** | decimal.Decimal, int,  | decimal.Decimal,  | Slow roam count | [optional] value must be a 64 bit integer

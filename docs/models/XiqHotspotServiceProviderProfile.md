# extremecloudiq.model.xiq_hotspot_service_provider_profile.XiqHotspotServiceProviderProfile

The payload of Hotspot Service Provider profile

## Model Type Info
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | The payload of Hotspot Service Provider profile | 

...
**schedule_time** | str,  | str,  | The scheduled time in HH:MM format (e.g., 08:00). Defaults to 23:59 if not provided. | [optional] if omitted the server will use the default value of "1439"
**schedule_timezone** | str,  | str,  | The timezone of the scheduled report. Defaults to UTC if not provided. | [optional] if omitted the server will use the default value of "UTC"

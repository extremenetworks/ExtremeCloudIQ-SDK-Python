# extremecloudiq.model.xiq_wired_device_health_poe_request.XiqWiredDeviceHealthPoeRequest

Request body for the Wired Device Health PoE Usage Issues widget

## Model Type Info
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | Request body for the Wired Device Health PoE Usage Issues widget | 

# extremecloudiq.model.rm_user_number_filter.RmUserNumberFilter
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | User Number Filter | 

### Dictionary Keys
Key | Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | ------------- | -------------
**column_name** | str,  | str,  | The column name | [optional] 
**filter_type** | [**RmUserFilterType**](RmUserFilterType.md) | [**RmUserFilterType**](RmUserFilterType.md) |  | [optional] 

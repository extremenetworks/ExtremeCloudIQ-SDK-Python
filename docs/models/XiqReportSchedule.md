# extremecloudiq.model.xiq_report_schedule.XiqReportSchedule
...
------------ | ------------- | ------------- | ------------- | -------------
**report_schedule_id** | decimal.Decimal, int,  | decimal.Decimal,  | The unique ID of the scheduled report. | [optional] value must be a 64 bit integer

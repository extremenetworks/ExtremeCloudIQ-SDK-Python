<a id="__pageTop"></a>
# extremecloudiq.apis.tags.ng_reports_ondemand_api.NGReportsOndemandApi
...
from extremecloudiq.apis.tags import ng_reports_ondemand_api
...
with extremecloudiq.ApiClient(configuration) as api_client:
    ...
    api_instance = ng_reports_ondemand_api.NGReportsOndemandApi(api_client)
    ...
    try:
        ...
        print("Exception when calling NGReportsOndemandApi->download_report: %s\n" % e)
```
### Parameters
...
400 | [ApiResponseFor400](#download_report.ApiResponseFor400) | Invalid Report Id
...
#### download_report.ApiResponseFor400
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
...
with extremecloudiq.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling NGReportsOndemandApi->get_application_list_for_filter: %s\n" % e)
```
### Parameters
...
with extremecloudiq.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling NGReportsOndemandApi->get_band_metadata: %s\n" % e)
```
### Parameters
...
with extremecloudiq.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling NGReportsOndemandApi->get_client_list_for_filter: %s\n" % e)
```
### Parameters
...
with extremecloudiq.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling NGReportsOndemandApi->get_device_list_for_filter: %s\n" % e)
```
### Parameters
...
with extremecloudiq.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling NGReportsOndemandApi->get_os_filter_metadata: %s\n" % e)
```
### Parameters
...
with extremecloudiq.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling NGReportsOndemandApi->get_ssis_metadata: %s\n" % e)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
fetchAll | FetchAllSchema | | optional
...
with extremecloudiq.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling NGReportsOndemandApi->get_users_list_for_filter: %s\n" % e)
```
### Parameters
...
with extremecloudiq.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling NGReportsOndemandApi->q_oe_diagnostics_help: %s\n" % e)
```
### Parameters
...
with extremecloudiq.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling NGReportsOndemandApi->q_oe_diagnostics_help1: %s\n" % e)
```
### Parameters
...
with extremecloudiq.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling NGReportsOndemandApi->qoe_diagnostics_table_data: %s\n" % e)
```
### Parameters
...
with extremecloudiq.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling NGReportsOndemandApi->qoe_diagnostics_time_series_data: %s\n" % e)
```
### Parameters
...
with extremecloudiq.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling NGReportsOndemandApi->qoe_diagnostics_xlsx_data: %s\n" % e)
```
### Parameters

...
[**delete_subscription**](#delete_subscription) | **delete** /subscriptions/webhook/{id} | Delete webhook subscription

# **call_list**
<a id="call_list"></a>
> [XiqWebhookSubscription] call_list()
...
------------- | ------------- | ------------- | ------------- | -------------
[**XiqWebhookSubscription**]({{complexTypePrefix}}XiqWebhookSubscription.md) | [**XiqWebhookSubscription**]({{complexTypePrefix}}XiqWebhookSubscription.md) | [**XiqWebhookSubscription**]({{complexTypePrefix}}XiqWebhookSubscription.md) |  | 

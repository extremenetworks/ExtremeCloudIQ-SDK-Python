...
> [XiqChangeStatusToManageResponse] change_device_status_to_manage(id)
...
Class Name | Input Type | Accessed Type | Description | Notes
------------- | ------------- | ------------- | ------------- | -------------
[**XiqChangeStatusToManageResponse**]({{complexTypePrefix}}XiqChangeStatusToManageResponse.md) | [**XiqChangeStatusToManageResponse**]({{complexTypePrefix}}XiqChangeStatusToManageResponse.md) | [**XiqChangeStatusToManageResponse**]({{complexTypePrefix}}XiqChangeStatusToManageResponse.md) |  | 
...
> [XiqChangeStatusToManageResponse] change_status_to_manage(xiq_device_filter)
    ...
    body = XiqRmDeviceListRequest(
        ...
        eth_uplink_speed_filters=[
            XiqRmDeviceEthUplinkSpeedFilter(
                eth_uplink_speed=XiqEthUplinkSpeed("ETH0"),
                filter_type=XiqRmDeviceNumberEnumFilter("GT"),
                constant_value=XiqConstantValue("VAUTO"),

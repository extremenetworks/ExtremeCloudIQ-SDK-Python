...
from extremecloudiq.models.xiq_iotp_ma_ble_scan import XiqIotpMaBleScan  # noqa: E501
...
class TestXiqIotpMaBleScan(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        """Test XiqIotpMaBleScan
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = extremecloudiq.models.xiq_iotp_ma_ble_scan.XiqIotpMaBleScan()  # noqa: E501
        if include_optional :

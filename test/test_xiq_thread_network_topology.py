...
from extremecloudiq.models.xiq_thread_network_topology import XiqThreadNetworkTopology  # noqa: E501
from extremecloudiq.rest import ApiException

class TestXiqThreadNetworkTopology(unittest.TestCase):
    """XiqThreadNetworkTopology unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test XiqThreadNetworkTopology
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = extremecloudiq.models.xiq_thread_network_topology.XiqThreadNetworkTopology()  # noqa: E501
        if include_optional :
            return XiqThreadNetworkTopology(
                neighbors = [
                    extremecloudiq.models.xiq_thread_router_neighbor.XiqThreadRouterNeighbor(
                        parent_device_id = 56, 
                        child_device_id = 56, 
    ...
    def testXiqThreadNetworkTopology(self):
        """Test XiqThreadNetworkTopology"""

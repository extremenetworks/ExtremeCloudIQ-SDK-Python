...
from extremecloudiq.models.xiq_packet_capture import XiqPacketCapture  # noqa: E501
from extremecloudiq.rest import ApiException

class TestXiqPacketCapture(unittest.TestCase):
    """XiqPacketCapture unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test XiqPacketCapture
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = extremecloudiq.models.xiq_packet_capture.XiqPacketCapture()  # noqa: E501
        if include_optional :

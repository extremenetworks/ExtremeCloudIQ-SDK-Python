...
class TestAfcEndpointApi(unittest.TestCase):
    ...
    def test_get_afc_geolocation_summary(self):
        """Test case for get_afc_geolocation_summary
    ...
    def test_get_afc_status_summary(self):
        """Test case for get_afc_status_summary

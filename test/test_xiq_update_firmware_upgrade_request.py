...
from extremecloudiq.models.xiq_update_firmware_upgrade_request import XiqUpdateFirmwareUpgradeRequest  # noqa: E501
from extremecloudiq.rest import ApiException

class TestXiqUpdateFirmwareUpgradeRequest(unittest.TestCase):
    """XiqUpdateFirmwareUpgradeRequest unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test XiqUpdateFirmwareUpgradeRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = extremecloudiq.models.xiq_update_firmware_upgrade_request.XiqUpdateFirmwareUpgradeRequest()  # noqa: E501
        if include_optional :
            return XiqUpdateFirmwareUpgradeRequest(
                schedule = extremecloudiq.models.xiq_schedule_details.XiqScheduleDetails(
                    start_time = 56, ), 
                devices = extremecloudiq.models.xiq_deploy_device_filter.XiqDeployDeviceFilter(
                    ids = [
                        56
                        ], 
                    site_ids = [
    ...
    def testXiqUpdateFirmwareUpgradeRequest(self):
        """Test XiqUpdateFirmwareUpgradeRequest"""
